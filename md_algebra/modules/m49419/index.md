...
In equations (4) and (5), we have created a new two-by-two system. We can solve for $$z$$ 
 ...
 $$
\frac{\begin{array}{l}\begin{array}{l}\hfill \\ \text{}y+2z=3\phantom{\rule{0.5em}{0ex}}\text{}\phantom{\rule{0.5em}{0ex}}(4)\hfill \end{array}\hfill \\ -y-z=-1\phantom{\rule{0.5em}{0ex}}\text{}(5)\hfill \end{array}}{\phantom{\rule{0.5em}{0ex}}z=2\phantom{\rule{0.5em}{0ex}}\text{}\phantom{\rule{0.5em}{0ex}}(6)}
$$
...
Then, we write the three equations as a system.
   	 ...
   	 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{}x+y+z=\mathrm{12,000}\hfill \\ \phantom{\rule{0.5em}{0ex}}\text{}-y+z=\mathrm{4,000}\hfill \\ 0.03x+0.04y+0.07z=670\hfill \end{array}
$$
To make the calculations simpler, we can multiply the third equation by 100. Thus,

    $$
\begin{array}{ll}\phantom{\rule{0.5em}{0ex}}\text{}x+\phantom{\rule{0.5em}{0ex}}\text{}y+z\phantom{\rule{0.5em}{0ex}}\text{}=\mathrm{12,000}\hfill & (1)\hfill \\ \phantom{\rule{0.5em}{0ex}}\text{}-y+z\phantom{\rule{0.5em}{0ex}}\text{}=\mathrm{4,000}\hfill & (2)\hfill \\ 3x+4y+7z=\mathrm{67,000}\hfill & (3)\hfill \end{array}
$$
...
Solve the system of three equations in three variables.
 ...
 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{}x+y+z=2\hfill \\ \phantom{\rule{0.5em}{0ex}}\text{}y\mathrm{-3}z=1\hfill \\ 2x+y+5z=0\hfill \end{array}
$$
