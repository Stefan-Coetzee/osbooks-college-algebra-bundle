...
![graph2](../../media/CNX_Precalc_Figure_01_02_008_new.jpg)
</details>
...
6. Graph the following function below. Use this graph to help determine the domain and range and express using interval notation. $f\left(x\right)=-4x-3$   D: ________  R: _________
...
![Image](../../media/CNX_Precalc_Figure_01_02_029n.jpg)
...
When there is a denominator, we want to include only values of the input that do not force the denominator to be zero. So, we will set the denominator equal to 0 and solve for $x.$
 ...
 $$
\begin{array}{ccc}  2-x& =& 0  \\   -x& =& \mathrm{-2}  \\   x& =& 2  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_01_02_028n.jpg)
</details>
...
Set the radicand greater than or equal to zero and solve for $x.$
 ...
 $$
\begin{array}{ccc}  7-x& \ge & 0  \\   -x& \ge & \mathrm{-7}  \\   x& \le & 7  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_01_02_003-2f9c.jpg)
...
| *Inequality* | $1\le x\le 3\phantom{\rule{0.5em}{0ex}}\text{or}\phantom{\rule{0.5em}{0ex}}x>5$ |
| :--- | :--- |
| *Set-builder notation* | $\left\{x|1\le x\le 3\phantom{\rule{0.5em}{0ex}}\text{or}\phantom{\rule{0.5em}{0ex}}x>5\right\}$ |
...
![Image](../../media/CNX_Precalc_Figure_01_02_006-bdb9.jpg)
...
![Image](../../media/CNX_Precalc_Figure_01_02_008_new.jpg)
</details>
...
![For the *quadratic function* $f(x)={x}^{2},$ the domain is all real numbers since the horizontal extent of the graph is the whole real number line. Because the graph does not include any negative values for the range, the range is only nonnegative real numbers.](../../media/CNX_Precalc_Figure_01_02_014-57f2.jpg)
...
![(a) $f\left(x\right)={x}^{2}\phantom{\rule{0.5em}{0ex}}\text{if\ \}x\le 1;$ (b) $f\left(x\right)=3\phantom{\rule{0.5em}{0ex}}\text{if\ 1<\}x\le 2;$ (c) $f\left(x\right)=x\phantom{\rule{0.5em}{0ex}}\text{\ if\}x>2$](../../media/CNX_Precalc_Figure_01_02_023abc-4996.jpg)

Now that we have sketched each piece individually, we combine them in the same coordinate plane. See .

![Image](../../media/CNX_Precalc_Figure_01_02_026-7f92.jpg)
</details>
...
> <summary>Solution</summary>
>
> ![Graph of f(x).](../../media/CNX_Precalc_Figure_01_02_027-8ea8.jpg)
> </details>
>
...
30. ![Graph of a function from [2, 6].](../../media/CNX_Precalc_Figure_01_02_205-63a9.jpg)
...
![Graph of f(x).](../../media/CNX_Precalc_Figure_01_02_214.jpg)
</details>
...
![Graph of f(x).](../../media/CNX_Precalc_Figure_01_02_216.jpg)
</details>
...
![Graph of f(x).](../../media/CNX_Precalc_Figure_01_02_218.jpg)
</details>

44. $f\left(x\right)=\{\begin{array}{ccc}x+1& \text{if}& x<1\\ {x}^{3}& \text{if}& x\ge 1\end{array}$
...
![Graph of f(x).](../../media/CNX_Precalc_Figure_01_02_220.jpg)
</details>
...
56. Graph $y=\frac{1}{x}$ on the viewing window $[\mathrm{-0.5},\mathrm{-0.1}]$ and $[0.1,\phantom{\rule{0.5em}{0ex}}\text{}0.5].$ Determine the corresponding range for the viewing window. Show the graphs.
