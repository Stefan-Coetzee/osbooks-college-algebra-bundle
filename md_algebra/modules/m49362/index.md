...
![This figure shows two curves. The first curve is marked in blue and passes through the points (negative 1, 1 over 2), (0, 1) and (1, 2). The second curve is marked in red and passes through the points (negative 1, 1), (0, 2) and (1, 4).](../../media/CNX_IntAlg_Figure_10_02_009_img.jpg)
...
![This figure shows two curves. The first curve is marked in blue and passes through the points (negative 1, 1 over 3), (0, 1), and (1, 3). The second curve is marked in red and passes through the points (negative 1, negative 5 over 3), (0, negative 1), and (1, 1).](../../media/CNX_IntAlg_Figure_10_02_011_img.jpg)
...
4. On the same coordinate system graph $f\left(x\right)={3}^{x}$ and $g\left(x\right)={3}^{x}+1.$     ![.](../../media/blankplot6.4-01c0.png)
...
![.](../../media/CNX_Coreq_Figure_06_02_001.jpg)
</details>
...
>
>
> ![Image](../../media/CNX_Precalc_Figure_04_02_003new.jpg)
>
...
![Image](../../media/CNX_Precalc_Figure_04_02_004.jpg)
...
>
>
> ![Graph of the increasing exponential function f(x) = 4^x with labeled points at (-1, 0.25), (0, 1), and (1, 4).](../../media/CNX_Precalc_Figure_04_02_005.jpg)
> </details>
>
...
![Image](../../media/CNX_Precalc_Figure_04_02_008.jpg)
...
>
>
> ![Graph of the function, f(x) = 2^(x-1)+3, with an asymptote at y=3. Labeled points in the graph are (-1, 3.25), (0, 3.5), and (1, 4).](../../media/CNX_Precalc_Figure_04_02_009.jpg)
> </details>
>
...
![Image](../../media/CNX_Precalc_Figure_04_02_011.jpg)
...
>
>
> ![Graph of the function, f(x) = (1/2)(4)^(x), with an asymptote at y=0. Labeled points in the graph are (-1, 0.125), (0, 0.5), and (1, 2).](../../media/CNX_Precalc_Figure_04_02_012.jpg)
> </details>
>
>
>
...
![Image](../../media/CNX_Precalc_Figure_04_02_014.jpg)
...
>
>
> ![Graph of the function, g(x) = -(1.25)^(-x), with an asymptote at y=0. Labeled points in the graph are (-1, 1.25), (0, 1), and (1, 0.8).](../../media/CNX_Precalc_Figure_04_02_015.jpg)
> </details>
>
...
7. The graph of $f\left(x\right)=-\frac{1}{2}{\left(\frac{1}{4}\right)}^{x-2}+4$ is shifted downward $4$ units, and then shifted left $2$ units, stretched vertically by a factor of $4,$ and reflected about the *x*-axis. What is the equation of the new function, $g(x)?$ State its *y*-intercept, domain, and range.
...
![Graph of two functions, g(-x)=-2(0.25)^(-x) in blue and g(x)=-2(0.25)^x in orange.](../../media/CNX_PreCalc_Figure_04_02_202.jpg)
...
![Graph of three functions, g(x)=3(2)^(x) in blue, h(x)=3(4)^(x) in green, and f(x)=3(1/4)^(x) in orange.](../../media/CNX_PreCalc_Figure_04_02_204.jpg)
</details>
...
15. $f\left(x\right)=2{\left(0.81\right)}^{x}$
...
![Graph of two functions, f(x)=(1/2)(4)^(x) in blue and -f(x)=(-1/2)(4)^x in orange.](../../media/CNX_PreCalc_Figure_04_02_208.jpg)
</details>

24. $f(x)=3{\left(0.75\right)}^{x}-1$

25. $f(x)=-4{\left(2\right)}^{x}+2$

<details>
<summary>Solution</summary>

![Graph of two functions, -f(x)=(4)(2)^(x)-2 in blue and f(x)=(-4)(2)^x+1 in orange.](../../media/CNX_PreCalc_Figure_04_02_210.jpg)
</details>
...
![Graph of h(x)=2^(x)+3.](../../media/CNX_PreCalc_Figure_04_02_212.jpg)
...
39. ![Graph of f(x)=2^(x) with the following translations: a reflection about the x-axis, and a shift up by 3.](../../media/CNX_PreCalc_Figure_04_02_215.jpg)
...
41. ![Graph of f(x)=3^(x) with the following translations: vertical stretch of 2, a reflection about the x-axis, and a shift up by 7.](../../media/CNX_PreCalc_Figure_04_02_217.jpg)
