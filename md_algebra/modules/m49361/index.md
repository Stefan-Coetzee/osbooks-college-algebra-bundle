...
6. Graph the exponential function $f(x)={\left(\frac{1}{2}\right)}^{x}$ by making a table.     | $x$ | $y=f(x)$ | | :--- | :--- | |  |  | |  |  | |  |  | |  |  | |  |  | |  |  |    ![.](../../media/blankplot6.4-01c0.png)   How does it compare with the graph of $f(x)={2}^{x}$ ?
...
### Practice Makes Perfect
10. Graph the exponential function $f\left(x\right)={e}^{x}$ by making a table.     | $x$ | $y=f(x)$ | | :--- | :--- | |  |  | |  |  | |  |  | |  |  | |  |  | |  |  |    ![.](../../media/blankplot6.4-01c0.png)   What is the domain of $f(x)$ ? What is the range of $f(x)$ ?
...
Follow the order of operations. Be sure to pay attention to the parentheses.
 ...
 $$
\begin{array}{lll}f\left(x\right)  & =5{\left(3\right)}^{x+1}  &   \\ f\left(2\right)  & =5{\left(3\right)}^{2+1}  & \text{Substitute\}x=2.  \\   & =5{\left(3\right)}^{3}  & \text{Add\ the\ exponents}.  \\   & =5\left(27\right)  & \text{Simplify\ the\ power}\text{.}  \\   & =135  & \text{Multiply}\text{.}  \end{array}
$$
</details>
...
We let our independent variable $t$ be the number of years after 2006. Thus, the information given in the problem can be written as input-output pairs: (0, 80) and (6, 180). Notice that by choosing our input variable to be measured as years after 2006, we have given ourselves the initial value for the function, $a=80.$ We can now substitute the second point into the equation $N(t)=80{b}^{t}$ to find $b:$ 
 ...
 $$
\begin{array}{lll}N(t)  & =80{b}^{t}  &   \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}180  & =80{b}^{6}  & \text{Substitute\ using\ point\}(6,\ 180).  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\frac{9}{4}  & ={b}^{6}  & \text{Divide\ and\ write\ in\ lowest\ terms}.  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}b  & ={\left(\frac{9}{4}\right)}^{\frac{1}{6}}  & \text{Isolate\}b\phantom{\rule{0.5em}{0ex}}\text{using\ properties\ of\ exponents}.  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}b  & \approx 1.1447\begin{array}{cccc}& & & \end{array}  & \text{Round\ to\ 4\ decimal\ places}.  \end{array}
$$
...
![Graph showing the population of deer over time, $N(t)=80{\left(1.1447\right)}^{t},$ $t$ years after 2006](../../media/CNX_Precalc_Figure_04_01_002.jpg)
</details>
...
We can choose the *y*-intercept of the graph, $\left(0,3\right),$ as our first point. This gives us the initial value, $a=3.$ Next, choose a point on the curve some distance away from $\left(0,3\right)$ that has integer coordinates. One such point is $(2,12).$ 
 $$
\begin{array}{ll}\phantom{\rule{0.5em}{0ex}}\text\ y=a{b}^{x}  & \text{Write\ the\ general\ form\ of\ an\ exponential\ equation}.  \\ \phantom{\rule{0.5em}{0ex}}\text\ y=3{b}^{x}  & \text{Substitute\ the\ initial\ value\ 3\ for\}a.  \\ 12=3{b}^{2}  & \text{Substitute\ in\ 12\ for\}y\phantom{\rule{0.5em}{0ex}}\text{and\ 2\ for\}x.  \\ \phantom{\rule{0.5em}{0ex}}\text\ 4={b}^{2}  & \text{Divide\ by\ 3}.  \\ \phantom{\rule{0.5em}{0ex}}\text\ b=\pm 2\begin{array}{cccc}& & & \end{array}  & \text{Take\ the\ square\ root}.  \end{array}
$$
...
Because we are starting with $3,000, $P=3000.$ Our interest rate is 3%, so $r\phantom{\rule{0.5em}{0ex}}\text{}=\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{0.03.}$ Because we are compounding quarterly, we are compounding 4 times per year, so $n=4.$ We want to know the value of the account in 10 years, so we are looking for $A\left(10\right),$ the value when $t\phantom{\rule{0.5em}{0ex}}\text{}=\phantom{\rule{0.5em}{0ex}}\text{}10.$ 
 ...
 $$
\begin{array}{lll}A(t)  & =P{\left(1+\frac{r}{n}\right)}^{nt}  & \text{Use\ the\ compound\ interest\ formula}.  \\ A(10)  & =3000{\left(1+\frac{0.03}{4}\right)}^{\mathrm{4\cdot 10}}\begin{array}{cccc}& & & \end{array}  & \text{Substitute\ using\ given\ values}.  \\   & \approx \text{$}4045.05  & \text{Round\ to\ two\ decimal\ places}.  \end{array}
$$
...
We want to find the initial investment, $P,$ needed so that the value of the account will be worth $40,000 in $18$ years. Substitute the given values into the compound interest formula, and solve for $P.$ 
 $$
\begin{array}{lll}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}A(t)  & =P{\left(1+\frac{r}{n}\right)}^{nt}  & \text{Use\ the\ compound\ interest\ formula}.  \\ \mathrm{40,000}  & =P{\left(1+\frac{0.06}{2}\right)}^{2(18)}\begin{array}{cccc}& & & \end{array}  & \text{Substitute\ using\ given\ values\}A\text{,\}r,\ n\text{,\ and\}t.  \\ \mathrm{40,000}  & =P{(1.03)}^{36}  & \text{Simplify}.  \\ \frac{\mathrm{40,000}}{{(1.03)}^{36}}  & =P  & \text{Isolate\}P.  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}P  & \approx \text{$}13,801  & \text{Divide\ and\ round\ to\ the\ nearest\ dollar}.  \end{array}
$$
...
Since the account is growing in value, this is a continuous compounding problem with growth rate $r=\mathrm{0.10.}$ The initial investment was $1,000, so $P=1000.$ We use the continuous compounding formula to find the value after $t=1$ year: 
 ...
 $$
\begin{array}{lll}A(t)  & =P{e}^{rt}  & \text{Use\ the\ continuous\ compounding\ formula}.  \\   & =1000{(e)}^{0.1}\begin{array}{cccc}& & & \end{array}  & \text{Substitute\ known\ values\ for\}P,\ r,\phantom{\rule{0.5em}{0ex}}\text{and\}t.  \\   & \approx 1105.17  & \text{Use\ a\ calculator\ to\ approximate}.  \end{array}
$$
...
Since the substance is decaying, the rate, $17.3\%$ , is negative. So, $r\phantom{\rule{0.5em}{0ex}}\text{}=\phantom{\rule{0.5em}{0ex}}\text{}-\mathrm{0.173.}$ The initial amount of radon-222 was $100$ mg, so $a=100.$ We use the continuous decay formula to find the value after $t=3$ days: 
 ...
 $$
\begin{array}{lll}A(t)  & =a{e}^{rt}  & \text{Use\ the\ continuous\ growth\ formula}.  \\   & =100{e}^{-0.173(3)}\begin{array}{cccc}& & & \end{array}  & \text{Substitute\ known\ values\ for\}a,\ r,\phantom{\rule{0.5em}{0ex}}\text{and\}t.  \\   & \approx 59.5115  & \text{Use\ a\ calculator\ to\ approximate}.  \end{array}
$$
