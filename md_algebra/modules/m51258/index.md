...
Whether we take the root first or the power first depends on the number. It is easy to find the cube root of 8, so rewrite ${8}^{\frac{2}{3}}$ as ${\left({8}^{\frac{1}{3}}\right)}^{2}.$
 ...
 $$
\begin{array}{ccc}\hfill {\left({8}^{\frac{1}{3}}\right)}^{2}& =\hfill & {(2)}^{2}\hfill \\ & =& 4\hfill \end{array}
$$
...
The way to remove the exponent on *x* is by raising both sides of the equation to a power that is the reciprocal of $\frac{5}{4},$ which is $\frac{4}{5}.$
 ...
 $$
\begin{array}{cccc}\hfill {x}^{\frac{5}{4}}& =& 32\hfill & \\ \hfill {\left({x}^{\frac{5}{4}}\right)}^{\frac{4}{5}}& =& {(32)}^{\frac{4}{5}}\hfill & \\ \hfill x& =& {(2)}^{4}\hfill & \phantom{\rule{2em}{0ex}}\text{The\ fifth\ root\ of\ 32\ is\ 2.}\hfill \\ & =& 16\hfill & \end{array}
$$
...
First, set the equation equal to zero. Then factor out what is common to both terms, the GCF.
 ...
 $$
\begin{array}{ccc}\hfill 5{x}^{4}-80{x}^{2}& =& 0\hfill \\ \hfill 5{x}^{2}({x}^{2}-16)& =& 0\hfill \end{array}
$$
Notice that we have the difference of squares in the factor ${x}^{2}-16,$ which we will continue to factor and obtain two solutions. The first term, $5{x}^{2},$ generates, technically, two solutions as the exponent is 2, but they are the same solution.
 ...
 $$
\begin{array}{ccc}\hfill 5{x}^{2}& =& 0\hfill \\ \hfill x& =& 0\hfill \\ \hfill {x}^{2}-16& =& 0\hfill \\ \hfill (x-4)(x+4)& =& 0\hfill \\ \hfill x& =& 4\hfill \\ \hfill x& =& \mathrm{-4}\hfill \end{array}
$$
...
We can see the solutions on the graph in . The *x-*coordinates of the points where the graph crosses the *x-*axis are the solutions—the *x-*intercepts. Notice on the graph that at the solution $0,$ the graph touches the *x-*axis and bounces back. It does not cross the *x-*axis. This is typical of double solutions.
\n\n![Image](../../media/CNX_CAT_Figure_02_06_001.jpg)\n\n
...
This polynomial consists of 4 terms, which we can solve by grouping. Grouping procedures require factoring the first two terms and then factoring the last two terms. If the factors in the parentheses are identical, we can continue the process and solve, unless more factoring is suggested.
 ...
 $$
\begin{array}{ccc}\hfill {x}^{3}+{x}^{2}-9x-9& =& 0\hfill \\ \hfill {x}^{2}(x+1)-9(x+1)& =& 0\hfill \\ \hfill ({x}^{2}-9)(x+1)& =& 0\hfill \end{array}
$$
The grouping process ends here, as we can factor ${x}^{2}-9$
using the difference of squares formula.

 $$
\begin{array}{ccc}({x}^{2}-9)(x+1)& =& 0\hfill \\ \hfill (x-3)(x+3)(x+1)& =& 0\hfill \\ \hfill x& =& 3\hfill \\ \hfill x& =& \mathrm{-3}\hfill \\ \hfill x& =& \mathrm{-1}\hfill \end{array}
$$
...
The radical is already isolated on the left side of the equal side, so proceed to square both sides.
 ...
 $$
\begin{array}{ccc}\hfill \sqrt{15-2x}& =& x\hfill \\ \hfill {\left(\sqrt{15-2x}\right)}^{2}& =& {(x)}^{2}\hfill \\ \hfill 15-2x& =& {x}^{2}\hfill \end{array}
$$

We see that the remaining equation is a quadratic. Set it equal to zero and solve.

 $$
\begin{array}{ccc}\hfill 0& =& {x}^{2}+2x-15\hfill \\ & =& (x+5)(x-3)\hfill \\ \hfill x& =& \mathrm{-5}\hfill \\ \hfill x& =& 3\hfill \end{array}
$$
...
The proposed solutions are $\mathrm{-5}$ and $3.$ Let us check each solution back in the original equation. First, check $x=\mathrm{-5.}$
 ...
 $$
\begin{array}{ccc}\hfill \sqrt{15-2x}& =& x\hfill \\ \hfill \sqrt{15-2(-5)}& =& \mathrm{-5}\hfill \\ \hfill \sqrt{25}& =& \mathrm{-5}\hfill \\ \hfill 5& \ne & \mathrm{-5}\hfill \end{array}
$$
...
Check $x=3.$
 ...
 $$
\begin{array}{ccc}\hfill \sqrt{15-2x}& =& x\hfill \\ \hfill \sqrt{15-2(3)}& =& 3\hfill \\ \hfill \sqrt{9}& =& 3\hfill \\ \hfill 3& =& 3\hfill \end{array}
$$
...
As this equation contains two radicals, we isolate one radical, eliminate it, and then isolate the second radical.
 ...
 $$
\begin{array}{cccc}\hfill \sqrt{2x+3}+\sqrt{x-2}& =& 4\hfill & \\ \hfill \sqrt{2x+3}& =& 4-\sqrt{x-2}\hfill & \phantom{\rule{2em}{0ex}}\text{Subtract\}\sqrt{x-2}\phantom{\rule{0.5em}{0ex}}\text{from\ both\ sides}.\hfill \\ \hfill {\left(\sqrt{2x+3}\right)}^{2}& =& {(4-\sqrt{x-2})}^{2}\hfill & \phantom{\rule{2em}{0ex}}\text{Square\ both\ sides}.\hfill \end{array}
$$

Use the perfect square formula to expand the right side: ${\left(a-b\right)}^{2}={a}^{2}\mathrm{-2}ab+{b}^{2}.$

 $$
\begin{array}{cccc}\hfill 2x+3& =& {(4)}^{2}-2(4)\sqrt{x-2}+{\left(\sqrt{x-2}\right)}^{2}\hfill & \\ \hfill 2x+3& =& 16-8\sqrt{x-2}+(x-2)\hfill & \\ \hfill 2x+3& =& 14+x-8\sqrt{x-2}\hfill & \phantom{\rule{2em}{0ex}}\text{Combine\ like\ terms}.\hfill \\ \hfill x-11& =& \mathrm{-8}\sqrt{x-2}\hfill & \phantom{\rule{2em}{0ex}}\text{Isolate\ the\ second\ radical}.\hfill \\ \hfill {(x-11)}^{2}& =& {\left(\mathrm{-8}\sqrt{x-2}\right)}^{2}\hfill & \phantom{\rule{2em}{0ex}}\text{Square\ both\ sides}.\hfill \\ \hfill {x}^{2}-22x+121& =& 64(x-2)\hfill & \end{array}
$$

Now that both radicals have been eliminated, set the quadratic equal to zero and solve.

 $$
\begin{array}{cccc}\hfill {x}^{2}-22x+121& =& 64x-128\hfill & \\ \hfill {x}^{2}-86x+249& =& 0\hfill & \\ \hfill (x-3)(x-83)& =& 0\hfill & \phantom{\rule{2em}{0ex}}\text{Factor\ and\ solve}.\hfill \\ \hfill x& =& 3\hfill & \\ \hfill x& =& 83\hfill & \end{array}
$$

The proposed solutions are $3$ and $83.$ Check each solution in the original equation.

 $$
\begin{array}{ccc}\hfill \sqrt{2x+3}+\sqrt{x-2}& =& 4\hfill \\ \hfill \sqrt{2x+3}& =& 4-\sqrt{x-2}\hfill \\ \hfill \sqrt{2(3)+3}& =& 4-\sqrt{(3)-2}\hfill \\ \hfill \sqrt{9}& =& 4-\sqrt{1}\hfill \\ \hfill 3& =& 3\hfill \end{array}
$$
...
Check $x=83.$
 ...
 $$
\begin{array}{ccc}\hfill \sqrt{2x+3}+\sqrt{x-2}& =& 4\hfill \\ \hfill \sqrt{2x+3}& =& 4-\sqrt{x-2}\hfill \\ \hfill \sqrt{2(83)+3}& =& 4-\sqrt{(83-2)}\hfill \\ \hfill \sqrt{169}& =& 4-\sqrt{81}\hfill \\ \hfill 13& \ne & -5\hfill \end{array}
$$
...
Next, we will learn how to solve an **absolute value equation**. To solve an equation such as $\left|2x-6\right|=8,$ we notice that the absolute value will be equal to 8 if the quantity inside the absolute value bars is $8$ or $\mathrm{-8.}$ This leads to two different equations we can solve independently.
 ...
 $$
\begin{array}{ccccccc}\hfill 2x-6& =& 8\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill 2x-6& =& \mathrm{-8}\hfill \\ \hfill 2x& =& 14& & \hfill 2x& =& \mathrm{-2}\hfill \\ \hfill x& =& 7\hfill & & \hfill x& =& \mathrm{-1}\hfill \end{array}
$$
...
The absolute value of *x*is written as $\left|x\right|.$ It has the following properties:
 ...
 $$
\begin{array}{l}\text{If\}x\ge 0,\phantom{\rule{0.5em}{0ex}}\text{then\}\left|x\right|=x.\hfill \\ \text{If\}x<0,\phantom{\rule{0.5em}{0ex}}\text{then\}\left|x\right|=-x.\hfill \end{array}
$$ 
...
An **absolute value equation** in the form $\left|ax+b\right|=c$ has the following properties:
 ...
 $$
\begin{array}{l}\text{If\ \}c<0,|ax+b|=c\phantom{\rule{0.5em}{0ex}}\text{has\ no\ solution}.\hfill \\ \text{If\ \}c=0,|ax+b|=c\phantom{\rule{0.5em}{0ex}}\text{has\ one\ solution}.\hfill \\ \text{If\ \}c>0,|ax+b|=c\phantom{\rule{0.5em}{0ex}}\text{has\ two\ solutions}.\hfill \end{array}
$$ 
...
Write two equations and solve each:
 ...
 $\begin{array}{ccccccc}\hfill 6x+4& =& 8\hfill & \phantom{\rule{5em}{0ex}}& \hfill 6x+4& =& \mathrm{-8}\hfill \\ \hfill 6x& =& 4\hfill & \phantom{\rule{5em}{0ex}}& \hfill 6x& =& \mathrm{-12}\hfill \\ \hfill x& =& \frac{2}{3}\hfill & \phantom{\rule{5em}{0ex}}& \hfill x& =& \mathrm{-2}\hfill \end{array}$
...
Solve each factor and replace the original term for *u.*
 ...
 $$
\begin{array}{ccc}\hfill 3u+1& =& 0\hfill \\ \hfill 3u& =& \mathrm{-1}\hfill \\ \hfill u& =& -\frac{1}{3}\hfill \\ \hfill {x}^{2}& =& -\frac{1}{3}\hfill \\ \hfill x& =& \pm i\sqrt{\frac{1}{3}}\hfill \end{array}
$$

 $$
\begin{array}{ccc}\hfill u-1& =& 0\hfill \\ \hfill u& =& 1\hfill \\ \hfill {x}^{2}& =& 1\hfill \\ \hfill x& =& \mathrm{\pm 1}\hfill \end{array}
$$
...
This equation contains a binomial in place of the single variable. The tendency is to expand what is presented. However, recognizing that it fits the criteria for being in quadratic form makes all the difference in the solving process. First, make a substitution, letting $u=x+2.$ Then rewrite the equation in *u.*
 ...
 $$
\begin{array}{ccc}\hfill {u}^{2}+11u-12& =& 0\hfill \\ \hfill (u+12)(u-1)& =& 0\hfill \end{array}
$$

Solve using the zero-factor property and then replace *u* with the original expression.

 $$
\begin{array}{ccc}\hfill u+12& =& 0\hfill \\ \hfill u& =& \mathrm{-12}\hfill \\ \hfill x+2& =& \mathrm{-12}\hfill \\ \hfill x& =& \mathrm{-14}\hfill \end{array}
$$

The second factor results in

 $\begin{array}{ccc}\hfill u-1& =& 0\hfill \\ \hfill u& =& 1\hfill \\ \hfill x+2& =& 1\hfill \\ \hfill x& =& \mathrm{-1}\hfill \end{array}$ 
...
We want all denominators in factored form to find the LCD. Two of the denominators cannot be factored further. However, ${x}^{2}\mathrm{-1}=\left(x+1\right)\left(x-1\right).$ Then, the LCD is $\left(x+1\right)\left(x-1\right).$ Next, we multiply the whole equation by the LCD.
 ...
 $\begin{array}{ccc}\hfill (x+1)(x-1)\left[\frac{\mathrm{-4}x}{x-1}+\frac{4}{x+1}\right]& =& \left[\frac{\mathrm{-8}}{(x+1)(x-1)}\right](x+1)(x-1)\hfill \\ \hfill \mathrm{-4}x(x+1)+4(x-1)& =& \mathrm{-8}\hfill \\ \hfill \mathrm{-4}{x}^{2}-4x+4x-4& =& \mathrm{-8}\hfill \\ \hfill \mathrm{-4}{x}^{2}+4& =& 0\hfill \\ \hfill \mathrm{-4}\left({x}^{2}-1\right)& =& 0\hfill \\ \hfill \mathrm{-4}(x+1)(x-1)& =& 0\hfill \\ \hfill x& =& \mathrm{-1}\hfill \\ \hfill x& =& 1\hfill \end{array}$
...
Your friend tries to calculate the value $-{9}^{{\scriptscriptstyle \frac{3}{2}}}$ and keeps getting an ERROR message. What mistake are they probably making?
...
Explain why $\left|2x+5\right|=\mathrm{-7}$ has no solutions.
...
$\left|2x-1\right|-7=\mathrm{-2}$

$x=3,\mathrm{-2}$

$\left|2x+1\right|-2=\mathrm{-3}$

$\left|x+5\right|=0$

$x=\mathrm{-5}$

$-\left|2x+1\right|=\mathrm{-3}$
...
$4{\left(t-1\right)}^{2}-9\left(t-1\right)=\mathrm{-2}$
...
Find the height of a 72-kg female to the nearest cm whose $BSA=\mathrm{1.8.}$

Find the weight of a 177-cm male to the nearest kg whose $BSA=\mathrm{2.1.}$
