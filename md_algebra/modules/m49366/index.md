...
1. **Solving Exponential Equations.**   Solve: ${3}^{2x-5}=27.$
...
|  | $x=4$ |
| Check the solution by substituting x=4 into the original equation. | ${3}^{2\left(4\right)-5}=27$ |
|  | $27=27,$ True |
</details>

<hr/>

2. Solve $3{e}^{x+2}=24$ . Find the exact answer and then approximate it to three decimal places.
...
| Take the natural logarithm of both sides. | $\mathrm{ln}\ {e}^{x+2}=\mathrm{ln}\ 8$ |
| Use the Power Property to get the x as a factor, not an exponent. | $(x+2)\mathrm{ln}\ e=\mathrm{ln}\ 8$ |
| Use the property $\mathrm{ln}e=1$ to simplify. | $x+2=\mathrm{ln}8$ |
| Solve the equation. Find the exact answer. | $x=\mathrm{ln}8-2$ |
...
| Use the Quotient Property on the left side and the Power Property on the right. | ${\mathrm{log}}_{4}\ \frac{x+6}{2x+5}={\mathrm{log}}_{4}{x}^{-1}$ |
| :--- | :--- |
| Rewrite ${x}^{-1}$ as $\frac{1}{x}$. | ${\mathrm{log}}_{4}\ \frac{x+6}{2x+5}={\mathrm{log}}_{4}\frac{1}{x}$ |
| Use the One-to-One Property. | $\frac{x+6}{2x+5}=\frac{1}{x}$ |
| Solve the rational equation. | $x(x+6)=2x+5$ |
| Distribute and write in standard form. | ${x}^{2}+4x-5=0$ |
| Factor and solve for x. | $(x+5)(x-1)=0$ , $x=-5$ , $x=1$ |
| Check: | x=–5 is extraneous solution because $2\left(-5\right)+5<0$ so  x=1 is the only solution. |
</details>

> Try It
> 9. Use the following steps to help solve the equation below.   Solve $\mathrm{log}(x+2)-\mathrm{log}\ 3=1$   Use properties of logarithms to rewrite the left side as a single log term.  Convert to exponential form.   Solve for x. Check.
>

> Try It
> 10. Use the following steps to help solve the equation below.  Solve $\mathrm{log}x+\mathrm{log}\ (x+1)\ =2$   Use properties of logarithms to rewrite the left side as a single log term.   Use the One-to-One Property.   Solve the quadratic equation.   Check.
>
...
11. ${\mathrm{log}}_{3}x=5$

12. ${\mathrm{log}}_{2}(x+1)+{\mathrm{log}}_{2}(x-1)=3$

13. $\mathrm{log}(x-2)-\mathrm{log}(4x+16)=\mathrm{log}\frac{1}{x}$

![Wild rabbits in Australia. The rabbit population grew so quickly in Australia that the event became known as the “rabbit plague.” (credit: Richard Taylor, Flickr)](../../media/CNX_Precalc_Figure_04_06_001.jpg)
...
For example, consider the equation ${3}^{4x-7}=\frac{{3}^{2x}}{3}.$ To solve for $x,$ we use the division property of exponents to rewrite the right side so that both sides have the common base, $3.$ Then we apply the one-to-one property of exponents by setting the exponents equal to one another and solving for $x$:
 $$
\begin{array}{lll}{3}^{4x-7}  & =\frac{{3}^{2x}}{3}  &   \\ {3}^{4x-7}  & =\frac{{3}^{2x}}{{3}^{1}}  & {\text{Rewrite\ 3\ as\ 3}}^{1}.  \\ {3}^{4x-7}  & ={3}^{2x-1}  & \text{Use\ the\ division\ property\ of\ exponents}\text{.}  \\ 4x-7  & =2x-1\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\text{}  & \text{Apply\ the\ one-to-one\ property\ of\ exponents}\text{.}  \\ 2x  & =6  & \text{Subtract\ 2}x\phantom{\rule{0.4em}{0ex}}\text{and\ add\ 7\ to\ both\ sides}\text{.}  \\ x  & =3  & \text{Divide\ by\ 2}\text{.}  \end{array}
$$ 
...
14. **Solving an Exponential Equation with a Common Base**   Solve ${2}^{x-1}={2}^{2x-4}.$

<details>
<summary>Solution</summary>

$$
\begin{array}{ll}\ {2}^{x-1}={2}^{2x-4}  & \text{The\ common\ base\ is\}2.  \\ x-1=2x-4\begin{array}{cccc}& & & \end{array}  & \text{By\ the\ one-to-one\ property\ the\ exponents\ must\ be\ equal}.  \\ x=3  & \text{Solve\ for\}x.  \end{array}
$$
</details>

>
> Try It
> 15. Solve ${5}^{2x}={5}^{3x+2}.$
>
> <details>
> <summary>Solution</summary>
>
...
$$
\begin{array}{ll}{8}^{x+2}={16}^{x+1}  &   \\ {\left({2}^{3}\right)}^{x+2}={\left({2}^{4}\right)}^{x+1}  & \text{Write}\phantom{\rule{0.5em}{0ex}}8\phantom{\rule{0.5em}{0ex}}\text{and}\phantom{\rule{0.5em}{0ex}}16\phantom{\rule{0.5em}{0ex}}\text{as\ powers\ of}\phantom{\rule{0.5em}{0ex}}2.  \\ {2}^{3x+6}={2}^{4x+4}  & \text{To\ take\ a\ power\ of\ a\ power,\ multiply\ exponents}.  \\ 3x+6=4x+4  & \text{Use\ the\ one-to-one\ property\ to\ set\ the\ exponents\ equal}.  \\ x=2  & \text{Solve\ for\}x.  \end{array}
$$
</details>
...
$$
\begin{array}{ll}{2}^{5x}={2}^{\frac{1}{2}}  & \text{Write\ the\ square\ root\ of\ \ 2\ as\ a\ power\ of}\phantom{\rule{0.5em}{0ex}}2.  \\ 5x=\frac{1}{2}  & \text{Use\ the\ one-to-one\ property}.  \\ x=\frac{1}{10}  & \text{Solve\ for}\phantom{\rule{0.5em}{0ex}}x.  \end{array}
$$
</details>
...
$$
\begin{array}{ll}{5}^{x+2}={4}^{x}  & \text{There is no easy way to get the powers to have the same base}.  \\ \mathrm{ln}{5}^{x+2}=\mathrm{ln}{4}^{x}  & \text{Take ln of both sides}.  \\ (x+2)\mathrm{ln}5=x\mathrm{ln}4  & \text{Use laws of logs}.  \\ x\mathrm{ln}5+2\mathrm{ln}5=x\mathrm{ln}4  & \text{Use the distributive law}.  \\ x\mathrm{ln}5-x\mathrm{ln}4=-2\mathrm{ln}5  & \text{Get terms containing}\phantom{\rule{0.4em}{0ex}}x\phantom{\rule{0.4em}{0ex}}\text{on one side, terms without}\phantom{\rule{0.4em}{0ex}}x\phantom{\rule{0.4em}{0ex}}\text{on the other}.  \\ x(\mathrm{ln}5-\mathrm{ln}4)=-2\mathrm{ln}5  & \text{On the left hand side, factor out an}x.  \\ x\mathrm{ln}\left(\frac{5}{4}\right)=\mathrm{ln}\left(\frac{1}{25}\right)\begin{array}{cccc}& & & \end{array}  & \text{Use the laws of logs.}  \\ x=\frac{\mathrm{ln}\left(\frac{1}{25}\right)}{\mathrm{ln}\left(\frac{5}{4}\right)}  & \text{Divide by the coefficient of}\phantom{\rule{0.4em}{0ex}}x.  \end{array}
$$
</details>
...
$$
\begin{array}{lll}100  & =20{e}^{2t}  &   \\ 5  & ={e}^{2t}  & \text{Divide\ by\ the\ coefficient\ of\ the\ power.}  \\ \mathrm{ln}5  & =2t  & \text{Take\ ln\ of\ both\ sides}\text{.\ Use\ the\ fact\ that\}\mathrm{ln}(x)\phantom{\rule{0.4em}{0ex}}\text{and\}{e}^{x}\phantom{\rule{0.5em}{0ex}}\text{are\ inverse\ functions}\text{.}  \\ t  & =\frac{\mathrm{ln}5}{2}  & \text{Divide\ by\ the\ coefficient\ of\}t\text{.}  \end{array}
$$
</details>
...
$$
\begin{array}{ll}4{e}^{2x}+5=12  &   \\ 4{e}^{2x}=7  & \text{Combine\ like\ terms}.  \\ {e}^{2x}=\frac{7}{4}  & \text{Divide\ by\ the\ coefficient\ of\ the\ power}.  \\ 2x=\mathrm{ln}\left(\frac{7}{4}\right)  & \text{Take\ ln\ of\ both\ sides}.  \\ x=\frac{1}{2}\mathrm{ln}\left(\frac{7}{4}\right)  & \text{Solve\ for\}x.  \end{array}
$$
</details>
...
$\begin{array}{lll}  {e}^{2x}-{e}^{x}& =56  &   \\   {e}^{2x}-{e}^{x}-56& =0  & \text{Get one side of the equation equal to zero}.  \\   ({e}^{x}+7)({e}^{x}-8)& =0  & \text{Factor by the FOIL method}.  \\   {e}^{x}+7& =0\phantom{\rule{0.4em}{0ex}}\text{or}{e}^{x}-8=0\begin{array}{cccc}& & & \end{array}  & \text{If a product is zero, then one factor must be zero}.  \\   {e}^{x}& =-7{\phantom{\rule{0.4em}{0ex}}\text{or e}}^{x}=8  & \text{Isolate the exponentials}.  \\   {e}^{x}& =8  & \text{Reject the equation in which the power equals a negative number}.  \\   x& =\mathrm{ln}8  & \text{Solve the equation in which the power equals a positive number}.  \end{array}$
</details>
...
30. **Using Algebra to Solve a Logarithmic Equation**   Solve $2\mathrm{ln}x+3=7.$

<details>
<summary>Solution</summary>

$$
\begin{array}{ll}2\mathrm{ln}x+3=7  &   \\ 2\mathrm{ln}x=4  & \text{Subtract\ 3}.  \\ \mathrm{ln}x=2  & \text{Divide\ by\ 2}.  \\ x={e}^{2}  & \text{Rewrite\ in\ exponential\ form}.  \end{array}
$$
</details>
...
$$
\begin{array}{ll}2\mathrm{ln}(6x)=7  &   \\ \mathrm{ln}(6x)=\frac{7}{2}  & \text{Divide\ by\ 2}.  \\ 6x={e}^{\left(\frac{7}{2}\right)}  & \text{Use\ the\ definition\ of\}\mathrm{ln}.  \\ x=\frac{1}{6}{e}^{\left(\frac{7}{2}\right)}  & \text{Divide\ by\ 6}.  \end{array}
$$
</details>
...
$$
\begin{array}{ll}\mathrm{ln}x=3  &   \\ x={e}^{3}  & \text{Use\ the\ definition\ of\ the\ natural\ logarithm}\text{.}  \end{array}
...
![The graphs of $y=\mathrm{ln}x$ and $y=3$ cross at the point ${\text{(e}}^{3},3),$ which is approximately (20.0855, 3).](../../media/CNX_Precalc_Figure_04_06_003.jpg)
</details>
...
$$
\begin{array}{ll}\mathrm{ln}({x}^{2})=\mathrm{ln}(2x+3)  &   \\ {x}^{2}=2x+3  & \text{Use\ the\ one-to-one\ property\ of\ the\ logarithm}.  \\ {x}^{2}-2x-3=0  & \text{Get\ zero\ on\ one\ side\ before\ factoring}.  \\ (x-3)(x+1)=0  & \text{Factor\ using\ FOIL}.  \\ x-3=0\phantom{\rule{0.5em}{0ex}}\text{or\}x+1=0\begin{array}{cccc}& & & \end{array}  & \text{If\ a\ product\ is\ zero,\ one\ of\ the\ factors\ must\ be\ zero}.  \\ x=3\phantom{\rule{0.4em}{0ex}}\text{or}\phantom{\rule{0.4em}{0ex}}x=-1  & \text{Solve\ for\}x.  \end{array}
$$
</details>
...
$$
\begin{array}{ll}y=\text{1000}e\frac{\mathrm{ln}(0.5)}{\text{703,800,000}}t  &   \\ 900=1000{e}^{\frac{\mathrm{ln}(0.5)}{\text{703,800,000}}t}  & \text{After 10\% decays, 900 grams are left}.  \\ 0.9={e}^{\frac{\mathrm{ln}(0.5)}{\text{703,800,000}}t}  & \text{Divide by 1000}.  \\ \mathrm{ln}(0.9)=\mathrm{ln}\left({e}^{\frac{\mathrm{ln}(0.5)}{\text{703,800,000}}t}\right)  & \text{Take ln of both sides}.  \\ \mathrm{ln}(0.9)=\frac{\mathrm{ln}(0.5)}{\text{703,800,000}}t  & \text{ln}({e}^{M})=M  \\ t=\text{703,800,000}\times \frac{\mathrm{ln}(0.9)}{\mathrm{ln}(0.5)}\text{years}\begin{array}{cccc}& & & \end{array}  & \text{Solve for}\phantom{\rule{0.4em}{0ex}}t.  \\ t\approx \text{106,979,777 years}  &   \end{array}
$$
</details>
...
| :--- | :--- |
| Definition of a logarithm | For any algebraic expression *S* and positive real numbers $\text{}b\$ and $\text{}c,$ where $\text{}b\ne 1,$  ${\mathrm{log}}_{b}(S)=c$ if and only if $\text{}{b}^{c}=S.$ |
| One-to-one property for logarithmic functions | For any algebraic expressions *S* and *T* and any positive real number $\text{}b,$ where $\text{}b\ne 1,$  ${\mathrm{log}}_{b}S={\mathrm{log}}_{b}T$ if and only if $\text{}S=T.$ |
...
40. ${\mathrm{log}}_{4}\left(6-m\right)={\mathrm{log}}_{4}3m$
...
42. ${\mathrm{log}}_{9}\left(2{n}^{2}-14n\right)={\mathrm{log}}_{9}\left(-45+{n}^{2}\right)$
...
44. $\mathrm{log}(x+12)=\mathrm{log}(x)+\mathrm{log}(12)$

45. $\mathrm{ln}(x)+\mathrm{ln}(x-3)=\mathrm{ln}(7x)$
...
![Graph of log_9(x)-5=y and y=-4.](../../media/CNX_PreCalc_Figure_04_06_201.jpg)
</details>
...
![Graph of ln(3x)=y and y=2.](../../media/CNX_PreCalc_Figure_04_06_203.jpg)
</details>
...
![Graph of log(4)+log(-5x)=y and y=2.](../../media/CNX_PreCalc_Figure_04_06_205.jpg)
</details>
...
![Graph of ln(4x-10)-6=y and y=-5.](../../media/CNX_PreCalc_Figure_04_06_207.jpg)
</details>
...
![Graph of log_11(-2x^2-7x)=y and y=log_11(x-2).](../../media/CNX_PreCalc_Figure_04_06_209.jpg)
</details>
...
![Graph of log_9(3-x)=y and y=log_9(4x-8).](../../media/CNX_PreCalc_Figure_04_06_211.jpg)
</details>
...
![Graph of 3/log_2(10)-log(x-9)=y and y=log(44).](../../media/CNX_PreCalc_Figure_04_06_213.jpg)
</details>
...
![Graph of f(x)=6500e^(0.0725x) with the labeled point at (20, 27710.24).](../../media/CNX_PreCalc_Figure_04_06_215.jpg)
</details>
...
![Graph of P(t)=1650e^(0.5x) with the labeled point at (5, 20000).](../../media/CNX_PreCalc_Figure_04_06_217.jpg)
</details>
...
79. Recall the formula for continually compounding interest, $y=A{e}^{kt}.$ Use the definition of a logarithm along with properties of logarithms to solve the formula for time $t$ such that $t$ is equal to a single logarithm.
