...
![This figure shows the graph of a straight line on the x y-coordinate plane. The x-axis runs from negative 3 to 6. The y-axis runs from negative 3 to 2. The line goes through the points (0, 1) and (5, negative 2).](../../media/CNX_IntAlg_Figure_03_02_302_img_new.jpg)
...
![This figure shows the graph of a straight line on the x y-coordinate plane. The x-axis runs from negative 8 to 8. The y-axis runs from negative 8 to 8. The line goes through the points (0, negative 5) and (2, negative 2).](../../media/CNX_IntAlg_Figure_03_02_202_img_new.jpg)
  ...
  Use the slope formula to find the slope of the linear function satisfying the condition below. $f\left(-2\right)=-1,f\left(6\right)=5$
...
Find an equation of the line given two points.
 ...
 $(-5,-3)$ and $(4,-6)$
  ...
  Find the equation of a line containing the given points. Write the equation in slope-intercept form.
 $f\left(-2\right)=8,f\left(4\right)=6$
  ...
  Derek notices the amount he receives in tips each night is a linear function of the number of tables he waits on. On Friday evening he waits on 22 tables and receives $87 in tips, and on Tuesday evening he waits on 18 tables and receives $73 in tips.
          ...
          ⓐ Record the information given above as two data points.
     
     
          ⓑ Find the slope of this linear function in terms of $\frac{\$}{table}$ .
     
     
          ⓒ Write a linear function S(t) that will let him estimate the amount in $ in tips he will receive as a function of tables, t, waited on.
...
===================================================
 ...
 $\begin{array}{cc}\text{Equation\ form}\phantom{\rule{2em}{0ex}}\hfill & y=mx+b\hfill \\ \text{Function\ notation}\phantom{\rule{2em}{0ex}}\hfill & f(x)=mx+b\hfill \end{array}$
...
=======================================================
            ...
            The pressure, $P,$ in pounds per square inch (PSI) on the diver in  depends upon her depth below the water surface, $d,$ in feet. This relationship may be modeled by the equation, $P(d)=0.434d+\mathrm{14.696.}$ Restate this function in words.
\n\n![(credit: Ilse Reijs and Jan-Noud Hutten)](../../media/CNX_Precalc_Figure_02_01_003.jpg)\n\n
...
Note that in function notation we can obtain two corresponding values for the output ${y}_{1}$ and ${y}_{2}$ for the function $f,$ ${y}_{1}=f\left({x}_{1}\right)$ and ${y}_{2}=f\left({x}_{2}\right),$ so we could equivalently write
...
\n\n![The slope of a function is calculated by the change in $y$ divided by the change in $x.$ It does not matter which coordinate is used as the $\left({x}_{2,}{y}_{2} ight)$ and which is the $\left({x}_{1},{y}_{1} ight),$ as long as each calculation is started with the elements from the same coordinate pair.](../../media/CNX_Precalc_Figure_02_01_005.jpg)\n\n
Q&A
...
If $f(x)$ is a linear function, and $(3,\mathrm{-2})$ and $(8,1)$ are points on the line, find the slope. Is this function increasing or decreasing?
...
As noted earlier, the order in which we write the points does not matter when we compute the slope of the line as long as the first output value, or *y*-coordinate, used corresponds with the first input value, or *x*-coordinate, used. Note that if we had reversed them, we would have obtained the same slope.
 ...
 $m=\frac{\left(\mathrm{-2}\right)-(1)}{3-8}=\frac{-3}{-5}=\frac{3}{5}$
...
Now we can substitute the slope and the coordinates of one of the points into the point-slope form.
 ...
 $\begin{array}{ccc}\hfill y-{y}_{1}& =& m(x-{x}_{1})\hfill \\ \hfill \phantom{\rule{0.5em}{0ex}}\text{}y-4& =& -\frac{3}{4}(x-4)\hfill \end{array}$
If we want to rewrite the equation in the slope-intercept form, we would find

 $\begin{array}{ccc}\hfill y-4& =& -\frac{3}{4}(x-4)\hfill \\ \hfill y-4& =& -\frac{3}{4}x+3\hfill \\ \hfill y& =& -\frac{3}{4}x+7\hfill \end{array}$
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_01_008a.jpg)\n\n

Identify two points on the line, such as $(0,2)$ and $(\mathrm{-2},\mathrm{-4}).$ Use the points to calculate the slope.
 $\begin{array}{ccc}\hfill m& =& \frac{{y}_{2}-{y}_{1}}{{x}_{2}-{x}_{1}}\hfill \\ & =& \frac{\mathrm{-4}-2}{\mathrm{-2}-0}\hfill \\ & =& \frac{\mathrm{-6}}{\mathrm{-2}}\hfill \\ & =& 3\hfill \end{array}$
Substitute the slope and the coordinates of one of the points into the point-slope form.

 $\begin{array}{ccc}\hfill y-{y}_{1}& =& m(x-{x}_{1})\hfill \\ \hfill y-(\mathrm{-4})& =& 3(x-(\mathrm{-2}))\hfill \\ \hfill y+4& =& 3(x+2)\hfill \end{array}$
...
This makes sense because we can see from  that the line crosses the *y*-axis at the point $\left(0,\phantom{\rule{0.5em}{0ex}}\text{}2\right),$ which is the *y*-intercept, so $b=2.$

\n\n![Image](../../media/CNX_Precalc_Figure_02_01_008b.jpg)\n\n
...
If Ben produces 100 items in a month, his monthly cost is found by substituting 100 for $x.$
 ...
 $\begin{array}{ccc}\hfill C(100)& =& 1250+37.5(100)\hfill \\ & =& 5000\hfill \end{array}$
So his monthly cost would be $5,000.

Writing an Equation for a Linear Function Given Two Points
==========================================================

If $f$ is a linear function, with $f(3)=\mathrm{-2},$ and $f(8)=1,$ find an equation for the function in slope-intercept form.

We can write the given points using coordinates.

 $\begin{array}{ccc}\hfill f(3)& =& -2\to (3,\mathrm{-2})\hfill \\ \hfill f(8)& =& 1\to (8,1)\hfill \end{array}$
We can then use the points to calculate the slope.

 $\begin{array}{ccc}\hfill m& =& \frac{{y}_{2}-{y}_{1}}{{x}_{2}-{x}_{1}}\hfill \\ & =& \frac{1-(\mathrm{-2})}{8-3}\hfill \\ & =& \frac{3}{5}\hfill \end{array}$
Substitute the slope and the coordinates of one of the points into the point-slope form.

 $\begin{array}{ccc}\hfill y-{y}_{1}& =& m\left(x-{x}_{1}\right)\hfill \\ \hfill y-(\mathrm{-2})& =& \frac{3}{5}(x-3)\hfill \end{array}$

We can use algebra to rewrite the equation in the slope-intercept form.

 $\begin{array}{ccc}\hfill y+2& =& \frac{3}{5}(x-3)\hfill \\ \hfill y+2& =& \frac{3}{5}x-\frac{9}{5}\hfill \\ \hfill y& =& \frac{3}{5}x-\frac{19}{5}\hfill \end{array}$

Try It

If $f(x)$ is a linear function, with $f(2)=\mathrm{\u201311},$ and $f(4)=\mathrm{-25},$ write an equation for the function in slope-intercept form.
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_01_010.jpg)\n\n
...
With this formula, we can then predict how many songs Marcus will have at the end of one year (12 months). In other words, we can evaluate the function at $t=12.$
 ...
 $\begin{array}{ccc}N(12)& =& 15(12)+200\hfill \\ & =& 180+200\hfill \\ & =& 380\hfill \end{array}$
...
The given information gives us two input-output pairs: $(3,760)$ and $(5,\text{92}0).$ We start by finding the rate of change.
 $\begin{array}{ccc}\hfill m& =& \frac{920-760}{5-3}\hfill \\ & =& \frac{\$160}{2\ \text{policies}}\hfill \\ & =& \text{\$}80\phantom{\rule{0.5em}{0ex}}\text{per}\phantom{\rule{0.5em}{0ex}}\text{policy}\hfill \end{array}$
...
We can then solve for the initial value.
 ...
 $\begin{array}{cccc}\hfill I(n)& =& 80n+b\hfill & \\ \hfill 760& =& 80(3)+b\hfill & \phantom{\rule{1em}{0ex}}\text{\hspace{1em}}\text{when}\phantom{\rule{0.5em}{0ex}}n=3,I(3)=760\hfill \\ \hfill 760& -& 80(3)=b\hfill & \\ \hfill 520& =& b\hfill & \end{array}$
...
If we did not notice the rate of change from the table we could still solve for the slope using any two points from the table. For example, using $(2,1080)$ and $(6,1240)$
 $\begin{array}{ccc}\hfill m& =& \frac{1240-1080}{6-2}\hfill \\ & =& \frac{160}{4}\hfill \\ & =& 40\hfill \end{array}$
...
Try It
 ...
 A new plant food was introduced to a young tree to test its effect on the height of the tree.  shows the height of the tree, in feet, $x$ months since the measurements began. Write a linear function, $H(x),$ where $x$ is the number of months since the start of the experiment.
...
Evaluate the function at each input value, and use the output value to identify coordinate pairs.
 ...
 $\begin{array}{cc}\hfill x=0& \phantom{\rule{2em}{0ex}}f(0)=-\frac{2}{3}(0)+5=5\Rightarrow (0,5)\hfill \\ \hfill x=3& \phantom{\rule{2em}{0ex}}f(3)=-\frac{2}{3}(3)+5=3\Rightarrow (3,3)\hfill \\ \hfill x=6& \phantom{\rule{2em}{0ex}}f(6)=-\frac{2}{3}(6)+5=1\Rightarrow (6,1)\hfill \end{array}$
Plot the coordinate pairs and draw a line through the points.  represents the graph of the function $f(x)=-\frac{2}{3}x+5.$

\n\n![The graph of the linear function $f(x)=-\frac{2}{3}x+5.$](../../media/CNX_Precalc_Figure_02_02_001.jpg)\n\n
...
![This graph shows a decreasing function graphed on an x y coordinate plane. The x-axis runs from negative 8 to 10 and the y-axis runs from negative 8 to 8. The function passes through the points (0,6), (4,3) and (8,0).](../../media/CNX_Precalc_Figure_02_02_002.jpg)
...
\n\n![Graph of $f(x)=\mathrm{-2}/3x+5$ and shows how to calculate the rise over run for the slope.](../../media/CNX_Precalc_Figure_02_02_004.jpg)\n\n
...
Find a point on the graph we drew in  that has a negative *x*-value.
...
*No. The order of the transformations follows the order of operations. When the function is evaluated at a given input, the corresponding output is calculated by following the order of operations. This is why we performed the compression first. For example, following the order: Let the input be 2.*
 ...
 $\begin{array}{ccc}\hfill f(2)& =& \frac{1}{2}(2)-3\hfill \\ & =& 1-3\hfill \\ & =& \mathrm{-2}\hfill \end{array}$
...
ⓓ $j\left(x\right)=\frac{1}{2}x+3$ 
 ...
 \n\n![Image](../../media/CNX_Precalc_Figure_02_02_011.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_012.jpg)\n\n
...
A graph of the function is shown in . We can see that the *x*-intercept is $(6,\text{0})$ as we expected.

\n\n![Image](../../media/CNX_Precalc_Figure_02_02_013.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_017.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_018.jpg)\n\n
...
\n\n![Parallel lines](../../media/CNX_Precalc_Figure_02_02_019.jpg)\n\nWe can determine from their equations whether two lines are parallel by comparing their slopes. If the slopes are the same and the *y*-intercepts are different, the lines are parallel. If the slopes are different, the lines are not parallel.

 $\begin{array}{cc}\begin{array}{l}f(x)=-2x+6\hfill \\ f(x)=-2x-4\hfill \end{array}\}\phantom{\rule{0.5em}{0ex}}\text{parallel}\phantom{\rule{2em}{0ex}}& \begin{array}{l}f(x)=3x+2\hfill \\ f(x)=2x+2\hfill \end{array}\}\phantom{\rule{0.5em}{0ex}}\text{not\ parallel}\end{array}$
...
As with parallel lines, we can determine whether two lines are perpendicular by comparing their slopes, assuming that the lines are neither horizontal nor vertical. The slope of each line below is the negative reciprocal of the other so the lines are perpendicular.
 ...
 $\begin{array}{cccc}\hfill f(x)& =& \frac{1}{4}x+2\hfill & \phantom{\rule{2em}{0ex}}\text{negative\ reciprocal\ of}\phantom{\rule{0.5em}{0ex}}\frac{1}{4}\phantom{\rule{0.5em}{0ex}}\text{is\}\mathrm{-4}\hfill \\ \hfill f(x)& =& \mathrm{-4}x+3\hfill & \phantom{\rule{2em}{0ex}}\text{negative\ reciprocal\ of}\phantom{\rule{0.5em}{0ex}}\mathrm{-4}\phantom{\rule{0.5em}{0ex}}\text{is\}\frac{1}{4}\hfill \end{array}$
...
Given the functions below, identify the functions whose graphs are a pair of parallel lines and a pair of perpendicular lines.
 ...
 $\begin{array}{cccccc}\hfill f(x)& =& 2x+3\hfill & \hfill \phantom{\rule{2em}{0ex}}h(x)& =& -2x+2\hfill \\ \hfill g(x)& =& \frac{1}{2}x-4\hfill & \hfill \phantom{\rule{2em}{0ex}}j(x)& =& 2x-6\hfill \end{array}$
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_021.jpg)\n\n
The graph shows that the lines $f(x)=2x+3$ and $j(x)=2x\u20136$ are parallel, and the lines $g(x)=\frac{1}{2}x\u20134$ and $h(x)=-2x+2$ are perpendicular.
...
Suppose for example, we are given the equation shown.
 ...
 $\begin{array}{ccc}\hfill g(x)& =& 3x+6\hfill \\ \hfill h(x)& =& 3x+1\hfill \\ \hfill p(x)& =& 3x+\frac{2}{3}\hfill \end{array}$
Suppose then we want to write the equation of a line that is parallel to $f$ and passes through the point $(1,\text{7}).$ This type of problem is often described as a point-slope problem because we have a point and a slope. In our example, we know that the slope is 3. We need to determine which value of $b$ will give the correct line. We can begin with the point-slope form of an equation for a line, and then rewrite it in the slope-intercept form.
 $\begin{array}{ccc}\hfill y-{y}_{1}& =& m(x-{x}_{1})\hfill \\ \hfill y-7& =& 3(x-1)\hfill \\ \hfill y-7& =& 3x-3\hfill \\ \hfill y& =& 3x+4\hfill \end{array}$
...
The slope of the given line is 3. If we choose the slope-intercept form, we can substitute $m=3,x=3,$ and $f(x)=0$ into the slope-intercept form to find the *y-*intercept.
 $\begin{array}{ccc}\hfill g(x)& =& 3x+b\hfill \\ \hfill 0& =& 3(3)+b\hfill \\ \hfill b& =& \mathrm{\u20139}\hfill \end{array}$
The line parallel to $f(x)$ that passes through $(3,\text{0})$ is $g(x)=3x-9.$

Analysis
========

We can confirm that the two lines are parallel by graphing them.  shows that the two lines will never intersect.

\n\n![Image](../../media/CNX_Precalc_Figure_02_02_022.jpg)\n\n
...
The slope of the line is 2, and its negative reciprocal is $-\frac{1}{2}.$ Any function with a slope of $-\frac{1}{2}$ will be perpendicular to $f(x).$ So the lines formed by all of the following functions will be perpendicular to $f(x).$
 ...
 $\begin{array}{ccc}\hfill g(x)& =& -\frac{1}{2}x+4\hfill \\ \hfill h(x)& =& -\frac{1}{2}x+2\hfill \\ \hfill p(x)& =& -\frac{1}{2}x-\frac{1}{2}\hfill \end{array}$
As before, we can narrow down our choices for a particular perpendicular line if we know that it passes through a given point. Suppose then we want to write the equation of a line that is perpendicular to $f(x)$ and passes through the point $(4,\text{0}).$ We already know that the slope is $-\frac{1}{2}.$ Now we can use the point to find the *y*-intercept by substituting the given values into the slope-intercept form of a line and solving for $b.$
 $\begin{array}{ccc}\hfill g(x)& =& mx+b\hfill \\ \hfill 0& =& -\frac{1}{2}(4)+b\hfill \\ \hfill 0& =& \mathrm{-2}+b\hfill \\ \hfill 2& =& b\hfill \\ \hfill b& =& 2\hfill \end{array}$
...
Find the equation of a line perpendicular to $f(x)=3x+3$ that passes through the point $(3,\text{0}).$
...
The original line has slope $m=3,$ so the slope of the perpendicular line will be its negative reciprocal, or $-\frac{1}{3}.$ Using this slope and the given point, we can find the equation of the line.
 ...
 $\begin{array}{ccc}\hfill g(x)& =& \u2013\frac{1}{3}x+b\hfill \\ \hfill 0& =& \u2013\frac{1}{3}(3)+b\hfill \\ \hfill 1& =& b\hfill \\ \hfill b& =& 1\hfill \end{array}$
...
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_023.jpg)\n\n
...
Given the function $h(x)=2x-4,$ write an equation for the line passing through $\left(0,0\right)$ that is
...
A line passes through the points $(\mathrm{-2},\text{6})$ and $(4,5).$ Find the equation of a perpendicular line that passes through the point $(4,5).$

From the two points of the given line, we can calculate the slope of that line.

 $\begin{array}{ccc}\hfill {m}_{1}& =& \frac{5-6}{4-(\mathrm{-2})}\hfill \\ & =& \frac{-1}{6}\hfill \\ & =& -\frac{1}{6}\hfill \end{array}$
Find the negative reciprocal of the slope.

 $\begin{array}{ccc}\hfill {m}_{2}& =& \frac{-1}{-\frac{1}{6}}\hfill \\ & =& \mathrm{-1}\left(-\frac{6}{1}\right)\hfill \\ & =& 6\hfill \end{array}$
We can then solve for the *y-*intercept of the line passing through the point $(4,5).$
 $\begin{array}{ccc}\hfill g(x)& =& 6x+b\hfill \\ \hfill 5& =& 6(4)+b\hfill \\ \hfill 5& =& 24+b\hfill \\ \hfill \mathrm{-19}& =& b\hfill \\ \hfill b& =& \mathrm{-19}\hfill \end{array}$
...
A line passes through the points, $(\mathrm{-2},\text{\u221215})$ and $(2,\mathrm{-3}).$ Find the equation of a perpendicular line that passes through the point, $(6,4).$
...
Passes through $(\mathrm{-1},\text{4})$ and $(5,2)$
$y=-\frac{1}{3}x+\frac{11}{3}$
Passes through $(\mathrm{-2},\text{8})$ and $(4,\text{6})$
*x* intercept at $(\mathrm{-2},0)$ and *y* intercept at $(0,\mathrm{-3})$
$y=-1.5x-3$
*x* intercept at $(\mathrm{-5},\text{0})$ and *y* intercept at $(0,4)$
...
Line 1: Passes through $(2,3)$ and $(4,\mathrm{-1})$
...
![This is a graph of a decreasing linear function on an x, y coordinate plane. The x-axis runs from negative 6 to 6. The y-axis runs from negative 6 to 6. The line passes through points (0, 5) and (4, 0).](../../media/CNX_Precalc_Figure_02_01_202-2cc8.jpg)

![This is a graph of a function on an x, y coordinate plane. The x-axis runs from negative 6 to 6. The y-axis runs from negative 6 to 6. The lines passes through points at (0, -2) and (2, -2).](../../media/CNX_Precalc_Figure_02_01_203-9e0c.jpg)

0

For the following exercises, write an equation for the line graphed.

![Graph of an increasing linear function with points at (0,1) and (3,3)](../../media/CNX_Precalc_Figure_02_01_205-50b9.jpg)

![Graph of a decreasing linear function with points (0,5) and (4,0)](../../media/CNX_Precalc_Figure_02_01_206-ae2b.jpg)

$y=-\frac{5}{4}x+5$

![Graph of a decreasing linear function with points at (0,3) and (1.5,0)](../../media/CNX_Precalc_Figure_02_01_207.jpg)

	

![Graph of an increasing linear function with points at (1,2) and (0,-2)](../../media/CNX_Precalc_Figure_02_01_208-ed56.jpg)

$y=3x-1$

![Graph of a function with points at (0, 3) and (3, 3)](../../media/CNX_Precalc_Figure_02_01_209-1a57.jpg)

![Graph of a function with points at (0,-2.5) and (-2.5,-2.5)](../../media/CNX_Precalc_Figure_02_01_210-23b3.jpg)

$y=-2.5$

For the following exercises, match the given linear equation with its graph in .
\n\n![Image](../../media/CNX_Precalc_Figure_02_02_201.jpg)\n\n
$f\left(x\right)=-x-1$

$f\left(x\right)=\mathrm{-3}x-1$
...
![Graph of f with an x-intercept at -4 and y-intercept at -2 which gives us a slope of: 2.](../../media/CNX_Precalc_Figure_02_02_203.jpg)

A *y*-intercept of $(0,\text{7})$ and slope $-\frac{3}{2}$

A *y*-intercept of $(0,\text{3})$ and slope $\frac{2}{5}$

![Graph of f with an y-intercept at 3 and a slope of 2/5.](../../media/CNX_Precalc_Figure_02_02_205.jpg)

Passing through the points $(\mathrm{\u20136},\text{\u20132})$ and $(6,\text{\u20136})$

Passing through the points $(\mathrm{\u20133},\text{\u20134})$ and $(3,\text{0})$

![Graph of a line that passes through the points (-3, -4) and (3, 0) which results in a slope of 2/3.](../../media/CNX_Precalc_Figure_02_02_207.jpg)
...
![Graph of g(x) = -3x + 2 which goes through the points (0,2) and (1,-1) with a slope of -3.](../../media/CNX_Precalc_Figure_02_02_209-60a6.jpg)

$f\left(x\right)=\frac{1}{3}x+2$

$f\left(x\right)=\frac{2}{3}x-3$

![Graph of k(x) =  .  This line goes through the points (0,-3) and (3,-1) and has a slope of 2/3.](../../media/CNX_Precalc_Figure_02_02_211.jpg)

$f\left(t\right)=3+2t$

$p\left(t\right)=\mathrm{-2}+3t$

![Graph of the line p(t) = 3t -2.  This line goes through the points (0,-2) and (1,1) which has a slope of 3.](../../media/CNX_Precalc_Figure_02_02_226.jpg)

 $x=3$

$x=\mathrm{-2}$

![Graph of x = -2 which is a line of undefined slope that goes through the point (-2,0).](../../media/CNX_Precalc_Figure_02_02_214.jpg)

 $r\left(x\right)=4$

For the following exercises, write the equation of the line shown in the graph.

![The graph of a line with a slope of 0 and y-intercept at 3.](../../media/CNX_Precalc_Figure_02_02_222-612a.jpg)

$y=\text{3}$

![Graph of a line with a slope of 0 and y-intercept at -1.](../../media/CNX_Precalc_Figure_02_02_223-8721.jpg)

![Graph of a line with an undefined slope and x-intercept at -3.](../../media/CNX_Precalc_Figure_02_02_224-571d.jpg)

 $x=-3$

![Graph of a line with an undefined slope and x-intercept at 2](../../media/CNX_Precalc_Figure_02_02_225.jpg)
...
If $f$ is a linear function, $f(0.1)=11.5$ , and $f(0.4)=\mathrm{\u20135.9}$ , find an equation for the function.
...
![Graph of f(x) = 2500x + 4000](../../media/CNX_Precalc_Figure_02_01_214.jpg)
...
![graph where the function's slope is 75 and y-intercept is –22.5](../../media/CNX_PreCalc_Figure_04_01_201.jpg)
...
Find the value of $x$ if a linear function goes through the following points and has the following slope: $(x,2),(\mathrm{-4},6),\phantom{\rule{0.5em}{0ex}}m=3$
$y=-\frac{16}{3}$
Find the value of*y*if a linear function goes through the following points and has the following slope: $(10,y),(25,100),\phantom{\rule{0.5em}{0ex}}m=\mathrm{-5}$
Find the equation of the line that passes through the following points:

$\left(a,\phantom{\rule{0.5em}{0ex}}\text{}b\right)$ and $\left(a,\phantom{\rule{0.5em}{0ex}}\text{}b+1\right)$
$x=a$
Find the equation of the line that passes through the following points:
...
Find the equation of the line parallel to the line $g\left(x\right)=\mathrm{-0.}\text{01}x\text{+2}\text{.01}$ through the point $(1,\text{2}).$
Find the equation of the line perpendicular to the line $g\left(x\right)=\mathrm{-0.}\text{01}x\text{+2}\text{.01}$ through the point $(1,\text{2}).$
$y=100x\u201398$
...
Suppose that average annual income (in dollars) for the years 1990 through 1999 is given by the linear function: $I(x)=1054x+\mathrm{23,286}$, where $x$ is the number of years after 1990. Which of the following interprets the slope in the context of the problem?
...
ⓒEach year in the decade of the 1990s, average annual income increased by $1,054.
 ⓓAverage annual income rose to a level of $23,286 by the end of 1999.C
...
ⓒFind and interpret $F(\mathrm{\u201340}).$ 
