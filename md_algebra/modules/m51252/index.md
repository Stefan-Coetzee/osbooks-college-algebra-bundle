...
![Horizontal blank plot line with arrows on either side of the line.](../../media/blankplot-d9a0.png)

  $\mathrm{-\pi},\sqrt{25},1\frac{3}{4},0.8,2.55,-\frac{15}{16}$
...
ⓐ $\left(\mathrm{-5},4\right)$ ⓑ $\left(\mathrm{-3},\mathrm{-4}\right)$ ⓒ $\left(2,\mathrm{-3}\right)$ ⓓ $\left(0,\mathrm{-1}\right)$ ⓔ $\left(3,\frac{5}{2}\right).$
...
ⓐ $\left(\mathrm{-4},2\right)$ ⓑ $\left(\mathrm{-1},\mathrm{-2}\right)$ ⓒ $\left(3,\mathrm{-5}\right)$ ⓓ $\left(\mathrm{-3},0\right)$ ⓔ $\left(\frac{5}{3},2\right)$

ⓐ $\left(\mathrm{-2},\mathrm{-3}\right)$ ⓑ $\left(3,\mathrm{-3}\right)$ ⓒ $\left(\mathrm{-4},1\right)$ ⓓ $\left(4,\mathrm{-1}\right)$ ⓔ $\left(\frac{3}{2},1\right)$

ⓐ $\left(3,\mathrm{-1}\right)$ ⓑ $\left(\mathrm{-3},1\right)$ ⓒ $\left(\mathrm{-2},\phantom{\rule{0.2em}{0ex}}\text{0}\right)$ ⓓ $\left(\mathrm{-4},\mathrm{-3}\right)$ ⓔ $\left(1,\frac{14}{5}\right)$

ⓐ $\left(\mathrm{-1},1\right)$ ⓑ $\left(\mathrm{-2},\mathrm{-1}\right)$ ⓒ $\left(2,0\right)$ ⓓ $\left(1,\mathrm{-4}\right)$ ⓔ $\left(3,\frac{7}{2}\right)$
...
Plot the points $\left(\mathrm{-2},4\right),$ $\left(3,3\right),$ and $\left(0,\mathrm{-3}\right)$ in the plane.
...
Suppose we want to graph the equation $y=2x-1.$ We can begin by substituting a value for *x* into the equation and determining the resulting value of *y*. Each pair of *x*- and *y*-values is an ordered pair that can be plotted.  lists values of *x* from –3 to 3 and the resulting values for *y*.
 ...
 $\mathrm{-3}$ 
 $y=2(\mathrm{-3})-1=\mathrm{-7}$ 
 $\left(\mathrm{-3},\mathrm{-7}\right)$ 

 $\mathrm{-2}$ 
 $y=2(\mathrm{-2})-1=\mathrm{-5}$ 
 $\left(\mathrm{-2},\mathrm{-5}\right)$ 

 $\mathrm{-1}$ 
 $y=2(\mathrm{-1})-1=\mathrm{-3}$ 
...
First, we construct a table similar to . Choose *x* values and calculate *y.*
 ...
 $\mathrm{-5}$ 
 $y=-\left(\mathrm{-5}\right)+2=7$ 
 $\left(\mathrm{-5},7\right)$ 

 $\mathrm{-3}$ 
 $y=-\left(\mathrm{-3}\right)+2=5$ 
 $\left(\mathrm{-3},5\right)$ 

 $\mathrm{-1}$ 
 $y=-\left(\mathrm{-1}\right)+2=3$ 
 ...
 $3$ 
 $y=-\left(3\right)+2=\mathrm{-1}$ 
 $\left(3,\mathrm{-1}\right)$ 

 $5$ 
 $y=-\left(5\right)+2=\mathrm{-3}$ 
 $\left(5,\mathrm{-3}\right)$ 
...
Construct a table and graph the equation by plotting points: $y=\frac{1}{2}x+2.$
 ...
 $\mathrm{-2}$ 
 $y=\frac{1}{2}\left(\mathrm{-2}\right)+2=1$ 
 $\left(\mathrm{-2},1\right)$ 

 $\mathrm{-1}$ 
 $y=\frac{1}{2}\left(\mathrm{-1}\right)+2=\frac{3}{2}$ 
 $\left(-1,\frac{3}{2}\right)$ 

 $0$ 
 $y=\frac{1}{2}\left(0\right)+2=2$ 
 $\left(0,2\right)$ 

 $1$ 
 $y=\frac{1}{2}\left(1\right)+2=\frac{5}{2}$ 
 $\left(1,\frac{5}{2}\right)$ 

 $2$ 
 $y=\frac{1}{2}\left(2\right)+2=3$ 
 $\left(2,3\right)$
...
$$
\begin{array}{ll}\phantom{\rule{0.5em}{0ex}}y=3x-1\hfill & \hfill \\ \phantom{\rule{0.5em}{0ex}}0=3x-1\hfill & \hfill \\ \phantom{\rule{0.5em}{0ex}}1=3x\hfill & \hfill \\ \frac{1}{3}=x\hfill & \hfill \\ \left(\frac{1}{3},0\right)\hfill & x\text{\u2212intercept}\hfill \end{array}
$$
To find the *y-*intercept, set $x=0.$

$$
\begin{array}{l}y=3x-1\hfill \\ y=3(0)-1\hfill \\ y=\mathrm{-1}\hfill \\ (0,\mathrm{-1})\phantom{\rule{3em}{0ex}}y\text{\u2212intercept}\hfill \end{array}
...
$$
\begin{array}{l}\phantom{\rule{1em}{0ex}}y=\mathrm{-3}x-4\hfill \\ \phantom{\rule{1em}{0ex}}0=\mathrm{-3}x-4\hfill \\ \phantom{\rule{1em}{0ex}}4=\mathrm{-3}x\hfill \\ -\frac{4}{3}=x\hfill \\ \left(-\frac{4}{3},0\right)\phantom{\rule{3em}{0ex}}x\text{\u2212intercept}\hfill \end{array}
$$ Set $x=0$ to find the *y-*intercept.

$$
\begin{array}{l}y=\mathrm{-3}x-4\hfill \\ y=\mathrm{-3}(0)-4\hfill \\ y=\mathrm{-4}\hfill \\ (0,\mathrm{-4})\phantom{\rule{3.5em}{0ex}}y\text{\u2212intercept}\hfill \end{array}
$$
...
Find the distance between the points $\left(\mathrm{-3},\mathrm{-1}\right)$ and $\left(2,3\right).$
...
$$
\begin{array}{l}\\ \begin{array}{l}d=\sqrt{{({x}_{2}-{x}_{1})}^{2}+{({y}_{2}-{y}_{1})}^{2}}\hfill \\ d=\sqrt{{(2-(\mathrm{-3}))}^{2}+{(3-(\mathrm{-1}))}^{2}}\hfill \\ \phantom{\rule{.7em}{0ex}}=\sqrt{{(5)}^{2}+{(4)}^{2}}\hfill \\ \phantom{\rule{.7em}{0ex}}=\sqrt{25+16}\hfill \\ \phantom{\rule{.7em}{0ex}}=\sqrt{41}\hfill \end{array}\end{array}
$$
...
Number of Feet Driven
 ...
 $\left(0,0\right)$ to $\left(1,1\right)$ 
2,000

 $\left(1,1\right)$ to $\left(5,1\right)$

4,000

 $\left(5,1\right)$ to $\left(8,3\right)$ 
5,000

 $\left(8,3\right)$ to $\left(8,7\right)$ 
4,000
...
$$
\begin{array}{l}d=\sqrt{{(8-0)}^{2}+{(7-0)}^{2}}\hfill \\ \phantom{\rule{.7em}{0ex}}=\sqrt{64+49}\hfill \\ \phantom{\rule{.7em}{0ex}}=\sqrt{113}\hfill \\ \phantom{\rule{.7em}{0ex}}\approx 10.63\phantom{\rule{0.5em}{0ex}}\text{units}\hfill \end{array}
...
Find the midpoint of the line segment with the endpoints $\left(7,\mathrm{-2}\right)$ and $\left(9,5\right).$
...
Try It
Find the midpoint of the line segment with endpoints $\left(\mathrm{-2},\mathrm{-1}\right)$ and $\left(\mathrm{-8},6\right).$
...
The diameter of a circle has endpoints $\left(\mathrm{-1},\mathrm{-4}\right)$ and $\left(5,\mathrm{-4}\right).$ Find the center of the circle.
...
When using the distance formula $d=\sqrt{{\left({x}_{2}-{x}_{1}\right)}^{2}+{\left({y}_{2}-{y}_{1}\right)}^{2}},$ explain the correct order of operations that are to be performed to obtain the correct answer.
...
$(\mathrm{-5},\mathrm{-6})$ and $(4,2)$

$(\mathrm{-1},1)$ and $(7,\mathrm{-4})$

$\left(3,\frac{-3}{2}\right)$

$(\mathrm{-5},\mathrm{-3})$ and $(\mathrm{-2},\mathrm{-8})$

$(0,7)$ and $(4,\mathrm{-9})$

$\left(2,\mathrm{-1}\right)$

$(\mathrm{-43},17)$ and $(23,\mathrm{-34})$
...
$\left(4,1\right)\left(\mathrm{-2},\mathrm{-3}\right)\left(5,0\right)$

![This is an image of a blank x, y coordinate plane with the x and y axes ranging from negative 5 to 5.](../../media/CNX_CAT_Figure_02_01_201.jpg)
...
$\left(\mathrm{-3},0\right)\left(\mathrm{-3},4\right)\left(\mathrm{-3},\mathrm{-3}\right)$

![This is an image of a blank x, y coordinate plane with the x and y axes ranging from negative 5 to 5.](../../media/CNX_CAT_Figure_02_01_201.jpg)

Name the coordinates of the points graphed.

![This is an image of an x, y coordinate plane where the x and y-axis range from negative 5 to 5. Three points are plotted: A, B, and C.](../../media/CNX_CAT_Figure_02_01_205.jpg)
...
Find the distance that $\left(\mathrm{-3},4\right)$ is from the origin.

$d=5$

Find the distance that $\left(5,2\right)$ is from the origin. Round to three decimal places.
...
${\text{Y}}_{1}=\mathrm{-8}x+6$

$x=0.75y=0$

${\text{Y}}_{1}=4x-7$

${\text{Y}}_{1}=\frac{3x+5}{4}$ Round your answer to the nearest thousandth.
...
Given these four points: $A(1,3)$, $B(\u20133,5)$, $C(4,7)$, and $D(5,\u20134)$ find the coordinates of the midpoint of line segments $\overline{\text{AB}}$ and $\overline{\text{CD}}.$
...
If San Jose’s coordinates are $(76,\mathrm{\u201312})$, where the coordinates represent miles, find the distance between San Jose and San Francisco to the nearest mile.
...
![A right triangle with its bottom left point sitting on the point (0,0).  The upper right hand corner is labeled (20,50).  The base has a length of 20 units and the triangle has a height of 50 units.](../../media/CNX_CAT_Figure_02_01_217.jpg)
