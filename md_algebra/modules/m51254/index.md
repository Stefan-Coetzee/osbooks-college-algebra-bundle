...
Substitute in the given information:
 $$1500=\left(7500\right)r\left(5\right)$$ 

Solve for *r*
 $$1500=\mathrm{37,500}r$$ 
...
Let $$x$$ equal the first number. Then, as the second number exceeds the first by 17, we can write the second number as $$x+17.$$ The sum of the two numbers is 31. We usually interpret the word *is* as an equal sign.
 ...
 $$
\begin{array}{ccc}\hfill x+(x+17)& =& 31\hfill \\ \hfill 2x+17& =& 31\phantom{\rule{2em}{0ex}}\text{Simplify\ and\ solve}\text{.}\hfill \\ \hfill 2x& =& 14\hfill \\ \hfill x& =& 7\hfill \\ \hfill x+17& =& 7+17\hfill \\ & =& 24\hfill \end{array}
$$ 
...
ⓑIf the average number of minutes used each month is 1,160, we have the following:
 ...
 $$
\begin{array}{ccc}\hfill \text{Company\}A& =& 0.05(1,160)+34\hfill \\ & =& 58+34\hfill \\ & =& 92\hfill \\ \hfill \text{Company\}B& =& 0.04(1,160)+40\hfill \\ & =& 46.4+40\hfill \\ \hfill & =& 86.4\hfill \end{array}
...
ⓒIf the average number of minutes used each month is 420, we have the following:
 ...
 $$
\begin{array}{ccc}\hfill \text{Company\}A& =& 0.05(420)+34\hfill \\ & =& 21+34\hfill \\ & =& 55\hfill \\ \hfill \text{Company\}B& =& 0.04(420)+40\hfill \\ & =& 16.8+40\hfill \\ & =& 56.8\hfill \end{array}
$$
...
Check the *x-*value in each equation.
 ...
 $$
\begin{array}{ccc}\hfill 0.05(600)+34& =& 64\hfill \\ \hfill 0.04(600)+40& =& 64\hfill \end{array}
$$ 
Therefore, a monthly average of 600 talk-time minutes renders the plans equal. See

\n\n![
](../../media/CNX_CAT_Figure_02_03_002.jpg)\n\n
...
Write two equations, one for each trip.
 ...
 $$
\begin{array}{cccc}\hfill d& =& r\left(\frac{1}{2}\right)\hfill & \phantom{\rule{2em}{0ex}}\text{To\ work}\hfill \\ \hfill d& =& (r-10)\left(\frac{2}{3}\right)\hfill & \phantom{\rule{2em}{0ex}}\text{To\ home}\hfill \end{array}
$$
As both equations equal the same distance, we set them equal to each other and solve for *r*.

 $$
\begin{array}{ccc}\hfill r\left(\frac{1}{2}\right)& =& (r-10)\left(\frac{2}{3}\right)\hfill \\ \hfill \frac{1}{2}r& =& \frac{2}{3}r-\frac{20}{3}\hfill \\ \hfill \frac{1}{2}r-\frac{2}{3}r& =& -\frac{20}{3}\hfill \\ \hfill -\frac{1}{6}r& =& -\frac{20}{3}\hfill \\ \hfill r& =& -\frac{20}{3}(\mathrm{-6})\hfill \\ \hfill r& =& 40\hfill \end{array}
$$
We have solved for the rate of speed to work, 40 mph. Substituting 40 into the rate on the return trip yields 30 mi/h. Now we can answer the question. Substitute the rate back into either equation and solve for *d.*
 ...
 $$
\begin{array}{ccc}\hfill d& =& 40\left(\frac{1}{2}\right)\hfill \\ & =& 20\hfill \end{array}
$$
...
Note that we could have cleared the fractions in the equation by multiplying both sides of the equation by the LCD to solve for $$r.$$
 ...
 $$
\begin{array}{ccc}\hfill r\left(\frac{1}{2}\right)& =& (r-10)\left(\frac{2}{3}\right)\hfill \\ \hfill 6\phantom{\rule{0.5em}{0ex}}\text{}\times \phantom{\rule{0.5em}{0ex}}\text{}r\left(\frac{1}{2}\right)& =& 6\phantom{\rule{0.5em}{0ex}}\text{}\times \phantom{\rule{0.5em}{0ex}}\text{}(r-10)\left(\frac{2}{3}\right)\hfill \\ \hfill 3r& =& 4(r-10)\hfill \\ \hfill 3r& =& 4r-40\hfill \\ \hfill -r& =& \mathrm{-40}\hfill \\ \hfill r& =& 40\hfill \end{array}
$$
...
\n\n![
](../../media/CNX_CAT_Figure_02_03_003.jpg)\n\n
Now we can solve for the width and then calculate the length.

 $$
\begin{array}{ccc}\hfill P& =& 2L+2W\hfill \\ \hfill 54& =& 2(W+3)+2W\hfill \\ \hfill 54& =& 2W+6+2W\hfill \\ \hfill 54& =& 4W+6\hfill \\ \hfill 48& =& 4W\hfill \\ \hfill 12& =& W\hfill \\ \hfill (12+3)& =& L\hfill \\ \hfill 15& =& L\hfill \end{array}
$$
...
We know that the length is 6 in. more than the width, so we can write length as $$L=W+6.$$ Substitute the value of the perimeter and the expression for length into the perimeter formula and find the length.
 ...
 $$
\begin{array}{ccc}\hfill P& =& 2L+2W\hfill \\ \hfill 48& =& 2(W+6)+2W\hfill \\ \hfill 48& =& 2W+12+2W\hfill \\ \hfill 48& =& 4W+12\hfill \\ \hfill 36& =& 4W\hfill \\ \hfill 9& =& W\hfill \\ \hfill (9+6)& =& L\hfill \\ \hfill 15& =& L\hfill \end{array}
$$

Now, we find the area given the dimensions of $$L=15$$ in. and $$W=9$$ in.

 $$
\begin{array}{ccc}\hfill A& =& LW\hfill \\ \hfill A& =& 15(9)\hfill \\ & =& \hfill 135\phantom{\rule{0.5em}{0ex}}\text{in}{\text{.}}^{2}\end{array}
$$
...
The formula for the volume of a box is given as $$V=LWH,$$ the product of length, width, and height. We are given that $$L=2W,$$ and $$H=8.$$ The volume is $$\mathrm{1,600}$$ cubic inches.
 ...
 $$
\begin{array}{ccc}\hfill V& =& LWH\hfill \\ \hfill 1,600& =& (2W)W(8)\hfill \\ \hfill 1,600& =& 16{W}^{2}\hfill \\ \hfill 100& =& {W}^{2}\hfill \\ \hfill 10& =& W\hfill \end{array}
$$
...
$$A=P(1+rt)$$ is used to find the principal amount *P* deposited, earning *r*% interest, for *t* years. Use this to find what principal amount *P* David invested at a 3% rate for 20 yr if $$A=\text{\$}\mathrm{8,000.}$$

The formula $$F=\frac{m{v}^{2}}{R}$$ relates force $$\left(F\right)$$, velocity $$\left(v\right)$$, mass , and resistance $$\left(m\right)$$. Find $$R$$ when $$m=45,$$ $$v=7,$$ and $$F=245.$$

$$R=9$$

$$F=ma$$ indicates that force (*F*) equals mass (*m*) times acceleration (*a*).  Find the acceleration of a mass of 50 kg if a force of 12 N is exerted on it.

$$Sum=\frac{1}{1-r}$$ is the formula for an infinite series sum. If the sum is 5, find $$r.$$
...
Use the formula from the previous question to find the width, $$W,$$ of a rectangle whose length is 15 and whose perimeter is 58.

$$W=\frac{P-2L}{2}=\frac{58-2(15)}{2}=14$$

Solve for $$f:\frac{1}{p}+\frac{1}{q}=\frac{1}{f}$$

Use the formula from the previous question to find $$f$$ when $$p=8\text{and\}q=13.$$

$$f=\frac{pq}{p+q}=\frac{8(13)}{8+13}=\frac{104}{21}$$

Solve for $$m$$ in the slope-intercept formula: $$y=mx+b$$

Use the formula from the previous question to find $$m$$ when the coordinates of the point are $$\left(4,7\right)$$ and $$b=12.$$

$$m=\frac{-5}{4}$$

The area of a trapezoid is given by $$A=\frac{1}{2}h\left({b}_{1}+{b}_{2}\right).$$ Use the formula to find the area of a trapezoid with $$h=6,\phantom{\rule{0.5em}{0ex}}\text{}{b}_{1}=14,\phantom{\rule{0.5em}{0ex}}\text{and\}{b}_{2}=8.$$

Solve for *h:* $$A=\frac{1}{2}h\left({b}_{1}+{b}_{2}\right)$$

$$h=\frac{2A}{{b}_{1}+{b}_{2}}$$

Use the formula from the previous question to find the height of a trapezoid with $$A=150,\text{}{b}_{1}=19$$, and $${b}_{2}=11.$$

Find the dimensions of an American football field. The length is 200 ft more than the width, and the perimeter is 1,040 ft. Find the length and width. Use the perimeter formula $$P=2L+2W.$$

length = 360 ft; width = 160 ft

Distance equals rate times time, $$d=rt.$$ Find the distance Tom travels if he is moving at a rate of 55 mi/h for 3.5 h.
...
If the area model for a triangle is $$A=\frac{1}{2}bh,$$ find the area of a triangle with a height of 16 in. and a base of 11 in.
...
The volume formula for a cylinder is $$V=\pi {r}^{2}h.$$ Using the symbol $$\pi $$ in your answer, find the volume of a cylinder with a radius, $$r,$$ of 4 cm and a height of 14 cm.

Solve for *h:* $$V=\pi {r}^{2}h$$

$$h=\frac{V}{\pi {r}^{2}}$$

Use the formula from the previous question to find the height of a cylinder with a radius of 8 and a volume of $$16\pi $$

Solve for *r:* $$V=\pi {r}^{2}h$$

$$r=\sqrt{\frac{V}{\pi h}}$$

Use the formula from the previous question to find the radius of a cylinder with a height of 36 and a volume of $$324\pi .$$

The formula for the circumference of a circle is $$\phantom{\rule{0.5em}{0ex}}C=2\pi r.$$ Find the circumference of a circle with a diameter of 12 in. (diameter = 2*r*). Use the symbol $$\pi $$ in your final answer.

$$C=12\pi $$

Solve the formula from the previous question for $$\pi .$$ Notice why $$\pi $$ is sometimes defined as the ratio of the circumference to its diameter.
