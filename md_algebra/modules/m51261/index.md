...
6. ![.](../../media/CNX_Coreq_Figure_03_01_003.jpg)   Use the mapping $y=F(x)$ to find the following:  ⓐ $F(-1)=$     ⓑ $F(4)=$     ⓒ $F(2)=$     ⓓ If $F(x)=9$ , then $x=$ ________     ⓔ Is $F(x)$ a function? Explain why or why not.
...
ⓐ Because the input value is a number, 2, we can use simple algebra to simplify.
 ...
 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}f\left(2\right)={2}^{2}+3\left(2\right)-4  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}=4+6-4  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}=6  \end{array}
$$
...
$$
 ...
 $$
\begin{array}{l}f(a+h)={(a+h)}^{2}+3(a+h)-4  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}={a}^{2}+2ah+{h}^{2}+3a+3h-4  \end{array}
$$
...
Now we combine the results and simplify.
  ...
  $$
\begin{array}{l}\begin{array}{l}  \\ \frac{f(a+h)-f(a)}{h}=\frac{({a}^{2}+2ah+{h}^{2}+3a+3h-4)-({a}^{2}+3a-4)}{h}  \end{array}  \\ \begin{array}{ll}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=\frac{2ah+{h}^{2}+3h}{h}  &   \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=\frac{h(2a+h+3)}{h}  & \begin{array}{cc}\begin{array}{cc}& \end{array}& \end{array}\text{Factor\ out\}h.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=2a+h+3  & \begin{array}{cc}\begin{array}{cc}& \end{array}& \end{array}\text{Simplify}.  \end{array}  \end{array}
$$
</details>
...
To evaluate $h\left(4\right),$ we substitute the value 4 for the input variable $p$ in the given function.
  ...
  $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{}h(p)={p}^{2}+2p  \\ \phantom{\rule{0.5em}{0ex}}\text{}h(4)={(4)}^{2}+2(4)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \}=16+8  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \}=24  \end{array}
$$
...
$$
\begin{array}{llll}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}h(p)=3  &   &   &   \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \}{p}^{2}+2p=3  &   &   & \text{Substitute\ the\ original\ function\}h(p)={p}^{2}+2p.  \\ {p}^{2}+2p-3=0  &   &   & \text{Subtract\ 3\ from\ each\ side}.  \\ \phantom{\rule{0.5em}{0ex}}\text{}(p+3\text{)(}p-1)=0  &   &   & \text{Factor}.  \end{array}
$$
...
If $\left(p+3\right)\left(p-1\right)=0,$ either $\left(p+3\right)=0$ or $\left(p-1\right)=0$ (or both of them equal 0). We will set each factor equal to 0 and solve for $p$ in each case.
  ...
  $$
\begin{array}{ll}(p+3)=0,  & p=-3  \\ (p-1)=0,  & p=1  \end{array}
$$
...
To express the relationship in this form, we need to be able to write the relationship where $p$ is a function of $n,$ which means writing it as $p=[\text{expression}\phantom{\rule{0.5em}{0ex}}\text{involving}\phantom{\rule{0.5em}{0ex}}n].$
 ...
 $$
\begin{array}{ll}2n+6p=12  &   \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}6p=12-2n  & \begin{array}{ccc}& & \end{array}\text{Subtract\}2n\phantom{\rule{0.5em}{0ex}}\text{from\ both\ sides}.  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}p=\frac{12-2n}{6}  & \begin{array}{ccc}& & \end{array}\text{Divide\ both\ sides\ by\ 6\ and\ simplify}.  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}p=\frac{12}{6}-\frac{2n}{6}  &   \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}p=2-\frac{1}{3}n  &   \end{array}
$$
...
We now try to solve for $y$ in this equation.
 ...
 $$
\begin{array}{l}y=\pm \sqrt{1-{x}^{2}}  \\ \phantom{\rule{0.5em}{0ex}}\text\ =+\sqrt{1-{x}^{2}}\phantom{\rule{0.5em}{0ex}}\text{and\}-\sqrt{1-{x}^{2}}  \end{array}
$$
...
<hr/>
 ...
 33. **Applying the Vertical Line Test**    Which of the graphs in  represent(s) a function $y=f\left(x\right)?$       ![Image](../../media/CNX_Precalc_Figure_01_01_013abc-e8fe.jpg)
...
| Identity | $f\left(x\right)=x$ | ![Graph of a straight line.](../../media/CNX_Precalc_Figure_01_01_019n-d192.jpg) |
...
| Reciprocal | $f\left(x\right)=\frac{1}{x}$ | ![Graph of f(x)=1/x.](../../media/CNX_Precalc_Figure_01_01_023n-24f9.jpg) |
...
42. ![Graph of relation.](../../media/CNX_Precalc_Figure_01_01_203-82d5.jpg)
...
45. ![Graph of relation.](../../media/CNX_Precalc_Figure_01_01_206-e6d4.jpg)
...
50. ![Graph of relation.](../../media/CNX_Precalc_Figure_01_01_211-dc5d.jpg)
...
53. Given the following graph,  ⓐ Evaluate $f(0).$  ⓑ Solve for $f(x)=\mathrm{-3.}$        ![Graph of relation.](../../media/CNX_Precalc_Figure_01_01_214-bbc5.jpg)
...
55. ![Graph of a circle.](../../media/CNX_Precalc_Figure_01_01_216-a74a.jpg)
...
77. $[-10,\phantom{\rule{0.5em}{0ex}}\text{10}]$
