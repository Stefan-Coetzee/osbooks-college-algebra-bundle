...
| Set the denominator equal to zero | $2{x}^{2}+9x-5=0$ |
| :--- | :--- |
| Solve the equation | We will solve this quadratic equation by factoring  $(2x-1)(x+5)=0$   $\begin{array}{ccc}2x-1=0& & x+5=0\\ 2x=1& & x=\mathrm{-5}\\ x=\frac{1}{2}& & \end{array}$ |
| Answer: | Rational expression is undefined when $x=\frac{1}{2}$ and $x=\mathrm{\u20135}$ |
</details>
...
Let $t$ be the number of minutes since the tap opened. Since the water increases at 10 gallons per minute, and the sugar increases at 1 pound per minute, these are constant rates of change. This tells us the amount of water in the tank is changing linearly, as is the amount of sugar in the tank. We can write an equation independently for each:
 ...
 $$
\begin{array}{ccc}  \text{water:\}W(t)& =& 100+10t\phantom{\rule{0.5em}{0ex}}\text{in\ gallons}  \\   \text{sugar:\}S(t)& =& 5+1t\phantom{\rule{0.5em}{0ex}}\text{in\ pounds}  \end{array}
$$ 
...
The ratio of sugar to water, in pounds per gallon after 12 minutes is given by evaluating $C\left(t\right)$ at $t=\phantom{\rule{0.5em}{0ex}}\text{}12.$ 
 ...
 $$
\begin{array}{ccc}  C(12)& =& \frac{5+12}{100+10(12)}  \\ & =& \frac{17}{220}  \end{array}
$$
...
At the beginning, the ratio of sugar to water, in pounds per gallon is
 ...
 $$
\begin{array}{ccc}  C(0)& =& \frac{5+0}{100+10(0)}  \\ & =& \frac{1}{20}  \end{array}
$$
...
Begin by setting the denominator equal to zero and solving.
 ...
 $$
\begin{array}{ccc}  {x}^{2}-9& =& 0  \\   {x}^{2}& =& 9  \\   x& =& \mathrm{\pm 3}  \end{array}
$$
...
First, factor the numerator and denominator.
 ...
 $$
\begin{array}{ccc}  k(x)& =& \frac{5+2{x}^{2}}{2-x-{x}^{2}}  \\ & =& \frac{5+2{x}^{2}}{(2+x)(1-x)}  \end{array}
$$
...
To find the vertical asymptotes, we determine where this function will be undefined by setting the denominator equal to zero:
 ...
 $$
\begin{array}{ccc}  (2+x)(1-x)& =& 0  \\   x& =& \mathrm{-2},1  \end{array}
$$
...
We can find the *y*-intercept by evaluating the function at zero
 ...
 $$
\begin{array}{ccc}  f(0)& =& \frac{(0-2)(0+3)}{(0-1)(0+2)(0-5)}  \\ & =& \frac{-6}{10}  \\ & =& -\frac{3}{5}  \\ & =& \mathrm{-0.6}  \end{array}
$$
The *x*-intercepts will occur when the function is equal to zero:

 $$
\begin{array}{cccc}  0& =& \frac{(x-2)(x+3)}{(x-1)(x+2)(x-5)}  & \phantom{\rule{2em}{0ex}}\text{This\ is\ zero\ when\ the\ numerator\ is\ zero}.  \\   0& =& (x-2)(x+3)  & \\   x& =& 2,\mathrm{-3}  & \end{array}
$$
...
Next, we will find the intercepts. Evaluating the function at zero gives the *y*-intercept:
 ...
 $$
\begin{array}{ccc}  f(0)& =& \frac{(0+2)(0-3)}{{(0+1)}^{2}(0-2)}  \\ & =& 3  \end{array}
$$
...
To find the stretch factor, we can use another clear point on the graph, such as the *y*-intercept $(0,\mathrm{\u20132}).$ 
 ...
 $$
\begin{array}{ccc}  \mathrm{-2}& =& a\frac{(0+2)(0-3)}{(0+1){(0-2)}^{2}}  \\   \mathrm{-2}& =& a\frac{-6}{4}  \\   a& =& \frac{-8}{-6}=\frac{4}{3}  \end{array}
$$
...
If a rational function has *x*-intercepts at $x={x}_{1},{x}_{2},\dots ,{x}_{n},$ vertical asymptotes at $x={v}_{1},{v}_{2},\dots ,{v}_{m},$ and no ${x}_{i}=\text{any\}{v}_{j},$ then the function can be written in the form
 ...
 $\begin{array}{l}\begin{array}{l}  \\ f(x)=a\frac{{(x-{x}_{1})}^{{p}_{1}}{(x-{x}_{2})}^{{p}_{2}}\cdots {(x-{x}_{n})}^{{p}_{n}}}{{(x-{v}_{1})}^{{q}_{1}}{(x-{v}_{2})}^{{q}_{2}}\cdots {(x-{v}_{m})}^{{q}_{n}}}  \end{array}  \end{array}$
...
63. ![Graph of a rational function with vertical asymptotes at x=-3 and x=2.](../../media/CNX_Precalc_Figure_03_07_223.jpg)
