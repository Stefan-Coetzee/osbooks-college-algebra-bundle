...
| Go to Pascal’s Triangle and read off the coefficients from the row whose second entry is 6. | ![.](../../media/CNX_Coreq_Figure_09_06_001-01.jpg) |
| :--- | :--- |
| Write the expansion with the coefficients. | ![.](../../media/CNX_Coreq_Figure_09_06_001-02.jpg) |
| Fill in the variable with the power of x decreasing from 6 to 0, and the power of y increasing from 0 to 6. | ![.](../../media/CNX_Coreq_Figure_09_06_001-03.jpg) |
| Binomial expansion of ${(x+y)}^{6}$ . | ![.](../../media/CNX_Coreq_Figure_09_06_001-04.jpg) |
</details>
...
| ![.](../../media/CNX_Coreq_Figure_09_06_002-06.jpg)  Go to Pascal’s Triangle and read off the coefficients from the row whose second entry is 5. | ![.](../../media/CNX_Coreq_Figure_09_06_002-01.jpg) |
| :--- | :--- |
| Write the expansion with the coefficients. | ![.](../../media/CNX_Coreq_Figure_09_06_002-05.jpg) |
| Fill in the variable with the power of x decreasing from 5 to 0, and the power of 3 increasing from 0 to 5. | ![.](../../media/CNX_Coreq_Figure_09_06_002-02.jpg)    ![.](../../media/CNX_Coreq_Figure_09_06_002-03.jpg) |
| Binomial expansion of ${(x+3)}^{5}$ . | ![.](../../media/CNX_Coreq_Figure_09_06_002-04.jpg) |
</details>
...
| ![.](../../media/CNX_Coreq_Figure_09_06_003-02.jpg)  Go to Pascal’s Triangle and read off the coefficients from the row whose second entry is 4. | ![.](../../media/CNX_Coreq_Figure_09_06_003-01.jpg) |
| :--- | :--- |
| Write the expansion with the coefficients. | ![.](../../media/CNX_Coreq_Figure_09_06_003-03.jpg) |
| Fill in the variable with the power of (3x) decreasing from 4 to 0, and the power of (-2) increasing from 0 to 4. | ![.](../../media/CNX_Coreq_Figure_09_06_003-04.jpg)    ![.](../../media/CNX_Coreq_Figure_09_06_003-05.jpg)    ![.](../../media/CNX_Coreq_Figure_09_06_003-06.jpg) |
| Binomial expansion of ${(3x-2)}^{4}$ . | ![.](../../media/CNX_Coreq_Figure_09_06_003-07.jpg) |
</details>
...
7. **Finding Binomial Coefficients**   Find each binomial coefficient.   ⓐ $\left(\begin{array}{c}5\\ 3\end{array}\right)$  ⓑ $\left(\begin{array}{c}9\\ 2\end{array}\right)$  ⓒ $\left(\begin{array}{c}9\\ 7\end{array}\right)$
...
>
> 8. ⓐ $\left(\begin{array}{c}7\\ 3\end{array}\right)$  ⓑ $\left(\begin{array}{c}11\\ 4\end{array}\right)$
>
> <details>
> <summary>Solution</summary>
>
...
$$ These patterns lead us to the *Binomial Theorem*, which can be used to expand any binomial.
 $$
\begin{array}{ll}{(x+y)}^{n}  & ={\displaystyle \sum _{k=0}^{n}\left(\begin{array}{c}n\\ k\end{array}\right){x}^{n-k}}{y}^{k}  \\   & ={x}^{n}+\left(\begin{array}{c}n\\ 1\end{array}\right){x}^{n-1}y+\left(\begin{array}{c}n\\ 2\end{array}\right){x}^{n-2}{y}^{2}+\mathrm{...}+\left(\begin{array}{c}n\\ n-1\end{array}\right)x{y}^{n-1}+{y}^{n}  \end{array}
...
9. **Expanding a Binomial**   Write in expanded form.   ⓐ ${(x+y)}^{5}$  ⓑ ${\left(3x-y\right)}^{4}$
...
ⓐSubstitute $n=5$ into the formula. Evaluate the $k=0$ through $k=5$ terms. Simplify.
 $$
\begin{array}{ll}{(x+y)}^{5}  & =\left(\begin{array}{c}5\\ 0\end{array}\right){x}^{5}{y}^{0}+\left(\begin{array}{c}5\\ 1\end{array}\right){x}^{4}{y}^{1}+\left(\begin{array}{c}5\\ 2\end{array}\right){x}^{3}{y}^{2}+\left(\begin{array}{c}5\\ 3\end{array}\right){x}^{2}{y}^{3}+\left(\begin{array}{c}5\\ 4\end{array}\right){x}^{1}{y}^{4}+\left(\begin{array}{c}5\\ 5\end{array}\right){x}^{0}{y}^{5}  \\ {(x+y)}^{5}  & ={x}^{5}+5{x}^{4}y+10{x}^{3}{y}^{2}+10{x}^{2}{y}^{3}+5x{y}^{4}+{y}^{5}  \end{array}
$$ 
...
ⓑSubstitute $n=4$ into the formula. Evaluate the $k=0$ through $k=4$ terms. Notice that $3x$ is in the place that was occupied by $x$ and that $\u2013y$ is in the place that was occupied by $y.$ So we substitute them. Simplify.
 $$
\begin{array}{ll}{(3x-y)}^{4}  & =\left(\begin{array}{c}4\\ 0\end{array}\right){(3x)}^{4}{(-y)}^{0}+\left(\begin{array}{c}4\\ 1\end{array}\right){(3x)}^{3}{(-y)}^{1}+\left(\begin{array}{c}4\\ 2\end{array}\right){(3x)}^{2}{(-y)}^{2}+\left(\begin{array}{c}4\\ 3\end{array}\right){(3x)}^{1}{(-y)}^{3}+\left(\begin{array}{c}4\\ 4\end{array}\right){(3x)}^{0}{(-y)}^{4}  \\ {(3x-y)}^{4}  & =81{x}^{4}-108{x}^{3}y+54{x}^{2}{y}^{2}-12x{y}^{3}+{y}^{4}  \end{array}
$$
</details>

>
> Try It
> 10. Write in expanded form.  ⓐ ${(x-y)}^{5}$  ⓑ ${(2x+5y)}^{3}$
>
> <details>
> <summary>Solution</summary>
>
...
11. **Writing a Given Term of a Binomial Expansion**   Find the tenth term of ${(x+2y)}^{16}$ without fully expanding the binomial.
...
>
> Try It
> 12. Find the sixth term of ${(3x-y)}^{9}$ without fully expanding the binomial.
>
> <details>
> <summary>Solution</summary>
>
...
| Binomial Theorem | ${(x+y)}^{n}={\displaystyle \sum _{k-0}^{n}\left(\begin{array}{c}n\\ k\end{array}\right)}{x}^{n-k}{y}^{k}$ |
| :--- | :--- |
| $(r+1)th$ term of a binomial expansion | $\left(\begin{array}{c}n\\ r\end{array}\right){x}^{n-r}{y}^{r}$ |
...
37. The ninth term of ${(a-3{b}^{2})}^{11}$
...
38. The fourth term of $\phantom{\rule{0.5em}{0ex}}{\left({x}^{3}-\frac{1}{2}\right)}^{10}$

39. The eighth term of $\phantom{\rule{0.5em}{0ex}}{\left(\frac{y}{2}+\frac{2}{x}\right)}^{9}$
...
40. Find and graph ${f}_{1}(x),$ such that ${f}_{1}(x)$ is the first term of the expansion.

41. Find and graph ${f}_{2}(x),$ such that ${f}_{2}(x)$ is the sum of the first two terms of the expansion.
...
42. Find and graph ${f}_{3}(x),$ such that ${f}_{3}(x)$ is the sum of the first three terms of the expansion.

43. Find and graph ${f}_{4}(x),$ such that ${f}_{4}(x)$ is the sum of the first four terms of the expansion.
...
44. Find and graph ${f}_{5}(x),$ such that ${f}_{5}(x)$ is the sum of the first five terms of the expansion.

## Extensions
45. In the expansion of ${(5x+3y)}^{n},$ each term has the form $\left(\begin{array}{c}n\\ k\end{array}\right){a}^{n\u2013k}{b}^{k}$, where $k$ successively takes on the value $0,1,2,\phantom{\rule{0.3em}{0ex}}\mathrm{...},\phantom{\rule{0.3em}{0ex}}n.$ If $\left(\begin{array}{c}n\\ k\end{array}\right)=\left(\begin{array}{c}7\\ 2\end{array}\right),$ what is the corresponding term?
...
47. Consider the expansion of $\phantom{\rule{0.5em}{0ex}}{(x+b)}^{40}.$ What is the exponent of $b$ in the $k\text{th}$ term?
...
48. Find $\phantom{\rule{0.5em}{0ex}}\left(\begin{array}{c}n\\ k-1\end{array}\right)+\left(\begin{array}{c}n\\ k\end{array}\right)$ and write the answer as a binomial coefficient in the form $\phantom{\rule{0.5em}{0ex}}\left(\begin{array}{c}n\\ k\end{array}\right).$ Prove it. *Hint:* Use the fact that, for any integer $p,$ such that $p\ge 1,\phantom{\rule{0.5em}{0ex}}p!=p(p-1)!\text{.}$

49. Which expression cannot be expanded using the Binomial Theorem? Explain.   $({x}^{2}-2x+1)$   ${(\sqrt{a}+4\sqrt{a}-5)}^{8}$   ${({x}^{3}+2{y}^{2}-z)}^{5}$   ${(3{x}^{2}-\sqrt{2{y}^{3}})}^{12}$
