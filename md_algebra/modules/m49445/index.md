...
The difference between consecutive terms, *d*, and is called the **common difference**, for n greater than or equal to two.
 $d={a}_{n}-{a}_{n-1}$ ![This figure has two rows and three columns. The first row reads “7”, “10”,”13”, “16”, “19”, “22”, and an ellipsis, “10 minus 7, divided by 3”, “13 minus 10, divided by 3”, “16 minus 13, divided by 3”, nth term equals nth term minus 1 divided by d”](../../media/9_2_1.jpg)

Determine if each sequence is arithmetic. If so, indicate the common difference.

ⓐ $5,9,13,17,21,25\text{,}\phantom{\rule{0.2em}{0ex}}\text{\u2026}$

ⓑ $4,9,12,17,20,25\text{,}\phantom{\rule{0.2em}{0ex}}\text{\u2026}$

To determine if the sequence is arithmetic, we find the difference of the consecutive terms shown.

ⓐ
 $\begin{array}{cccccc}\begin{array}{}\\ \\ \\ \\ \text{Find the difference of}\hfill \\ \text{the consecutive terms.}\hfill \end{array}\hfill & & & & & \hfill \begin{array}{cccccccccc}\hfill 5,\hfill & & \hfill \phantom{\rule{1em}{0ex}}9,\hfill & & \hfill \phantom{\rule{1em}{0ex}}13,\hfill & & \hfill \phantom{\rule{1em}{0ex}}17\hfill & & \hfill \phantom{\rule{1em}{0ex}}21,\hfill & \hfill \phantom{\rule{0.6em}{0ex}}25,\dots \hfill \\ \\ \\ \hfill 9-5\hfill & & \hfill \phantom{\rule{1em}{0ex}}13-9\hfill & & \hfill \phantom{\rule{1em}{0ex}}17-13\hfill & & \hfill \phantom{\rule{1em}{0ex}}21-17\hfill & & \hfill \phantom{\rule{1em}{0ex}}25-21\hfill & & \\ \hfill 4\hfill & & \hfill \phantom{\rule{1em}{0ex}}4\hfill & & \hfill \phantom{\rule{1em}{0ex}}4\hfill & & \hfill \phantom{\rule{1em}{0ex}}4\hfill & & \hfill \phantom{\rule{1em}{0ex}}4\hfill & & \end{array}\hfill \\ \\ \\ & & & & & \text{The sequence is arithmetic. The common difference is}\phantom{\rule{0.2em}{0ex}}d=4\text{.}\hfill \end{array}$

ⓑ
 $\begin{array}{cccccc}\begin{array}{}\\ \\ \\ \\ \text{Find the difference of}\hfill \\ \text{the consecutive terms.}\hfill \end{array}\hfill & & & & & \hfill \begin{array}{cccccccccc}\hfill 4,\hfill & & \hfill \phantom{\rule{1em}{0ex}}9,\hfill & & \hfill \phantom{\rule{1em}{0ex}}12,\hfill & & \hfill \phantom{\rule{1em}{0ex}}17\hfill & & \hfill \phantom{\rule{1em}{0ex}}20,\hfill & \hfill \phantom{\rule{0.6em}{0ex}}25,\dots \hfill \\ \\ \\ \hfill 9-4\hfill & & \hfill \phantom{\rule{1em}{0ex}}12-9\hfill & & \hfill \phantom{\rule{1em}{0ex}}17-12\hfill & & \hfill \phantom{\rule{1em}{0ex}}20-17\hfill & & \hfill \phantom{\rule{1em}{0ex}}25-20\hfill & & \\ \hfill 2\hfill & & \hfill \phantom{\rule{1em}{0ex}}3\hfill & & \hfill \phantom{\rule{1em}{0ex}}5\hfill & & \hfill \phantom{\rule{1em}{0ex}}3\hfill & & \hfill \phantom{\rule{1em}{0ex}}5\hfill & & \end{array}\hfill \\ \\ \\ & & & & & \begin{array}{c}\text{The sequence is not arithmetic as all the differences between}\hfill \\ \text{the consecutive terms are not the same.}\hfill \\ \text{There is no common difference.}\hfill \end{array}\hfill \end{array}$
...
Write the first five terms of the sequence where the first term is 5 and the common difference is $d=\mathrm{-6}.$
...
We start with the first term and add the common difference. Then we add the common difference to that result to get the next term, and so on.
 ...
 $\begin{array}{ccccccccccccccc}\hfill {a}_{1}\hfill & & & \hfill {a}_{2}\hfill & & & \hfill {a}_{3}\hfill & & & \hfill {a}_{4}\hfill & & & \hfill {a}_{5}\hfill & & \\ \hfill 5\hfill & & & \hfill 5+\left(\mathrm{-6}\right)\hfill & & & \hfill \mathrm{-1}+\left(\mathrm{-6}\right)\hfill & & & \hfill \mathrm{-7}+\left(\mathrm{-6}\right)\hfill & & & \hfill \mathrm{-13}+\left(\mathrm{-6}\right)\hfill \\ & & & \hfill -1\hfill & & & \hfill -7\hfill & & & \hfill -13\hfill & & & \hfill -19\hfill \end{array}$ 
...
Write the first five terms of the sequence where the first term is –4 and the common difference is $d=7.$
 $\begin{array}{ccccccccccccccc}\hfill {a}_{1}\hfill & & & \hfill {a}_{2}\hfill & & & \hfill {a}_{3}\hfill & & & \hfill {a}_{4}\hfill & & & \hfill {a}_{5}\hfill & & \\ -4\end{array}$ The sequence is: ________________________________________
...
Find the eleventh term of a sequence where the third term is 19 and the common difference is five. Give the formula for the general term.
    ...
    ⓐ To find the 21st term, use the formula with ${a}_{1}=3$, $d=8$, and $n=21$ 
     ${a}_{n}={a}_{1}+(n-1)d$ 
  
  
    Substitute
     ${a}_{21}=3+(21-1)\left(8\right)$ 
  
  
    Simplify
     $\begin{array}{c}{a}_{21}=3+\left(20\right)\left(8\right)\\ {a}_{21}=3+160\\ {a}_{21}=163\end{array}$ 
  

  
ⓑ 
Let's first find ${a}_{1}$.
Use the formula with ${a}_{3}=19$, $d=5$, and $n=3$.
Substitute these values and simplify

     $\begin{array}{c}{a}_{n}={a}_{1}+(n-1)d\\ {a}_{3}={a}_{1}+(3-1)\left(5\right)\\ 19={a}_{1}+\left(2\right)\left(5\right)\\ 19={a}_{1}+10\\ {a}_{1=9}\end{array}$ 
  
  
    To find the 11th term, use the formula with ${a}_{3}=9$, $d=5$, and $n=11$ 
Substitute these values and simplify

     $\begin{array}{c}{a}_{n}={a}_{1}+(n-1)d\\ {a}_{11}=9+(11-1)\left(5\right)\\ {a}_{11}=9+\left(10\right)\left(5\right)\\ {a}_{11}=59\\ \phantom{\rule{0ex}{0ex}}\end{array}$ 
  
  
    To find the general term, substitute $a=9$ and $d=5$ into the formula.
     $\begin{array}{c}{a}_{n}={a}_{1}+(n-1)d\\ {a}_{11}=9+(11-1)\left(5\right)\\ {a}_{11}=9+\left(10\right)\left(5\right)\\ {a}_{11}=59\end{array}$ 
...
![Image](../../media/CNX_Coreq_Figure_09_03_001-01.png)

ⓑThe sequence is arithmetic because there is a common difference. The common difference is 4.
![Image](../../media/CNX_Coreq_Figure_09_03_001-02.png)

Analysis
========

The graph of each of these sequences is shown in . We can see from the graphs that, although both sequences show growth, $a$ is not linear whereas $b$ is linear. Arithmetic sequences have a constant rate of change so their graphs will always be points on a line.
\n\n![Image](../../media/CNX_Precalc_Figure_11_02_003.jpg)\n\n
...
Try It
 ...
 $$
\{18,\phantom{\rule{0.5em}{0ex}}\text{}16,\phantom{\rule{0.5em}{0ex}}\text{}14,\phantom{\rule{0.5em}{0ex}}\text{}12,\phantom{\rule{0.5em}{0ex}}\text{}10,\dots \}
$$ 
...
Try It
    ...
    Is the given sequence arithmetic? If so, find the common difference.
 $$
\{1,\phantom{\rule{0.5em}{0ex}}\text{}3,\phantom{\rule{0.5em}{0ex}}\text{}6,\phantom{\rule{0.5em}{0ex}}\text{}10,\phantom{\rule{0.5em}{0ex}}\text{}15,\dots \}
$$
...
\n\n![Image](../../media/CNX_Precalc_Figure_11_02_004.jpg)\n\n
...
We can find the common difference $d$ .
 $$
\begin{array}{ll}{a}_{n}={a}_{1}+(n-1)d\hfill & \hfill \\ {a}_{4}={a}_{1}+3d\hfill & \hfill \\ {a}_{4}=8+3d\hfill & \text{Write\ the\ fourth\ term\ of\ the\ sequence\ in\ terms\ of}\ {a}_{1}\ \text{and}\ d.\hfill \\ 14=8+3d\hfill & \text{Substitute}\ 14\ \text{for}\ {a}_{4}.\hfill \\ \ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}d=2\hfill & \text{Solve\ for\ the\ common\ difference}.\hfill \end{array}
$$
...
Write a **recursive formula** for the
    **arithmetic sequence**.
 $$
\{-18\text{,\}-7\text{,\}4\text{,\}15\text{,\}26\text{,\ \u2026}\}
$$
...
$$ Substitute the initial term and the common difference into the recursive formula for arithmetic sequences.
 $$
\begin{array}{l}{a}_{1}=-18\hfill \\ {a}_{n}={a}_{n-1}+11,\phantom{\rule{0.5em}{0ex}}\text{for\}n\ge 2\hfill \end{array}
$$ 
...
\n\n![Image](../../media/CNX_Precalc_Figure_11_02_005.jpg)\n\n
...
Write a recursive formula for the arithmetic sequence.
 $$
\{25\text{,\}\ 37\text{,\}\ 49\text{,\}\ 61\text{,\}\ \text{\u2026}\}
$$

$\begin{array}{l}{a}_{1}=25\hfill \\ {a}_{n}={a}_{n-1}+12,\phantom{\rule{0.5em}{0ex}}\text{for\}n\ge 2\hfill \end{array}$
...
$$
 ...
 $$
\begin{array}{l}{a}_{n}=2+10(n-1)\hfill \\ {a}_{n}=10n-8\hfill \end{array}
$$ 

Analysis
========

The graph of this sequence, represented in , shows a slope of 10 and a vertical intercept of $-8$ .
\n\n![Image](../../media/CNX_Precalc_Figure_11_02_008.jpg)\n\n
...
Find the number of terms in the **finite arithmetic sequence**.
 $$
\left\{8\text{,\}1\text{,\}\mathrm{\u20136}\text{,\}\mathrm{...}\text{,\}\mathrm{\u201341}\right\}
$$
...
The common difference is $-7$ . Substitute the common difference and the initial term of the sequence into the $n\text{th}$ term formula and simplify.
 ...
 $$
\begin{array}{l}{a}_{n}={a}_{1}+d(n-1)\hfill \\ {a}_{n}=8+(-7)(n-1)\hfill \\ {a}_{n}=15-7n\hfill \end{array}
$$
Substitute $-41$ for ${a}_{n}$ and solve for $n$
 $$
\begin{array}{l}-41=15-7n\hfill \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}8=n\hfill \end{array}
$$
...
Find the number of terms in the finite arithmetic sequence.
 $$
\left\{6\text{,\}11\text{,\}16\text{,\}\mathrm{...}\text{,\}56\right\}
$$
...
recursive formula for nth term of an arithmetic sequence
 ${a}_{n}={a}_{n-1}+d,n\ge 2$

explicit formula for nth term of an arithmetic sequence
 $\begin{array}{l}{a}_{n}={a}_{1}+d(n-1)\end{array}$
...
${a}_{1}=17,\phantom{\rule{0.5em}{0ex}}{a}_{7}=-31$

${a}_{13}=-60,\phantom{\rule{0.5em}{0ex}}{a}_{33}=-160$
...
${a}_{1}=2$
  ...
  Find the first term or ${a}_{1}$ of an arithmetic sequence if ${a}_{7}=21$ and ${a}_{15}=42.$
...
$a=\{8.9,10.3,11.7,\mathrm{...}\}$

$\begin{array}{ll}{a}_{1}=8.9;\ {a}_{n}={a}_{n-1}+1.4\hfill & n\ge 2\hfill \end{array}$

$a=\{-0.52,-1.02,-1.52,\mathrm{...}\}$

$a=\left\{\frac{1}{5},\frac{9}{20},\frac{7}{10},\mathrm{...}\right\}$

$\begin{array}{ll}{a}_{1}=\frac{1}{5};\ {a}_{n}={a}_{n-1}+\frac{1}{4}\hfill & n\ge 2\hfill \end{array}$

$a=\left\{-\frac{1}{2},-\frac{5}{4},-2,\mathrm{...}\right\}$

$a=\left\{\frac{1}{6},-\frac{11}{12},-2,\mathrm{...}\right\}$
...
$a=\left\{7\text{,\}4\text{,\}1\text{,\}\mathrm{...}\right\};$ Find the 17th term.

$a=\left\{4\text{,\}11\text{,\}18\text{,\}\mathrm{...}\right\};$ Find the 14th term.

${a}_{1}=4;\phantom{\rule{0.5em}{0ex}}\text{}{a}_{n}={a}_{n-1}+7;\phantom{\rule{0.5em}{0ex}}\text{}{a}_{14}=95$

$a=\left\{2\text{,\}6\text{,\}10\text{,\}\mathrm{...}\right\};$ Find the 12th term.
...
$a=\{-5\text{,\}95\text{,\}195\text{,\}\mathrm{...}\}$

${a}_{n}=-105+100n$

$a=\left\{\mathrm{-17}\text{,\}\mathrm{-217}\text{,\}\mathrm{-417}\text{,}\mathrm{...}\right\}$

$a=\left\{1.8\text{,\}3.6\text{,\}5.4\text{,\}\mathrm{...}\right\}$

${a}_{n}=1.8n$

$a=\{\mathrm{-18.1},\mathrm{-16.2},\mathrm{-14.3},\mathrm{...}\}$

$a=\{15.8,18.5,21.2,\mathrm{...}\}$

${a}_{n}=13.1+2.7n$

$a=\left\{\frac{1}{3},-\frac{4}{3},\mathrm{-3}\text{,\}\mathrm{...}\right\}$

$a=\left\{0,\frac{1}{3},\frac{2}{3},\mathrm{...}\right\}$

${a}_{n}=\frac{1}{3}n-\frac{1}{3}$

$a=\left\{-5,-\frac{10}{3},-\frac{5}{3},\dots \right\}$

For the following exercises, find the number of terms in the given finite arithmetic sequence.

$a=\{3\text{,}-4\text{,}-11\text{,\}\mathrm{...}\text{,}-60\}$

There are 10 terms in the sequence.

$a=\{1.2,1.4,1.6,\mathrm{...},3.8\}$

$a=\left\{\frac{1}{2},2,\frac{7}{2},\mathrm{...},8\right\}$
...
![Graph of a scattered plot with labeled points: (1, -4), (2, -2), (3, 0), (4, 2), and (5, 4). The x-axis is labeled n and the y-axis is labeled a_n.](../../media/CNX_Precalc_Figure_11_02_201.jpg)

![Graph of a scattered plot with labeled points: (1, 1.5), (2, 2.25), (3, 3.375), (4, 5.0625), and (5, 7.5938). The x-axis is labeled n and the y-axis is labeled a_n.](../../media/CNX_Precalc_Figure_11_02_202.jpg)
...
![Graph of a scattered plot with labeled points: (1, 9), (2, -1), (3, -11), (4, -21), and (5, -31). The x-axis is labeled n and the y-axis is labeled a_n.](../../media/CNX_Precalc_Figure_11_02_204.jpg)
...
Press *[WINDOW]*. Set $n\text{Min}=1$, $n\text{Max}=5$, $x\text{Min}=0$, $x\text{Max}=6$, $y\text{Min}=-1$, and 

$y\text{Max}=14.$ Then press *[GRAPH]*. Graph the sequence as it appears on the graphing calculator.

![Graph of a scattered plot with labeled points: (1, 1), (2, 4), (3, 7), (4, 10), and (5, 13). The x-axis is labeled n and the y-axis is labeled a_n.](../../media/CNX_Precalc_Figure_11_02_206.jpg)
...
![Graph of a scattered plot with labeled points: (1, 5.5), (2, 6), (3, 6.5), (4, 7), and (5, 7.5). The x-axis is labeled n and the y-axis is labeled a_n.](../../media/CNX_Precalc_Figure_11_02_207.jpg)
...
Find the 5th term of the arithmetic sequence $\{9b,5b,b,\dots \}.$

Find the 11th term of the arithmetic sequence $\{3a-2b,a+2b,-a+6b\dots \}.$
