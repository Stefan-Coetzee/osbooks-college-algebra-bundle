...
| Rewrite with $y=f\left(x\right)$ | $y={2}^{x}$ |
| :--- | :--- |
...
| :--- | :--- |
| Convert to exponential form. | $\phantom{\rule{5.6em}{0ex}}{x}^{2}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}36$ |
| Solve the quadratic. | $\phantom{\rule{3.8em}{0ex}}x=6,\phantom{\rule{2em}{0ex}}\overline{)x=\mathrm{-6}}$ |
| The base of a logarithmic function must be positive, so we eliminate $x=\mathrm{-6}$ . | $\phantom{\rule{6.2em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}6\phantom{\rule{2.5em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{6}36=2.$ |

ⓑ

|  | $\phantom{\rule{6.8em}{0ex}}{\text{log}}_{4}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3$ |
| :--- | :--- |
| Convert to exponential form. | $\phantom{\rule{8.2em}{0ex}}{4}^{3}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}x$ |
| Simplify. | $\phantom{\rule{8.6em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}64\phantom{\rule{1.3em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{4}64\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3.$ |

ⓒ

|  | ${\text{log}}_{\frac{1}{2}}\frac{1}{8}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}x$ |
| :--- | :--- |
| Convert to exponential form. | $\phantom{\rule{0.4em}{0ex}}{\left(\frac{1}{2}\right)}^{x}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}\frac{1}{8}$ |
| Rewrite $\frac{1}{8}$ as ${\left(\frac{1}{2}\right)}^{3}$ . | $\phantom{\rule{0.4em}{0ex}}{\left(\frac{1}{2}\right)}^{x}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}{\left(\frac{1}{2}\right)}^{3}$ |
| With the same base, the exponents must be equal. | $\phantom{\rule{2.4em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3\phantom{\rule{2em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{\frac{1}{2}}\frac{1}{8}=3$ |
</details>

### Practice Makes Perfect
8. **Evaluate logarithmic functions.**  Find the value of $x$ .            ⓐ ${\mathrm{log}}_{25}x=2$                  ⓑ ${\mathrm{log}}_{x}4=2$                       ⓒ ${\mathrm{log}}_{x}\frac{1}{3}=2$

9. Evaluate each of the following.            ⓐ ${\mathrm{log}}_{100}\mathrm{10}$                  ⓑ $\mathrm{log}0.1$                       ⓒ ${\mathrm{log}}_{2}4$                       ⓓ ${\mathrm{log}}_{1}20$                       ⓔ ${\mathrm{log}}_{4}4$                  ⓕ ${\mathrm{log}}_{\frac{1}{9}}3$                  ⓖ ${\mathrm{log}}_{\sqrt{2}}2$                  ⓗ $\mathrm{ln}\ {e}^{-5}$
...
We begin by rewriting the exponential equation in logarithmic form.
 ...
 $$
\begin{array}{lll}{10}^{x}  & =500  &   \\ \mathrm{log}\left(500\right)  & =x  & \text{Use\ the\ definition\ of\ the\ common\ log}\text{.}  \end{array}
$$
...
20. ${x}^{-\phantom{\rule{0.5em}{0ex}}\frac{10}{13}}=y$
...
41. ${e}^{\mathrm{ln}\left(10.125\right)}+4$
