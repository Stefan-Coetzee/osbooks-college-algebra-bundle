...
![Blank plot.](../../media/blankplot5.5.png)
...
$y={\mathrm{log}}_{x}2$ 
" $y={\mathrm{log}}_{x}2$ " read "*the logarithm, base 2 of *x**", means "the power to which we raise 2 to get *x*".
The function $y={\mathrm{log}}_{a}\mathrm{x}$ *is equivalent to* ${a}^{y}=x$
...
ⓐ
 ...
 $\phantom{\rule{3.8em}{0ex}}{\text{log}}_{x}36\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}2$ 

Convert to exponential form.
 $\phantom{\rule{5.6em}{0ex}}{x}^{2}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}36$ 

Solve the quadratic.
 $\phantom{\rule{3.8em}{0ex}}x=6,\phantom{\rule{2em}{0ex}}\overline{)x=\mathrm{-6}}$ 

The base of a logarithmic function must be positive, so we eliminate $x=\mathrm{-6}$ .
 $\phantom{\rule{6.2em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}6\phantom{\rule{2.5em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{6}36=2.$

ⓑ

 $\phantom{\rule{6.8em}{0ex}}{\text{log}}_{4}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3$ 

Convert to exponential form.
 $\phantom{\rule{8.2em}{0ex}}{4}^{3}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}x$ 

Simplify.
 $\phantom{\rule{8.6em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}64\phantom{\rule{1.3em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{4}64\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3.$

ⓒ

 ${\text{log}}_{\frac{1}{2}}\frac{1}{8}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}x$ 

Convert to exponential form.
 $\phantom{\rule{0.4em}{0ex}}{\left(\frac{1}{2}\right)}^{x}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}\frac{1}{8}$ 

Rewrite $\frac{1}{8}$ as ${\left(\frac{1}{2}\right)}^{3}$ .
 $\phantom{\rule{0.4em}{0ex}}{\left(\frac{1}{2}\right)}^{x}\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}{\left(\frac{1}{2}\right)}^{3}$ 

With the same base, the exponents must be equal.
 $\phantom{\rule{2.4em}{0ex}}x\phantom{\rule{0.2em}{0ex}}=\phantom{\rule{0.2em}{0ex}}3\phantom{\rule{2em}{0ex}}\text{Therefore,}\phantom{\rule{0.2em}{0ex}}{\text{log}}_{\frac{1}{2}}\frac{1}{8}=3$
...
Find the value of $x$ .
          ...
          ⓒ ${\mathrm{log}}_{x}\frac{1}{3}=2$

  Evaluate each of the following.

          ⓐ ${\mathrm{log}}_{100}\mathrm{10}$ 
          ...
          ⓕ ${\mathrm{log}}_{\frac{1}{9}}3$ 
     
          ⓖ ${\mathrm{log}}_{\sqrt{2}}2$ 
...
\n\n![Image](../../media/CNX_Precalc_Figure_04_03_002.jpg)\n\n
...
![Image](../../media/CNX_Precalc_Figure_04_03_003.jpg)
...
First, identify the values of $b,y,\text{and}x.$ Then, write the equation in the form ${b}^{y}=x.$
 ⓐ ${\mathrm{log}}_{6}\left(\sqrt{6}\right)=\frac{1}{2}$
Here, $b=6,y=\frac{1}{2},\text{and}\ x=\sqrt{6.}$ Therefore, the equation ${\mathrm{log}}_{6}\left(\sqrt{6}\right)=\frac{1}{2}$ is equivalent to $$
{6}^{\frac{1}{2}}=\sqrt{6}.
$$

 ⓑ ${\mathrm{log}}_{3}\left(9\right)=2$
Here, $b=3,y=2,\text{and}\ x=9.$ Therefore, the equation ${\mathrm{log}}_{3}\left(9\right)=2$ is equivalent to ${3}^{2}=9.$

Try It

Write the following logarithmic equations in exponential form.

ⓐ${\mathrm{log}}_{10}\left(\mathrm{1,}\mathrm{000,}000\right)=6$ 
ⓑ${\mathrm{log}}_{5}\left(25\right)=2$ 

ⓐ${\mathrm{log}}_{10}\left(1,000,000\right)=6$ is equivalent to ${10}^{6}=1,000,000$ 
ⓑ${\mathrm{log}}_{5}\left(25\right)=2$ is equivalent to ${5}^{2}=25$ 
...
Write the following exponential equations in logarithmic form.
 ...
 ${2}^{3}=8$ 
 ${5}^{2}=25$ 
 ${10}^{-4}=\frac{1}{\mathrm{10,000}}$ 

First, identify the values of $b,y,\text{and}x.$ Then, write the equation in the form $x={\mathrm{log}}_{b}\left(y\right).$
 ${2}^{3}=8$
Here, $b=2,$ $x=3,$ and $y=8.$ Therefore, the equation ${2}^{3}=8$ is equivalent to ${\mathrm{log}}_{2}(8)=3.$

 ${5}^{2}=25$
Here, $b=5,$ $x=2,$ and $y=25.$ Therefore, the equation ${5}^{2}=25$ is equivalent to ${\mathrm{log}}_{5}(25)=2.$
...
Write the following exponential equations in logarithmic form.
 ...
 ⓐ ${3}^{2}=9$ is equivalent to ${\mathrm{log}}_{3}(9)=2$ 
 ⓑ ${5}^{3}=125$ is equivalent to ${\mathrm{log}}_{5}(125)=3$ 
...
${\mathrm{log}}_{121}\left(11\right)=\frac{1}{2}$ (recalling that $\sqrt{121}={(121)}^{\frac{1}{2}}=11$ )
...
Evaluate $y=\mathrm{log}(1000)$ without using a calculator.
...
Evaluate $y=\mathrm{log}(\mathrm{1,}\mathrm{000,}000).$

$\mathrm{log}(1,000,000)=6$
...
Rounding to four decimal places, $\mathrm{log}\left(321\right)\approx \mathrm{2.5065.}$
...
Press *[ENTER]*.
To the nearest thousandth, $\mathrm{log}\left(500\right)\approx \mathrm{2.699.}$ 
The difference in magnitudes was about $\mathrm{2.699.}$
...
The difference in magnitudes was about $\mathrm{3.929.}$
...
Rounding to four decimal places, $\mathrm{ln}(500)\approx 6.2146$

Try It

Evaluate $\mathrm{ln}(\mathrm{-500}).$
...
Definition of the common logarithm
For $\text{}x>0,$ $y=\mathrm{log}\left(x\right)$ if and only if $\text{}{10}^{y}=x.$ 

Definition of the natural logarithm
For $\text{}x>0,$ $y=\mathrm{ln}\left(x\right)$ if and only if $\text{}{e}^{y}=x.$ 
...
What is a base $b$ logarithm? Discuss the meaning by interpreting each part of the equivalent equations ${b}^{y}=x$ and ${\mathrm{log}}_{b}x=y$ for $b>0,b\ne 1.$
...
How is the logarithmic function $f(x)={\mathrm{log}}_{b}x$ related to the exponential function $g(x)={b}^{x}?$ What is the result of composing these two functions?

How can the logarithmic equation ${\mathrm{log}}_{b}x=y$ be solved for $x$ using the properties of exponents?
...
The natural logarithm is a special case of the logarithm with base $b$ in that the natural log always has base $e.$ Rather than notating the natural logarithm as ${\mathrm{log}}_{e}\left(x\right),$ the notation used is $\mathrm{ln}\left(x\right).$
...
${x}^{-\phantom{\rule{0.5em}{0ex}}\frac{10}{13}}=y$
...
Is $x=0$ in the domain of the function $f(x)=\mathrm{log}(x)?$ If so, what is the value of the function when $x=0?$ Verify the result.

No, the function has no defined value for $x=0.$ To verify, suppose $x=0$ is in the domain of the function $f(x)=\mathrm{log}(x).$ Then there is some number $n$ such that $n=\mathrm{log}(0).$ Rewriting as an exponential equation gives: ${10}^{n}=0,$ which is impossible since no such real number $n$ exists. Therefore, $x=0$ is *not* the domain of the function $f(x)=\mathrm{log}(x).$

Is $f(x)=0$ in the range of the function $f(x)=\mathrm{log}(x)?$ If so, for what value of $x?$ Verify the result.

Is there a number $x$ such that $\mathrm{ln}x=2?$ If so, what is that number? Verify the result.

Yes. Suppose there exists a real number $x$ such that $\mathrm{ln}x=2.$ Rewriting as an exponential equation gives $x={e}^{2},$ which is a real number. To verify, let $x={e}^{2}.$ Then, by definition, $\mathrm{ln}\left(x\right)=\mathrm{ln}\left({e}^{2}\right)=2.$

Is the following true: $\frac{{\mathrm{log}}_{3}(27)}{{\mathrm{log}}_{4}\left(\frac{1}{64}\right)}=\mathrm{-1}?$ Verify the result.

Is the following true: $\frac{\mathrm{ln}\left({e}^{1.725}\right)}{\mathrm{ln}\left(1\right)}=1.725?$ Verify the result.

No; $\mathrm{ln}\left(1\right)=0,$ so $\frac{\mathrm{ln}\left({e}^{1.725}\right)}{\mathrm{ln}\left(1\right)}$ is undefined.

Real-World Applications
=======================

The exposure index $EI$ for a camera is a measurement of the amount of light that hits the image receptor. It is determined by the equation $EI={\mathrm{log}}_{2}\left(\frac{{f}^{2}}{t}\right),$ where $f$ is the “f-stop” setting on the camera, and $t$ is the exposure time in seconds. Suppose the f-stop setting is $8$ and the desired exposure time is $2$ seconds. What will the resulting exposure index be?
