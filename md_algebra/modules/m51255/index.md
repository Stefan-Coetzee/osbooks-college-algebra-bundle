...
Rewrite the radical as the product of two radicals.
 $\sqrt[3]{8}\xb7\sqrt[3]{{2}^{}}$ 

Simplify.
 $2\phantom{\rule{0.2em}{0ex}}\sqrt[3]{{2}^{}}$ 
...
Rewrite the radical as the product of two radicals.
 $\sqrt[4]{81}\xb7\sqrt[4]{3}$ 

Simplify.
 $3\phantom{\rule{0.2em}{0ex}}\sqrt[4]{{3}^{}}$ 
...
Express $\sqrt{\mathrm{-9}}$ in standard form.
 ...
 $$
\begin{array}{ccc}\hfill \sqrt{\mathrm{-9}}& =& \sqrt{9}\sqrt{\mathrm{-1}}\hfill \\ & =& 3i\hfill \end{array}
$$ 
In standard form, this is $0+3i.$

Try It
Express $\sqrt{\mathrm{-24}}$ in standard form.
...
Plot the complex number $3-4i\phantom{\rule{0.5em}{0ex}}$ on the complex plane.
...
Plot the complex number $\mathrm{-4}-i$ on the complex plane.
...
ⓐ $\left(3-4i\right)+\left(2+5i\right)$ 
ⓑ $\left(\mathrm{-5}+7i\right)-\left(\mathrm{-11}+2i\right)$

We add the real parts and add the imaginary parts.

ⓐ $\begin{array}{ccc}\hfill (3-4i)+(2+5i)& =& 3-4i+2+5i\hfill \\ & =& 3+2+(\mathrm{-4}i)+5i\hfill \\ & =& (3+2)+(\mathrm{-4}+5)i\hfill \\ & =& 5+i\hfill \end{array}$

ⓑ
 $\begin{array}{ccc}\hfill (\mathrm{-5}+7i)-(\mathrm{-11}+2i)& =& \mathrm{-5}+7i+11-2i\hfill \\ & =& \mathrm{-5}+11+7i-2i\hfill \\ & =& (\mathrm{-5}+11)+(7-2)i\hfill \\ & =& 6+5i\hfill \end{array}$ 
...
Distribute the 4.
 ...
 $$
\begin{array}{ccc}\hfill 4(2+5i)& =& (4\cdot 2)+(4\cdot 5i)\hfill \\ & =& 8+20i\hfill \end{array}
$$

Try It
Find the product: $\frac{1}{2}\left(5-2i\right).$
...
Now, let’s multiply two complex numbers. We can use either the distributive property or more specifically the FOIL method because we are dealing with binomials. Recall that FOIL is an acronym for multiplying First, Inner, Outer, and Last terms together. The difference with complex numbers is that when we get a squared term, ${i}^{2},$ it equals $\mathrm{-1.}$
 ...
 $$
\begin{array}{cccc}\hfill (a+bi)(c+di)& =& ac+adi+bci+bd{i}^{2}\hfill & \\ & =& ac+adi+bci-bd\hfill & \phantom{\rule{2em}{0ex}}{i}^{2}=\mathrm{-1}\hfill \\ & =& (ac-bd)+(ad+bc)i\hfill & \phantom{\rule{2em}{0ex}}\text{Group\ real\ terms\ and\ imaginary\ terms}.\hfill \end{array}
$$
...
Multiply: $\left(4+3i\right)(2-5i).$

 $$
\begin{array}{ccc}\hfill (4+3i)(2-5i)& =& 4(2)-4(5i)+3i(2)-(3i)(5i)\hfill \\ & =& 8-20i+6i-15\left({i}^{2}\right)\hfill \\ & =& (8+15)+(\mathrm{-20}+6)i\hfill \\ & =& 23-14i\hfill \end{array}
$$

Try It

Multiply: $\left(3-4i\right)\left(2+3i\right).$
...
Dividing two complex numbers is more complicated than adding, subtracting, or multiplying because we cannot divide by an imaginary number, meaning that any fraction must have a real-number denominator to write the answer in standard form $a+bi.$ We need to find a term by which we can multiply the numerator and the denominator that will eliminate the imaginary portion of the denominator so that we end up with a real number as the denominator. This term is called the complex conjugate of the denominator, which is found by changing the sign of the imaginary part of the complex number. In other words, the complex conjugate of $a+bi$ is $a-bi.$ For example, the product of $a+bi$ and $a-bi$ is
 ...
 $$
\begin{array}{ccc}\hfill (a+bi)(a-bi)& =& {a}^{2}-abi+abi-{b}^{2}{i}^{2}\\ & =& {a}^{2}+{b}^{2}\hfill \end{array}
$$
...
Simplify, remembering that ${i}^{2}=\mathrm{-1.}$
 ...
 $$
\begin{array}{l}=\frac{ca-cbi+adi-bd(\mathrm{-1})}{{a}^{2}-abi+abi-{b}^{2}(\mathrm{-1})}\hfill \\ =\frac{(ca+bd)+(ad-cb)i}{{a}^{2}+{b}^{2}}\hfill \end{array}
$$ 
...
Try It
Find the complex conjugate of $\mathrm{-3}+4i.$
...
To multiply two complex numbers, we expand the product as we would with polynomials (using FOIL).
 ...
 $$
\begin{array}{cccc}\hfill \frac{(2+5i)}{(4-i)}\cdot \frac{(4+i)}{(4+i)}& =& \frac{8+2i+20i+5{i}^{2}}{16+4i-4i-{i}^{2}}\hfill & \\ & =& \frac{8+2i+20i+5(\mathrm{-1})}{16+4i-4i-(\mathrm{-1})}\hfill & \phantom{\rule{2em}{0ex}}\text{Because}\ {i}^{2}=\mathrm{-1.}\hfill \\ & =& \frac{3+22i}{17}\hfill & \\ & =& \frac{3}{17}+\frac{22}{17}i\hfill & \phantom{\rule{2em}{0ex}}\text{Separate\ real\ and\ imaginary\ parts}.\hfill \end{array}
$$
...
The powers of $i$ are cyclic. Let’s look at what happens when we raise $i$ to increasing powers.
 $\begin{array}{l}{i}^{1}=i\hfill \\ {i}^{2}=\mathrm{-1}\hfill \\ {i}^{3}={i}^{2}\cdot i=\mathrm{-1}\cdot i=-i\hfill \\ {i}^{4}={i}^{3}\cdot i=-i\cdot i=-{i}^{2}=-(\mathrm{-1})=1\hfill \\ {i}^{5}={i}^{4}\cdot i=1\cdot i=i\hfill \end{array}$ We can see that when we get to the fifth power of $i,$ it is equal to the first power. As we continue to multiply $i$ by increasing powers, we will see a cycle of four. Let’s examine the next four powers of $i.$
 $\begin{array}{l}{i}^{6}={i}^{5}\cdot i=i\cdot i={i}^{2}=\mathrm{-1}\hfill \\ {i}^{7}={i}^{6}\cdot i={i}^{2}\cdot i={i}^{3}=-i\hfill \\ {i}^{8}={i}^{7}\cdot i={i}^{3}\cdot i={i}^{4}=1\hfill \\ {i}^{9}={i}^{8}\cdot i={i}^{4}\cdot i={i}^{5}=i\hfill \end{array}$ The cycle is repeated continuously: $i,\mathrm{-1},-i,1,$ every four powers.
...
*Reduced form*
 ${\left({i}^{2}\right)}^{17}\cdot i$ 
 ${i}^{33}\cdot \left(\mathrm{-1}\right)$

 ${i}^{31}\cdot 1$ 
 $$
{i}^{19}\cdot {\left({i}^{4}\right)}^{4}
$$ 

*Simplified form*
 ${\left(\mathrm{-1}\right)}^{17}\cdot i$
...
Evaluate ${(\text{l}+i)}^{k}-{(\text{l}-i)}^{k}$ for $k=4,8,$ and $12$. Predict the value for $k=16.$
