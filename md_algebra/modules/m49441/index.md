...
![rotation of axes definitional graph](../../media/CNX_Coreq_Figure_08_04_001.jpg)
...
1. **Using rotation of axes formulas.**     Find a new representation of the given equation after rotating through the given angle.   $3{x}^{2}+xy+3{y}^{2}-5=0,\ \theta =45\xba$

<details>
<summary>Solution</summary>

| Find x and y using the rotation of axes formulas, substitute *θ*=45º. | $\left\{\begin{array}{l}x=x\text{'}\text{cos}\theta -y\text{'}\text{sin}\theta \\ y=x\text{'}\text{sin}\theta +y\text{'}\text{cos}\theta \end{array}\right.$ |
| :--- | :--- |
|  | | $x=x\text{'}\left(\frac{1}{\sqrt{2}}\right)-y\text{'}\left(\frac{1}{\sqrt{2}}\right)$$x=\frac{x\text{'}-y\text{'}}{\sqrt{2}}$ | $y=x\text{'}\left(\frac{1}{\sqrt{2}}\right)-y\text{'}\left(\frac{1}{\sqrt{2}}\right)$$y=\frac{x\text{'}-y\text{'}}{\sqrt{2}}$ | | :--- | :--- | |
...
| Foil each term. | $3\left(\frac{{x\text{'}}^{2}-2x\text{'}y\text{'}+{y\text{'}}^{2}}{2}\right)2+\frac{{x\text{'}}^{2}-{y\text{'}}^{2}}{2}+3\left(\frac{{x\text{'}}^{2}-2x\text{'}y\text{'}+{y\text{'}}^{2}}{2}\right)-5=0$ |
| Multiply by 2 to get rid of the fraction. | $3({x\text{'}}^{2}-2x\text{'}y\text{'}+{y\text{'}}^{2})2+{x\text{'}}^{2}-{y\text{'}}^{2}+3({x\text{'}}^{2}-2x\text{'}y\text{'}+{y\text{'}}^{2})-10=0$ |
| Combine like terms. | $3{x\text{'}}^{2}-6x\text{'}y\text{'}+3{y\text{'}}^{2}+{x\text{'}}^{2}-{y\text{'}}^{2}+3{x\text{'}}^{2}+6x\text{'}y\text{'}+3{y\text{'}}^{2}-10=0\phantom{\rule{0ex}{0ex}}7{x\text{'}}^{2}+{5y\text{'}}^{2}-10=0\phantom{\rule{0ex}{0ex}}7{x\text{'}}^{2}+{5y\text{'}}^{2}=10$ |
| Write the equations with  x′ and y′ in standard form. | Set equal to 1.  $\frac{7{x\text{'}}^{2}}{10}+\frac{{5y\text{'}}^{2}}{10}=1\phantom{\rule{0ex}{0ex}}\frac{{x\text{'}}^{2}}{{\displaystyle \raisebox{1ex}{$10$}\!\left/ \!\raisebox{-1ex}{$7$}\right.}}+\frac{{y\text{'}}^{2}}{2}=1\phantom{\rule{0ex}{0ex}}$ |
</details>

### Practice Makes Perfect
Using rotation of axes formulas:
2. Find a new representation of the given equation after rotating through the given angle. Use the steps outlined to assist you in your work.   $4{x}^{2}\u2013xy+4{y}^{2}-2=0,\theta =45\xba$      | Find x and y using the rotation of axes formulas, substitute *θ*=45º. | | :--- | | Substitute the expressions for x and y into the given equation and simplify. | | Write the equations with  x′ and y′ in standard form. |
...
| Conic | Characteristics of
 ${x}^{2}\text{-}$ and  ${y}^{2}\text{-}$ terms | Example |
| :--- | :--- | :--- |
| *Parabola* | Either
 ${x}^{2}$ OR  ${y}^{2}.$ Only one variable is squared. | $x=3{y}^{2}-2y+1$ |
...
3. **Identify conic sections by their equations.**      ⓐ $x=-{y}^{2}-2y+3$        ⓑ $9{y}^{2}-{x}^{2}+18y-4x-4=0$        ⓒ $9{x}^{2}+25{y}^{2}=225$        ⓓ ${x}^{2}+{y}^{2}-4x+10y-7=0$
...
![The nondegenerate conic sections](../../media/CNX_Precalc_Figure_10_04_001.jpg)
...
![Degenerate conic sections](../../media/CNX_Precalc_Figure_10_04_002n.jpg)
...
| parabola | $4{x}^{2}=9y\phantom{\rule{0.5em}{0ex}}\text{or\}4{y}^{2}=9x$ |
| one line | $4x+9y=1$ |
| intersecting lines | $\left(x-4\right)\left(y+4\right)=0$ |
| parallel lines | $\left(x-4\right)\left(x-9\right)=0$ |
| a point | $4{x}^{2}+4{y}^{2}=0$ |
| no graph | $4{x}^{2}+4{y}^{2}=\phantom{\rule{0.5em}{0ex}}-\phantom{\rule{0.5em}{0ex}}1$ |
...
>
>
> | *ellipse* | $A{x}^{2}+C{y}^{2}+Dx+Ey+F=0,\phantom{\rule{0.5em}{0ex}}\text{}A\ne C\phantom{\rule{0.5em}{0ex}}\text{and\}AC>0$ |
> | :--- | :--- |
> | *circle* | $A{x}^{2}+C{y}^{2}+Dx+Ey+F=0,\phantom{\rule{0.5em}{0ex}}\text{}A=C$ |
> | *hyperbola* | $A{x}^{2}-C{y}^{2}+Dx+Ey+F=0\phantom{\rule{0.5em}{0ex}}\text{or\}-A{x}^{2}+C{y}^{2}+Dx+Ey+F=0,$ where $A$ and $C$ are positive |
> | *parabola* | $A{x}^{2}+Dx+Ey+F=0\phantom{\rule{0.5em}{0ex}}\text{or\}C{y}^{2}+Dx+Ey+F=0$ |
>
...
8. **Identifying a Conic from Its General Form**        Identify the graph of each of the following nondegenerate conic sections.   ⓐ$4{x}^{2}-9{y}^{2}+36x+36y-125=0$        ⓑ $9{y}^{2}+16x+36y-10=0$        ⓒ $3{x}^{2}+3{y}^{2}-2x-6y-4=0$        ⓓ $-25{x}^{2}-4{y}^{2}+100x+16y+20=0$
...
![Image](../../media/CNX_Coreq_Figure_08_04_002-01.png)
...
>
>    Try It
>    9. Identify the graph of each of the following nondegenerate conic sections.            ⓐ $16{y}^{2}-{x}^{2}+x-4y-9=0$            ⓑ $16{x}^{2}+4{y}^{2}+16x+49y-81=0$
>
> <details>
> <summary>Solution</summary>
>
...
![The graph of the rotated ellipse ${x}^{2}+{y}^{2}\u2013xy\u201315=0$](../../media/CNX_Precalc_Figure_10_04_003.jpg)
...
![The Cartesian plane with *x*- and *y*-axes and the resulting *x*′− and *y*′−axes formed by a rotation by an angle $\theta .$](../../media/CNX_Precalc_Figure_10_04_004.jpg)
...
The original coordinate *x*- and *y*-axes have unit vectors $i$ and $j.$ The rotated coordinate axes have unit vectors ${i}^{\prime}$ and ${j}^{\prime}.$ The angle $\theta$ is known as the **angle of rotation**. See . We may write the new unit vectors in terms of the original ones.
 $$
\begin{array}{l}{i}^{\prime}=\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta i+\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta j  \\ {j}^{\prime}=-\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta i+\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta j  \end{array}
$$

![Relationship between the old and new coordinate planes.](../../media/CNX_Precalc_Figure_10_04_005.jpg)

Consider a vector*$u$*in the new coordinate plane. It may be represented in terms of its coordinate axes.
 $$
\begin{array}{ll}u={x}^{\prime}{i}^{\prime}+{y}^{\prime}{j}^{\prime}  &   \\ u={x}^{\prime}(i\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta +j\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta )+{y}^{\prime}(-i\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +j\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta )  & \begin{array}{cccc}& & & \end{array}\text{Substitute}.  \\ u=ix\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta +jx\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta -iy\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +jy\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta   & \begin{array}{cccc}& & & \end{array}\text{Distribute}.  \\ u=ix\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -iy\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +jx\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +jy\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta   & \begin{array}{cccc}& & & \end{array}\text{Apply\ commutative\ property}.  \\ u=(x\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -y\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta )i+(x\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +y\text{'}\phantom{\rule{0.5em}{0ex}}\text{}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta )j  & \begin{array}{cccc}& & & \end{array}\text{Factor\ by\ grouping}.  \end{array}
$$
...
<hr/>
    ...
    10. **Finding a New Representation of an Equation after Rotating through a Given Angle**         Find a new representation of the equation $2{x}^{2}-xy+2{y}^{2}-30=0$ after rotating through an angle of $\theta =\mathrm{45\xb0}.$
...
Find $x$ and $y,$ where $x={x}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -{y}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ and $y={x}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +{y}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta .$
 ...
 $$
\begin{array}{l}  \\ x={x}^{\prime}\mathrm{cos}\left(\mathrm{45\xb0}\right)-{y}^{\prime}\mathrm{sin}\left(\mathrm{45\xb0}\right)  \\ x={x}^{\prime}\left(\frac{1}{\sqrt{2}}\right)-{y}^{\prime}\left(\frac{1}{\sqrt{2}}\right)  \\ x=\frac{{x}^{\prime}-{y}^{\prime}}{\sqrt{2}}  \end{array}
$$

and

       $$
\begin{array}{l}\\ \begin{array}{l}y={x}^{\prime}\mathrm{sin}(\mathrm{45\xb0})+{y}^{\prime}\mathrm{cos}(\mathrm{45\xb0})  \\ y={x}^{\prime}\left(\frac{1}{\sqrt{2}}\right)+{y}^{\prime}\left(\frac{1}{\sqrt{2}}\right)  \\ y=\frac{{x}^{\prime}+{y}^{\prime}}{\sqrt{2}}  \end{array}\end{array}
$$
...
$$
     ...
     Simplify.
      ...
      $$
\begin{array}{ll}\overline{)2}\frac{({x}^{\prime}-{y}^{\prime})({x}^{\prime}-{y}^{\prime})}{\overline{)2}}-\frac{({x}^{\prime}-{y}^{\prime})({x}^{\prime}+{y}^{\prime})}{2}+\overline{)2}\frac{({x}^{\prime}+{y}^{\prime})({x}^{\prime}+{y}^{\prime})}{\overline{)2}}-30=0  & \begin{array}{cccc}& & & \end{array}\text{FOIL\ method}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \}{x}^{\prime}{}^{2}{\overline{)-2{x}^{\prime}y}}^{\prime}+{y}^{\prime}{}^{2}-\frac{({x}^{\prime}{}^{2}-{y}^{\prime}{}^{2})}{2}+{x}^{\prime}{}^{2}\overline{)+2{x}^{\prime}{y}^{\prime}}+{y}^{\prime}{}^{2}-30=0  & \begin{array}{cccc}& & & \end{array}\text{Combine\ like\ terms}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}2{x}^{\prime}{}^{2}+2{y}^{\prime}{}^{2}-\frac{({x}^{\prime}{}^{2}-{y}^{\prime}{}^{2})}{2}=30  & \begin{array}{cccc}& & & \end{array}\text{Combine\ like\ terms}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}2\left(2{x}^{\prime}{}^{2}+2{y}^{\prime}{}^{2}-\frac{({x}^{\prime}{}^{2}-{y}^{\prime}{}^{2})}{2}\right)=2(30)  & \begin{array}{cccc}& & & \end{array}\text{Multiply\ both\ sides\ by\ 2}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}4{x}^{\prime}{}^{2}+4{y}^{\prime}{}^{2}-({x}^{\prime}{}^{2}-{y}^{\prime}{}^{2})=60  & \begin{array}{cccc}& & & \end{array}\text{Simplify}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}4{x}^{\prime}{}^{2}+4{y}^{\prime}{}^{2}-{x}^{\prime}{}^{2}+{y}^{\prime}{}^{2}=60  & \begin{array}{cccc}& & & \end{array}\text{Distribute}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\frac{3{x}^{\prime}{}^{2}}{60}+\frac{5{y}^{\prime}{}^{2}}{60}=\frac{60}{60}  & \begin{array}{cccc}& & & \end{array}\text{Set\ equal\ to\ 1}.  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_10_04_006.jpg)
</details>
...
<hr/>
   ...
   11. **Rewriting an Equation with respect to the *x′* and *y′* axes without the *x′y′* Term**        Rewrite the equation $8{x}^{2}-12xy+17{y}^{2}=20$ in the ${x}^{\prime}{y}^{\prime}$ system without an ${x}^{\prime}{y}^{\prime}$ term.
...
First, we find $\mathrm{cot}(2\theta ).$ See .
     ...
     $$
\begin{array}{l}8{x}^{2}-12xy+17{y}^{2}=20\Rightarrow A=8,\phantom{\rule{0.5em}{0ex}}B=-12\phantom{\rule{0.5em}{0ex}}\text{and}\phantom{\rule{0.5em}{0ex}}C=17  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\mathrm{cot}(2\theta )=\frac{A-C}{B}=\frac{8-17}{-12}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\mathrm{cot}(2\theta )=\frac{-9}{-12}=\frac{3}{4}  \end{array}
$$

![Image](../../media/CNX_Precalc_Figure_10_04_007.jpg)
...
$$
    ...
    So the hypotenuse is
     ...
     $$
\begin{array}{r}  {3}^{2}+{4}^{2}={h}^{2}\\   9+16={h}^{2}\\   25={h}^{2}\\   h=5\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\end{array}
$$

Next, we find $\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ and $\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta .$
    
 $$
\begin{array}{l}\begin{array}{l}  \\   \\ \mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\sqrt{\frac{1-\mathrm{cos}(2\theta )}{2}}=\sqrt{\frac{1-\frac{3}{5}}{2}}=\sqrt{\frac{\frac{5}{5}-\frac{3}{5}}{2}}=\sqrt{\frac{5-3}{5}\cdot \frac{1}{2}}=\sqrt{\frac{2}{10}}=\sqrt{\frac{1}{5}}  \end{array}  \\ \mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\frac{1}{\sqrt{5}}  \\ \mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\sqrt{\frac{1+\mathrm{cos}(2\theta )}{2}}=\sqrt{\frac{1+\frac{3}{5}}{2}}=\sqrt{\frac{\frac{5}{5}+\frac{3}{5}}{2}}=\sqrt{\frac{5+3}{5}\cdot \frac{1}{2}}=\sqrt{\frac{8}{10}}=\sqrt{\frac{4}{5}}  \\ \mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\frac{2}{\sqrt{5}}  \end{array}
$$
...
Substitute the values of $\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ and $\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ into $x={x}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -{y}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ and $y={x}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +{y}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta .$
 ...
 $$
\begin{array}{l}  \\ \begin{array}{l}x={x}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -{y}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \\ x={x}^{\prime}\left(\frac{2}{\sqrt{5}}\right)-{y}^{\prime}\left(\frac{1}{\sqrt{5}}\right)  \\ x=\frac{2{x}^{\prime}-{y}^{\prime}}{\sqrt{5}}  \end{array}  \end{array}
$$

and

     $$
\begin{array}{l}\begin{array}{l}  \\ y={x}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +{y}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \end{array}  \\ y={x}^{\prime}\left(\frac{1}{\sqrt{5}}\right)+{y}^{\prime}\left(\frac{2}{\sqrt{5}}\right)  \\ y=\frac{{x}^{\prime}+2{y}^{\prime}}{\sqrt{5}}  \end{array}
$$

Substitute the expressions for $x$ and $y$ into in the given equation, and then simplify.

 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}8{\left(\frac{2{x}^{\prime}-{y}^{\prime}}{\sqrt{5}}\right)}^{2}-12\left(\frac{2{x}^{\prime}-{y}^{\prime}}{\sqrt{5}}\right)\left(\frac{{x}^{\prime}+2{y}^{\prime}}{\sqrt{5}}\right)+17{\left(\frac{{x}^{\prime}+2{y}^{\prime}}{\sqrt{5}}\right)}^{2}=20\phantom{\rule{0.5em}{0ex}}\text{\ \ \}  \\ \phantom{\rule{0.5em}{0ex}}\text{}8\left(\frac{(2{x}^{\prime}-{y}^{\prime})(2{x}^{\prime}-{y}^{\prime})}{5}\right)-12\left(\frac{(2{x}^{\prime}-{y}^{\prime})({x}^{\prime}+2{y}^{\prime})}{5}\right)+17\left(\frac{({x}^{\prime}+2{y}^{\prime})({x}^{\prime}+2{y}^{\prime})}{5}\right)=20\phantom{\rule{0.5em}{0ex}}\text{\ \ \}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \}8\left(4{x}^{\prime}{}^{2}-4{x}^{\prime}{y}^{\prime}+{y}^{\prime}{}^{2}\right)-12\left(2{x}^{\prime}{}^{2}+3{x}^{\prime}{y}^{\prime}-2{y}^{\prime}{}^{2}\right)+17\left({x}^{\prime}{}^{2}+4{x}^{\prime}{y}^{\prime}+4{y}^{\prime}{}^{2}\right)=100  \\ 32{x}^{\prime}{}^{2}-32{x}^{\prime}{y}^{\prime}+8{y}^{\prime}{}^{2}-24{x}^{\prime}{}^{2}-36{x}^{\prime}{y}^{\prime}+24{y}^{\prime}{}^{2}+17{x}^{\prime}{}^{2}+68{x}^{\prime}{y}^{\prime}+68{y}^{\prime}{}^{2}=100  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}25{x}^{\prime}{}^{2}+100{y}^{\prime}{}^{2}=100\phantom{\rule{0.5em}{0ex}}\text\   \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\frac{25}{100}{x}^{\prime}{}^{2}+\frac{100}{100}{y}^{\prime}{}^{2}=\frac{100}{100}\   \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_10_04_008.jpg)
</details>

>
>    Try It
>    12. Rewrite the $13{x}^{2}-6\sqrt{3}xy+7{y}^{2}=16$ in the ${x}^{\prime}{y}^{\prime}$ system without the ${x}^{\prime}{y}^{\prime}$ term.
>
> <details>
> <summary>Solution</summary>
>
...
<hr/>
   ...
   13. **Graphing an Equation That Has No *x′y′* Terms**        Graph the following equation relative to the ${x}^{\prime}{y}^{\prime}$ system:        $$ {x}^{2}+12xy-4{y}^{2}=30 $$
...
First, we find $\mathrm{cot}\left(2\theta \right).$
 ...
 $$
\begin{array}{l}\mathrm{cot}(2\theta )=\frac{A-C}{B}  \\ \mathrm{cot}(2\theta )=\frac{1-(\mathrm{-4})}{12}  \\ \mathrm{cot}(2\theta )=\frac{5}{12}  \end{array}
$$

Because $\mathrm{cot}\left(2\theta \right)=\frac{5}{12},$ we can draw a reference triangle as in .

![Image](../../media/CNX_Precalc_Figure_10_04_009.jpg)
...
Next, we find $\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta$ and $\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta .$ We will use half-angle identities.
 ...
 $$
\begin{array}{l}\begin{array}{l}  \\   \\ \mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\sqrt{\frac{1-\mathrm{cos}(2\theta )}{2}}=\sqrt{\frac{1-\frac{5}{13}}{2}}=\sqrt{\frac{\frac{13}{13}-\frac{5}{13}}{2}}=\sqrt{\frac{8}{13}\cdot \frac{1}{2}}=\frac{2}{\sqrt{13}}  \end{array}  \\ \mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta =\sqrt{\frac{1+\mathrm{cos}(2\theta )}{2}}=\sqrt{\frac{1+\frac{5}{13}}{2}}=\sqrt{\frac{\frac{13}{13}+\frac{5}{13}}{2}}=\sqrt{\frac{18}{13}\cdot \frac{1}{2}}=\frac{3}{\sqrt{13}}  \end{array}
$$
Now we find $x$ and $y\text{.\hspace{0.17em}}$
     

 $$
\begin{array}{l}  \\ x={x}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -{y}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \\ x={x}^{\prime}\left(\frac{3}{\sqrt{13}}\right)-{y}^{\prime}\left(\frac{2}{\sqrt{13}}\right)  \\ x=\frac{3{x}^{\prime}-2{y}^{\prime}}{\sqrt{13}}  \end{array}
$$

and

      $$
\begin{array}{l}  \\ y={x}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +{y}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \\ y={x}^{\prime}\left(\frac{2}{\sqrt{13}}\right)+{y}^{\prime}\left(\frac{3}{\sqrt{13}}\right)  \\ y=\frac{2{x}^{\prime}+3{y}^{\prime}}{\sqrt{13}}  \end{array}
$$
...
Now we substitute $x=\frac{3{x}^{\prime}-2{y}^{\prime}}{\sqrt{13}}$ and $y=\frac{2{x}^{\prime}+3{y}^{\prime}}{\sqrt{13}}$ into ${x}^{2}+12xy-4{y}^{2}=30.$
     ...
     $$
\begin{array}{llll}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}{\left(\frac{3{x}^{\prime}-2{y}^{\prime}}{\sqrt{13}}\right)}^{2}+12\left(\frac{3{x}^{\prime}-2{y}^{\prime}}{\sqrt{13}}\right)\left(\frac{2{x}^{\prime}+3{y}^{\prime}}{\sqrt{13}}\right)-4{\left(\frac{2{x}^{\prime}+3{y}^{\prime}}{\sqrt{13}}\right)}^{2}=30  &   &   &   \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\left(\frac{1}{13}\right)\left[{(3{x}^{\prime}-2{y}^{\prime})}^{2}+12(3{x}^{\prime}-2{y}^{\prime})(2{x}^{\prime}+3{y}^{\prime})-4{(2{x}^{\prime}+3{y}^{\prime})}^{2}\right]=30\   &   &   & \text{Factor}.  \\ \left(\frac{1}{13}\right)\left[9{x}^{\prime}{}^{2}-12{x}^{\prime}{y}^{\prime}+4{y}^{\prime}{}^{2}+12\left(6{x}^{\prime}{}^{2}+5{x}^{\prime}{y}^{\prime}-6{y}^{\prime}{}^{2}\right)-4\left(4{x}^{\prime}{}^{2}+12{x}^{\prime}{y}^{\prime}+9{y}^{\prime}{}^{2}\right)\right]=30  &   &   & \text{Multiply}.  \\ \phantom{\rule{0.5em}{0ex}}\text\ \left(\frac{1}{13}\right)\left[9{x}^{\prime}{}^{2}-12{x}^{\prime}{y}^{\prime}+4{y}^{\prime}{}^{2}+72{x}^{\prime}{}^{2}+60{x}^{\prime}{y}^{\prime}-72{y}^{\prime}{}^{2}-16{x}^{\prime}{}^{2}-48{x}^{\prime}{y}^{\prime}-36{y}^{\prime}{}^{2}\right]=30  &   &   & \text{Distribute}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\text{}\left(\frac{1}{13}\right)\left[65{x}^{\prime}{}^{2}-104{y}^{\prime}{}^{2}\right]=30  &   &   & \text{Combine\ like\ terms}.  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}65{x}^{\prime}{}^{2}-104{y}^{\prime}{}^{2}=390  &   &   & \text{Multiply}.\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\frac{{x}^{\prime}{}^{2}}{6}-\frac{4{y}^{\prime}{}^{2}}{15}=1\   &   &   & \text{Divide\ by\ 390}.  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_10_04_010.jpg)
</details>
...
14. **Identifying the Conic without Rotating Axes**        Identify the conic for each of the following without rotating axes.         ⓐ $5{x}^{2}+2\sqrt{3}xy+2{y}^{2}-5=0$              ⓑ $5{x}^{2}+2\sqrt{3}xy+12{y}^{2}-5=0$
...
Now, we find the discriminant. 
 ...
 $$
\begin{array}{l}{B}^{2}-4AC={\left(2\sqrt{3}\right)}^{2}-4(5)(2)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=4(3)-40  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=12-40  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=-28<0  \end{array}
$$
...
Now, we find the discriminant.
 ...
 $$
\begin{array}{l}{B}^{2}-4AC={\left(2\sqrt{3}\right)}^{2}-4(5)(12)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=4(3)-240  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=12-240  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=-228<0  \end{array}
$$
...
>
>    Try It
>    15. Identify the conic for each of the following without rotating axes. ⓐ ${x}^{2}-9xy+3{y}^{2}-12=0$             ⓑ $10{x}^{2}-9xy+4{y}^{2}-4=0$
>
> <details>
> <summary>Solution</summary>
>
...
| :--- | :--- |
| Rotation of a conic section | $$ \begin{array}{l}x={x}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta -{y}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \\ y={x}^{\prime}\mathrm{sin}\phantom{\rule{0.5em}{0ex}}\text{}\theta +{y}^{\prime}\mathrm{cos}\phantom{\rule{0.5em}{0ex}}\text{}\theta   \end{array} $$ |
...
5. For the equation $A{x}^{2}+Bxy+C{y}^{2}+Dx+Ey+F=0,$ the value of $\theta$ that satisfies $\mathrm{cot}\left(2\theta \right)=\frac{A-C}{B}$ gives us what information?
...
18. $3{x}^{2}+xy+3{y}^{2}-5=0,\theta =\mathrm{45\xb0}$

19. $4{x}^{2}-xy+4{y}^{2}-2=0,\theta =\mathrm{45\xb0}$
...
20. $2{x}^{2}+8xy-1=0,\theta =\mathrm{30\xb0}$

21. $-2{x}^{2}+8xy+1=0,\theta =\mathrm{45\xb0}$
...
22. $4{x}^{2}+\sqrt{2}xy+4{y}^{2}+y+2=0,\theta =\mathrm{45\xb0}$
...
26. $\mathrm{-3}{x}^{2}-\sqrt{3}xy-2{y}^{2}-x=0$
...
![Image](../../media/CNX_Precalc_Figure_10_04_201.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_203.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_205.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_207.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_209.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_211.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_213.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_215.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_217.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_219.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_221.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_223.jpg)
</details>
...
![Image](../../media/CNX_Precalc_Figure_10_04_225.jpg)
</details>
