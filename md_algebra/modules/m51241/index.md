...
Consider the product ${x}^{3}\cdot {x}^{4}.$ Both terms have the same base, *x*, but they are raised to different exponents. Expand each expression, and then rewrite the resulting expression.
 ...
 $$
\begin{array}{ccc}  {x}^{3}\cdot {x}^{4}& =& \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{x\cdot x\cdot x}}\cdot \stackrel{4\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{x\cdot x\cdot x\cdot x}}  \\ & =& \stackrel{7\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{x\cdot x\cdot x\cdot x\cdot x\cdot x\cdot x}}  \\ & =& {x}^{7}  \end{array}
$$
...
<hr/>
      ...
      1. **Using the Product Rule**             Write each of the following products with a single base. Do not simplify further.                         ⓐ ${t}^{5}\cdot {t}^{3}$                          ⓑ ${\left(\mathrm{-3}\right)}^{5}\cdot \left(\mathrm{-3}\right)$                          ⓒ  ${x}^{2}\cdot {x}^{5}\cdot {x}^{3}$
...
>
>       Try It
>       2. Write each of the following products with a single base. Do not simplify further.                     ⓐ ${k}^{6}\cdot {k}^{9}$                      ⓑ ${\left(\frac{2}{y}\right)}^{4}\cdot \left(\frac{2}{y}\right)$                      ⓒ ${t}^{3}\cdot {t}^{6}\cdot {t}^{5}$
>
> <details>
> <summary>Solution</summary>
>
...
The *quotient rule of exponents* allows us to simplify an expression that divides two numbers with the same base but different exponents. In a similar way to the product rule, we can simplify an expression such as $\frac{{y}^{m}}{{y}^{n}},$ where $m>n.$ Consider the example $\frac{{y}^{9}}{{y}^{5}}.$ Perform the division by canceling common factors.
 ...
 $\begin{array}{ccc}  \frac{{y}^{9}}{{y}^{5}}& =& \frac{y\cdot y\cdot y\cdot y\cdot y\cdot y\cdot y\cdot y\cdot y}{y\cdot y\cdot y\cdot y\cdot y}  \\ & =& \frac{\overline{)y}\cdot \overline{)y}\cdot \overline{)y}\cdot \overline{)y}\cdot \overline{)y}\cdot y\cdot y\cdot y\cdot y}{\overline{)y}\cdot \overline{)y}\cdot \overline{)y}\cdot \overline{)y}\cdot \overline{)y}}  \\ & =& \frac{y\cdot y\cdot y\cdot y}{1}  \\ & =& {y}^{4}  \end{array}$
...
<hr/>
      ...
      3. **Using the Quotient Rule**             Write each of the following products with a single base. Do not simplify further.                         ⓐ $\frac{{\left(\mathrm{-2}\right)}^{14}}{{\left(\mathrm{-2}\right)}^{9}}$                          ⓑ $\frac{{t}^{23}}{{t}^{15}}$                          ⓒ  $\frac{{\left(z\sqrt{2}\right)}^{5}}{z\sqrt{2}}$
...
>
>       Try It
>       4. Write each of the following products with a single base. Do not simplify further.                      ⓐ $\frac{{s}^{75}}{{s}^{68}}$                      ⓑ $\frac{{\left(\mathrm{-3}\right)}^{6}}{\mathrm{-3}}$                      ⓒ $\frac{{\left(e{f}^{2}\right)}^{5}}{{\left(e{f}^{2}\right)}^{3}}$
>
> <details>
> <summary>Solution</summary>
>
...
Suppose an exponential expression is raised to some power. Can we simplify the result? Yes. To do this, we use the *power rule of exponents*. Consider the expression ${\left({x}^{2}\right)}^{3}.$ The expression inside the parentheses is multiplied twice because it has an exponent of 2. Then the result is multiplied three times because the entire expression has an exponent of 3.
 ...
 $$
\begin{array}{ccc}  {\left({x}^{2}\right)}^{3}& =& \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{\left({x}^{2}\right)\cdot \left({x}^{2}\right)\cdot \left({x}^{2}\right)}}  \\ & =&   \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{\left(\stackrel{2\phantom{\rule{0.5em}{0ex}}\text{factors}}{\overbrace{x\cdot x}}\right)\cdot \left(\stackrel{2\phantom{\rule{0.5em}{0ex}}\text{factors}}{\overbrace{x\cdot x}}\right)\cdot \left(\stackrel{2\phantom{\rule{0.5em}{0ex}}\text{factors}}{\overbrace{x\cdot x}}\right)}}\\ & =& x\cdot x\cdot x\cdot x\cdot x\cdot x  \\ & =& {x}^{6}  \end{array}
$$
...
The exponent of the answer is the product of the exponents: ${\left({x}^{2}\right)}^{3}={x}^{2\cdot 3}={x}^{6}.$ In other words, when raising an exponential expression to a power, we write the result with the common base and the product of the exponents.
 ...
 $$
\begin{array}{cccccccccc}& & \text{Product\ Rule}  & & & & & \phantom{\rule{0.5em}{0ex}}\text{Power\ Rule}  & & \\   {5}^{3}\cdot {5}^{4}& =& {5}^{3+4}  & =& {5}^{7}  & \phantom{\rule{1em}{0ex}}\text{but}\phantom{\rule{1em}{0ex}}&   \phantom{\rule{0.5em}{0ex}}\text{}{({5}^{3})}^{4}& =& {5}^{3\cdot 4}  & =& {5}^{12}  \\   {x}^{5}\cdot {x}^{2}& =& {x}^{5+2}  & =& {x}^{7}  & \phantom{\rule{1em}{0ex}}\text{but}\phantom{\rule{1em}{0ex}}&   {({x}^{5})}^{2}& =& {x}^{5\cdot 2}  & =  & {x}^{10}  \\   {(3a)}^{7}\cdot {(3a)}^{10}& =& {(3a)}^{7+10}  & =& {(3a)}^{17}  & \phantom{\rule{1em}{0ex}}\text{but}\phantom{\rule{1em}{0ex}}&   {({(3a)}^{7})}^{10}& =& {(3a)}^{7\cdot 10}  & =& {(3a)}^{70}  \end{array}
$$
...
<hr/>
      ...
      5. **Using the Power Rule**             Write each of the following products with a single base. Do not simplify further.                         ⓐ ${\left({x}^{2}\right)}^{7}$                          ⓑ  ${\left({\left(2t\right)}^{5}\right)}^{3}$                          ⓒ  ${\left({\left(\mathrm{-3}\right)}^{5}\right)}^{11}$
...
>
>       Try It
>       6. Write each of the following products with a single base. Do not simplify further.                      ⓐ ${\left({\left(3y\right)}^{8}\right)}^{3}$                      ⓑ ${\left({t}^{5}\right)}^{7}$                      ⓒ ${\left({\left(-g\right)}^{4}\right)}^{4}$
>
> <details>
> <summary>Solution</summary>
>
...
7. **Using the Zero Exponent Rule**             Simplify each expression using the zero exponent rule of exponents.                         ⓐ $\frac{{c}^{3}}{{c}^{3}}$                          ⓑ $\frac{\mathrm{-3}{x}^{5}}{{x}^{5}}$                          ⓒ $\frac{{\left({j}^{2}k\right)}^{4}}{\left({j}^{2}k\right)\cdot {\left({j}^{2}k\right)}^{3}}$                          ⓓ $\frac{5{\left(r{s}^{2}\right)}^{2}}{{\left(r{s}^{2}\right)}^{2}}$
...
ⓐ 
 $\begin{array}{ccc}  \frac{{c}^{3}}{{c}^{3}}& =& {c}^{3-3}  \\ & =& {c}^{0}  \\ & =& 1  \end{array}$

ⓑ 
 $\begin{array}{ccc}  \frac{\mathrm{-3}{x}^{5}}{{x}^{5}}& =& \mathrm{-3}\cdot \frac{{x}^{5}}{{x}^{5}}  \\ & =& \mathrm{-3}\cdot {x}^{5-5}  \\ & =& \mathrm{-3}\cdot {x}^{0}  \\ & =& \mathrm{-3}\cdot 1  \\ & =& \mathrm{-3}  \end{array}$

ⓒ 
 $\begin{array}{cccc}  \frac{{\left({j}^{2}k\right)}^{4}}{\left({j}^{2}k\right)\cdot {\left({j}^{2}k\right)}^{3}}& =& \frac{{\left({j}^{2}k\right)}^{4}}{{\left({j}^{2}k\right)}^{1+3}}  & \phantom{\rule{3em}{0ex}}\text{Use\ the\ product\ rule\ in\ the\ denominator}.  \\ & =& \frac{{\left({j}^{2}k\right)}^{4}}{{\left({j}^{2}k\right)}^{4}}  & \phantom{\rule{3em}{0ex}}\text{Simplify}.  \\ & =& {\left({j}^{2}k\right)}^{4-4}  & \phantom{\rule{3em}{0ex}}\text{Use\ the\ quotient\ rule}.  \\ & =& {\left({j}^{2}k\right)}^{0}  & \phantom{\rule{3em}{0ex}}\text{Simplify}.  \\ & =& 1  & \end{array}$

ⓓ 
 $\begin{array}{cccc}  \frac{5{\left(r{s}^{2}\right)}^{2}}{{\left(r{s}^{2}\right)}^{2}}& =& 5{\left(r{s}^{2}\right)}^{2-2}  & \phantom{\rule{5em}{0ex}}\text{Use\ the\ quotient\ rule}.  \\ & =& 5{\left(r{s}^{2}\right)}^{0}  & \phantom{\rule{5em}{0ex}}\text{Simplify}.  \\ & =& 5\cdot 1  & \phantom{\rule{5em}{0ex}}\text{Use\ the\ zero\ exponent\ rule}.  \\ & =& 5  & \phantom{\rule{5em}{0ex}}\text{Simplify}.  \end{array}$
</details>

>
>       Try It
>       8. Simplify each expression using the zero exponent rule of exponents.                     ⓐ  $\frac{{t}^{7}}{{t}^{7}}$                      ⓑ  $\frac{{\left(d{e}^{2}\right)}^{11}}{2{\left(d{e}^{2}\right)}^{11}}$                      ⓒ  $\frac{{w}^{4}\cdot {w}^{2}}{{w}^{6}}$                      ⓓ  $\frac{{t}^{3}\cdot {t}^{4}}{{t}^{2}\cdot {t}^{5}}$
>
> <details>
> <summary>Solution</summary>
>
...
Divide one exponential expression by another with a larger exponent. Use our example, $\frac{{h}^{3}}{{h}^{5}}.$ 
 ...
 $\begin{array}{ccc}  \frac{{h}^{3}}{{h}^{5}}& =& \frac{h\cdot h\cdot h}{h\cdot h\cdot h\cdot h\cdot h}  \\ & =& \frac{\overline{)h}\cdot \overline{)h}\cdot \overline{)h}}{\overline{)h}\cdot \overline{)h}\cdot \overline{)h}\cdot h\cdot h}  \\ & =& \frac{1}{h\cdot h}  \\ & =& \frac{1}{{h}^{2}}  \end{array}$
...
<hr/>
      ...
      9. **Using the Negative Exponent Rule**             Write each of the following quotients with a single base. Do not simplify further. Write answers with positive exponents.                         ⓐ $\frac{{\theta}^{3}}{{\theta}^{10}}$                          ⓑ $\frac{{z}^{2}\cdot z}{{z}^{4}}$                          ⓒ $\frac{{\left(\mathrm{-5}{t}^{3}\right)}^{4}}{{\left(\mathrm{-5}{t}^{3}\right)}^{8}}$
...
>
>           Try It
>           10. Write each of the following quotients with a single base. Do not simplify further. Write answers with positive exponents.                             ⓐ $\frac{{\left(\mathrm{-3}t\right)}^{2}}{{\left(\mathrm{-3}t\right)}^{8}}$                              ⓑ $\frac{{f}^{47}}{{f}^{49}\cdot f}$                              ⓒ $\frac{2{k}^{4}}{5{k}^{7}}$
>
> <details>
> <summary>Solution</summary>
>
...
<hr/>
          ...
          11. **Using the Product and Quotient Rules**           Write each of the following products with a single base. Do not simplify further. Write answers with positive exponents.                                 ⓐ ${b}^{2}\cdot {b}^{\mathrm{-8}}$                                  ⓑ ${\left(-x\right)}^{5}\cdot {\left(-x\right)}^{\mathrm{-5}}$                                  ⓒ $\frac{\mathrm{-7}z}{{\left(\mathrm{-7}z\right)}^{5}}$
...
>
>       Try It
>       12. Write each of the following products with a single base. Do not simplify further. Write answers with positive exponents.                     ⓐ ${t}^{\mathrm{-11}}\cdot {t}^{6}$                      ⓑ $\frac{{25}^{12}}{{25}^{13}}$
>
> <details>
> <summary>Solution</summary>
>
...
To simplify the power of a product of two exponential expressions, we can use the *power of a product rule of exponents,* which breaks up the power of a product of factors into the product of the powers of the factors. For instance, consider ${\left(pq\right)}^{3}.$ We begin by using the associative and commutative properties of multiplication to regroup the factors.
 ...
 $$
\begin{array}{ccc}  {(pq)}^{3}& =& \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{(pq)\cdot (pq)\cdot (pq)}}  \\ & =& p\cdot q\cdot p\cdot q\cdot p\cdot q  \\ & =& \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{p\cdot p\cdot p}}\cdot \stackrel{3\phantom{\rule{0.5em}{0ex}}\text{factors}}{\stackrel{}{q\cdot q\cdot q}}  \\ & =& {p}^{3}\cdot {q}^{3}  \end{array}
$$
...
<hr/>
      ...
      13. **Using the Power of a Product Rule**             Simplify each of the following products as much as possible using the power of a product rule. Write answers with positive exponents.                         ⓐ ${\left(a{b}^{2}\right)}^{3}$                          ⓑ ${\left(2t\right)}^{15}$                          ⓒ ${\left(\mathrm{-2}{w}^{3}\right)}^{3}$                           ⓓ $\frac{1}{{\left(\mathrm{-7}z\right)}^{4}}$                          ⓔ ${\left({e}^{\mathrm{-2}}{f}^{2}\right)}^{7}$
...
>
>       Try It
>       14. Simplify each of the following products as much as possible using the power of a product rule. Write answers with positive exponents.             ⓐ ${\left({g}^{2}{h}^{3}\right)}^{5}$                          ⓑ ${\left(5t\right)}^{3}$                          ⓒ ${\left(\mathrm{-3}{y}^{5}\right)}^{3}$                           ⓓ $\frac{1}{{\left({a}^{6}{b}^{7}\right)}^{3}}$                          ⓔ ${\left({r}^{3}{s}^{\mathrm{-2}}\right)}^{4}$
>
> <details>
> <summary>Solution</summary>
>
...
To simplify the power of a quotient of two expressions, we can use the *power of a quotient rule,* which states that the power of a quotient of factors is the quotient of the powers of the factors. For example, let’s look at the following example.
 ...
 $$
\begin{array}{ccc}  {\left({e}^{\mathrm{-2}}{f}^{2}\right)}^{7}& =& {\left(\frac{{f}^{2}}{{e}^{2}}\right)}^{7}  \\ & =& \frac{{f}^{14}}{{e}^{14}}  \end{array}
$$

It appears from the last two steps that we can use the power of a product rule as a power of a quotient rule.

 $$
\begin{array}{ccc}  {\left({e}^{-2}{f}^{2}\right)}^{7}& =& {\left(\frac{{f}^{2}}{{e}^{2}}\right)}^{7}  \\ & =& \frac{{({f}^{2})}^{7}}{{({e}^{2})}^{7}}  \\ & =& \frac{{f}^{2\cdot 7}}{{e}^{2\cdot 7}}  \\ & =& \frac{{f}^{14}}{{e}^{14}}  \end{array}
$$
...
<hr/>
      ...
      15. **Using the Power of a Quotient Rule**             Simplify each of the following quotients as much as possible using the power of a quotient rule. Write answers with positive exponents.                         ⓐ ${\left(\frac{4}{{z}^{11}}\right)}^{3}$                          ⓑ ${\left(\frac{p}{{q}^{3}}\right)}^{6}$                          ⓒ ${\left(\frac{\mathrm{-1}}{{t}^{2}}\right)}^{27}$                           ⓓ ${\left({j}^{3}{k}^{\mathrm{-2}}\right)}^{4}$                          ⓔ ${\left({m}^{\mathrm{-2}}{n}^{\mathrm{-2}}\right)}^{3}$
...
>
>       Try It
>       16. Simplify each of the following quotients as much as possible using the power of a quotient rule. Write answers with positive exponents.           ⓐ ${\left(\frac{{b}^{5}}{c}\right)}^{3}$                      ⓑ ${\left(\frac{5}{{u}^{8}}\right)}^{4}$                      ⓒ ${\left(\frac{\mathrm{-1}}{{w}^{3}}\right)}^{35}$                       ⓓ ${\left({p}^{\mathrm{-4}}{q}^{3}\right)}^{8}$                      ⓔ ${\left({c}^{\mathrm{-5}}{d}^{\mathrm{-3}}\right)}^{4}$
>
> <details>
> <summary>Solution</summary>
>
...
<hr/>
      ...
      17. **Simplifying Exponential Expressions**             Simplify each expression and write the answer with positive exponents only.                         ⓐ ${\left(6{m}^{2}{n}^{\mathrm{-1}}\right)}^{3}$                          ⓑ ${17}^{5}\cdot {17}^{\mathrm{-4}}\cdot {17}^{\mathrm{-3}}$                          ⓒ ${\left(\frac{{u}^{\mathrm{-1}}v}{{v}^{\mathrm{-1}}}\right)}^{2}$                           ⓓ $\left(\mathrm{-2}{a}^{3}{b}^{\mathrm{-1}}\right)\left(5{a}^{\mathrm{-2}}{b}^{2}\right)$                          ⓔ ${\left({x}^{2}\sqrt{2}\right)}^{4}{\left({x}^{2}\sqrt{2}\right)}^{\mathrm{-4}}$                          ⓕ $\frac{{\left(3{w}^{2}\right)}^{5}}{{\left(6{w}^{\mathrm{-2}}\right)}^{2}}$

<details>
<summary>Solution</summary>

ⓐ $\begin{array}{cccc}  {\left(6{m}^{2}{n}^{\mathrm{-1}}\right)}^{3}& =& {(6)}^{3}{\left({m}^{2}\right)}^{3}{\left({n}^{\mathrm{-1}}\right)}^{3}  & \phantom{\rule{9em}{0ex}}\text{The\ power\ of\ a\ product\ rule}  \\ & =& {6}^{3}{m}^{2\cdot 3}{n}^{\mathrm{-1}\cdot 3}  & \phantom{\rule{9em}{0ex}}\text{The\ power\ rule}  \\ & =& \phantom{\rule{0.5em}{0ex}}\text{}216{m}^{6}{n}^{\mathrm{-3}}  & \phantom{\rule{9em}{0ex}}\text{Simplify}.  \\ & =& \frac{216{m}^{6}}{{n}^{3}}  & \phantom{\rule{9em}{0ex}}\text{The\ negative\ exponent\ rule}  \end{array}$

ⓑ $\begin{array}{cccc}  {17}^{5}\cdot {17}^{\mathrm{-4}}\cdot {17}^{\mathrm{-3}}& =& {17}^{5-4-3}  & \phantom{\rule{9em}{0ex}}\text{The\ product\ rule}  \\ & =& {17}^{\mathrm{-2}}  & \phantom{\rule{9em}{0ex}}\text{Simplify}.  \\ & =& \frac{1}{{17}^{2}}\phantom{\rule{0.5em}{0ex}}\text{or\}\frac{1}{289}  & \phantom{\rule{9em}{0ex}}\text{The\ negative\ exponent\ rule}  \end{array}$

ⓒ $\begin{array}{cccc}  {\left(\frac{{u}^{\mathrm{-1}}v}{{v}^{\mathrm{-1}}}\right)}^{2}& =& \frac{{({u}^{\mathrm{-1}}v)}^{2}}{{({v}^{\mathrm{-1}})}^{2}}  & \phantom{\rule{12em}{0ex}}\text{The\ power\ of\ a\ quotient\ rule}  \\ & =& \frac{{u}^{\mathrm{-2}}{v}^{2}}{{v}^{\mathrm{-2}}}  & \phantom{\rule{12em}{0ex}}\text{The\ power\ of\ a\ product\ rule}  \\ & =& {u}^{\mathrm{-2}}{v}^{2-(\mathrm{-2})}& \phantom{\rule{12em}{0ex}}\text{The\ quotient\ rule}  \\ & =& {u}^{\mathrm{-2}}{v}^{4}  & \phantom{\rule{12em}{0ex}}\text{Simplify}.  \\ & =& \frac{{v}^{4}}{{u}^{2}}  & \phantom{\rule{12em}{0ex}}\text{The\ negative\ exponent\ rule}  \end{array}$

 ⓓ $\begin{array}{cccc}  \left(\mathrm{-2}{a}^{3}{b}^{-1}\right)\left(5{a}^{\mathrm{-2}}{b}^{2}\right)& =& \mathrm{-2}\cdot 5\cdot {a}^{3}\cdot {a}^{\mathrm{-2}}\cdot {b}^{\mathrm{-1}}\cdot {b}^{2}  & \phantom{\rule{3em}{0ex}}\text{Commutative\ and\ associative\ laws\ of\ multiplication}  \\ & =& \mathrm{-10}\cdot {a}^{3-2}\cdot {b}^{\mathrm{-1}+2}  & \phantom{\rule{3em}{0ex}}\text{The\ product\ rule}  \\ & =& \mathrm{-10}ab  & \phantom{\rule{3em}{0ex}}\text{Simplify}.  \end{array}$

ⓔ $\begin{array}{cccc}  {\left({x}^{2}\sqrt{2}\right)}^{4}{\left({x}^{2}\sqrt{2}\right)}^{\mathrm{-4}}& =& {\left({x}^{2}\sqrt{2}\right)}^{4-4}  & \phantom{\rule{8em}{0ex}}\text{The\ product\ rule}  \\ & =& \phantom{\rule{0.5em}{0ex}}\text{}{\left({x}^{2}\sqrt{2}\right)}^{0}  & \phantom{\rule{8em}{0ex}}\text{Simplify}.  \\ & =& 1  & \phantom{\rule{8em}{0ex}}\text{The\ zero\ exponent\ rule}  \end{array}$

ⓕ $\begin{array}{cccc}  \frac{{(3{w}^{2})}^{5}}{{(6{w}^{\mathrm{-2}})}^{2}}& =& \frac{{(3)}^{5}\cdot {({w}^{2})}^{5}}{{(6)}^{2}\cdot {({w}^{\mathrm{-2}})}^{2}}  & \phantom{\rule{13.5em}{0ex}}\text{The\ power\ of\ a\ product\ rule}  \\ & =& \frac{{3}^{5}{w}^{2\cdot 5}}{{6}^{2}{w}^{\mathrm{-2}\cdot 2}}  & \phantom{\rule{13.5em}{0ex}}\text{The\ power\ rule}  \\ & =& \frac{243{w}^{10}}{36{w}^{\mathrm{-4}}}  & \phantom{\rule{13.5em}{0ex}}\text{Simplify}.  \\ & =& \frac{27{w}^{10-(\mathrm{-4})}}{4}  & \phantom{\rule{13.5em}{0ex}}\text{The\ quotient\ rule\ and\ reduce\ fraction}  \\ & =& \frac{27{w}^{14}}{4}  & \phantom{\rule{13.5em}{0ex}}\text{Simplify}.  \end{array}$
</details>
...
>
>       Try It
>       18. Simplify each expression and write the answer with positive exponents only.           ⓐ ${\left(2u{v}^{-2}\right)}^{\mathrm{-3}}$                      ⓑ ${x}^{8}\cdot {x}^{\mathrm{-12}}\cdot x$                      ⓒ ${\left(\frac{{e}^{2}{f}^{-3}}{{f}^{\mathrm{-1}}}\right)}^{2}$                       ⓓ $\left(9{r}^{\mathrm{-5}}{s}^{3}\right)\left(3{r}^{6}{s}^{\mathrm{-4}}\right)$                      ⓔ ${\left(\frac{4}{9}t{w}^{\mathrm{-2}}\right)}^{\mathrm{-3}}{\left(\frac{4}{9}t{w}^{\mathrm{-2}}\right)}^{3}$                      ⓕ $\frac{{\left(2{h}^{2}k\right)}^{4}}{{\left(7{h}^{\mathrm{-1}}{k}^{2}\right)}^{2}}$
>
> <details>
> <summary>Solution</summary>
>
...
19. **Converting Standard Notation to Scientific Notation**   Write each number in scientific notation.  ⓐDistance to Andromeda Galaxy from Earth:	24,000,000,000,000,000,000,000 m  ⓑDiameter of Andromeda Galaxy:	1,300,000,000,000,000,000,000 m  ⓒNumber of stars in Andromeda Galaxy:	1,000,000,000,000  ⓓDiameter of electron:	0.00000000000094 m  ⓔProbability of being struck by lightning in any single year:	0.00000143

<details>
<summary>Solution</summary>

ⓐ $\begin{array}{l}\mathrm{24,000,000,000,000,000,000,000}\phantom{\rule{0.5em}{0ex}}\text{m}  \\ \underset{\leftarrow 22\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{\mathrm{24,000,000,000,000,000,000,000}\phantom{\rule{0.5em}{0ex}}\text{m}}}  \\ 2.4\times {10}^{22}\phantom{\rule{0.5em}{0ex}}\text{m}  \end{array}$
  

  ⓑ $\begin{array}{l}\mathrm{1,300,000,000,000,000,000,000}\phantom{\rule{0.5em}{0ex}}\text{m}  \\ \underset{\leftarrow 21\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{\mathrm{1,300,000,000,000,000,000,000}\phantom{\rule{0.5em}{0ex}}\text{m}}}  \\ 1.3\times {10}^{21}\phantom{\rule{0.5em}{0ex}}\text{m}  \end{array}$

  ⓒ $\begin{array}{l}\mathrm{1,000,000,000,000}  \\ \underset{\leftarrow 12\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{\mathrm{1,000,000,000,000}}}  \\ 1\times {10}^{12}  \end{array}$

   ⓓ $\begin{array}{l}0.00000000000094\phantom{\rule{0.5em}{0ex}}\text{m}  \\ \underset{\to 13\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{0.00000000000094\phantom{\rule{0.5em}{0ex}}\text{m}}}  \\ 9.4\times {10}^{\mathrm{-13}}\phantom{\rule{0.5em}{0ex}}\text{m}  \end{array}$

  ⓔ $\begin{array}{l}0.00000143  \\ \underset{\to 6\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{0.00000143}}  \\ 1.43\times {10}^{\mathrm{-6}}  \end{array}$
</details>

>
> Try It
>   20. Write each number in scientific notation.   ⓐU.S. national debt per taxpayer (April 2014): $152,000 ⓑWorld population (April 2014): 7,158,000,000 ⓒWorld gross national income (April 2014): $85,500,000,000,000 ⓓTime for light to travel 1 m: 0.00000000334 s ⓔProbability of winning lottery (match 6 of 49 possible numbers): 0.0000000715
>
> <details>
> <summary>Solution</summary>
>
...
21. **Converting Scientific Notation to Standard Notation**   Convert each number in scientific notation to standard notation.   ⓐ $3.547\times {10}^{14}$      ⓑ $\mathrm{-2}\times {10}^{6}$      ⓒ $7.91\times {10}^{\mathrm{-7}}$      ⓓ $\mathrm{-8.05}\times {10}^{\mathrm{-12}}$

<details>
<summary>Solution</summary>

ⓐ $\begin{array}{l}3.547\times {10}^{14}  \\ \underset{\to 14\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{3.54700000000000}}  \\ \mathrm{354,700,000,000,000}  \end{array}$
  
  ⓑ $\begin{array}{l}\mathrm{-2}\times {10}^{6}  \\ \underset{\to 6\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{\mathrm{-2.000000}}}  \\ \mathrm{-2,000,000}  \end{array}$
  
  ⓒ $\begin{array}{l}7.91\times {10}^{\mathrm{-7}}  \\ \underset{\leftarrow 7\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{0000007.91}}  \\ 0.000000791  \end{array}$
  
  ⓓ $\begin{array}{l}\mathrm{-8.05}\times {10}^{\mathrm{-12}}  \\ \underset{\leftarrow 12\phantom{\rule{0.5em}{0ex}}\text{places}}{\underset{}{\mathrm{-000000000008.05}}}  \\ \mathrm{-0.00000000000805}  \end{array}$
</details>

>
> Try It
> 22. Convert each number in scientific notation to standard notation.     ⓐ $7.03\times {10}^{5}$          ⓑ $\mathrm{-8.16}\times {10}^{11}$          ⓒ $\mathrm{-3.9}\times {10}^{\mathrm{-13}}$          ⓓ $8\times {10}^{\mathrm{-6}}$
>
> <details>
> <summary>Solution</summary>
>
...
23. **Using Scientific Notation**   Perform the operations and write the answer in scientific notation.   ⓐ $\left(8.14\times {10}^{\mathrm{-7}}\right)\left(6.5\times {10}^{10}\right)$      ⓑ $\left(4\times {10}^{5}\right)\xf7\left(\mathrm{-1.52}\times {10}^{9}\right)$      ⓒ $\left(2.7\times {10}^{5}\right)\left(6.04\times {10}^{13}\right)$      ⓓ $\left(1.2\times {10}^{8}\right)\xf7\left(9.6\times {10}^{5}\right)$      ⓔ $\left(3.33\times {10}^{4}\right)\left(\mathrm{-1.05}\times {10}^{7}\right)\left(5.62\times {10}^{5}\right)$

<details>
<summary>Solution</summary>

ⓐ
 $\begin{array}{cccc}  \left(8.14\times {10}^{\mathrm{-7}}\right)\left(6.5\times {10}^{10}\right)& =& (8.14\times 6.5)\left({10}^{\mathrm{-7}}\times {10}^{10}\right)  & \begin{array}{l}\phantom{\rule{3em}{0ex}}\text{Commutative\ and\ associative}  \\ \phantom{\rule{3em}{0ex}}\text{properties\ of\ multiplication}  \end{array}  \\ & =& (52.91)\left({10}^{3}\right)  & \phantom{\rule{3em}{0ex}}\text{Product\ rule\ of\ exponents}  \\ & =& 5.291\times {10}^{4}  & \phantom{\rule{3em}{0ex}}\text{Scientific\ notation}  \end{array}$

ⓑ
 $\begin{array}{cccc}  \left(4\times {10}^{5}\right)\xf7\left(\mathrm{-1.52}\times {10}^{9}\right)& =& \left(\frac{4}{\mathrm{-1.52}}\right)\left(\frac{{10}^{5}}{{10}^{9}}\right)  & \begin{array}{l}\phantom{\rule{8em}{0ex}}\text{Commutative\ and\ associative}  \\ \phantom{\rule{8em}{0ex}}\text{properties\ of\ multiplication}  \end{array}  \\ & \approx & (\mathrm{-2.63})\left({10}^{\mathrm{-4}}\right)  & \phantom{\rule{8em}{0ex}}\text{Quotient\ rule\ of\ exponents}  \\ & =& \mathrm{-2.63}\times {10}^{\mathrm{-4}}  & \phantom{\rule{8em}{0ex}}\text{Scientific\ notation}  \end{array}$

ⓒ $\begin{array}{cccc}  \left(2.7\times {10}^{5}\right)\left(6.04\times {10}^{13}\right)& =& (2.7\times 6.04)\left({10}^{5}\times {10}^{13}\right)  & \begin{array}{l}\phantom{\rule{4em}{0ex}}\text{Commutative\ and\ associative}  \\ \phantom{\rule{4em}{0ex}}\text{properties\ of\ multiplication}  \end{array}  \\ & =& (16.308)\left({10}^{18}\right)  & \phantom{\rule{4em}{0ex}}\text{Product\ rule\ of\ exponents}  \\ & =& 1.6308\times {10}^{19}  & \phantom{\rule{4em}{0ex}}\text{Scientific\ notation}  \end{array}$

ⓓ
 $\begin{array}{cccc}  \left(1.2\times {10}^{8}\right)\xf7\left(9.6\times {10}^{5}\right)& =& \left(\frac{1.2}{9.6}\right)\left(\frac{{10}^{8}}{{10}^{5}}\right)  & \begin{array}{l}\phantom{\rule{9em}{0ex}}\text{Commutative\ and\ associative}  \\ \phantom{\rule{9em}{0ex}}\text{properties\ of\ multiplication}  \end{array}  \\ & =& (0.125)\left({10}^{3}\right)  & \phantom{\rule{9em}{0ex}}\text{Quotient\ rule\ of\ exponents}  \\ & =& 1.25\times {10}^{2}  & \phantom{\rule{9em}{0ex}}\text{Scientific\ notation}  \end{array}$

ⓔ $\begin{array}{ccc}  \left(3.33\times {10}^{4}\right)\left(\mathrm{-1.05}\times {10}^{7}\right)\left(5.62\times {10}^{5}\right)& =& [3.33\times (\mathrm{-1.05})\times 5.62]\left({10}^{4}\times {10}^{7}\times {10}^{5}\right)  \\ & \approx & (\mathrm{-19.65})\left({10}^{16}\right)  \\ & =& \mathrm{-1.965}\times {10}^{17}  \end{array}$
</details>

>
> Try It
>   24. Perform the operations and write the answer in scientific notation.   ⓐ $\left(\mathrm{-7.5}\times {10}^{8}\right)\left(1.13\times {10}^{\mathrm{-2}}\right)$      ⓑ $\left(1.24\times {10}^{11}\right)\xf7\left(1.55\times {10}^{18}\right)$      ⓒ $\left(3.72\times {10}^{9}\right)\left(8\times {10}^{3}\right)$      ⓓ $\left(9.933\times {10}^{23}\right)\xf7\left(-2.31\times {10}^{17}\right)$      ⓔ $\left(\mathrm{-6.04}\times {10}^{9}\right)\left(7.3\times {10}^{2}\right)\left(\mathrm{-2.81}\times {10}^{2}\right)$
>
> <details>
> <summary>Solution</summary>
>
...
To find the amount of debt per citizen, divide the national debt by the number of citizens.
 ...
 $$
\begin{array}{ccc}  (1.75\times {10}^{13})\xf7(3.08\times {10}^{8})& =& \left(\frac{1.75}{3.08}\right)\cdot \left(\frac{{10}^{13}}{{10}^{8}}\right)  \\ & \approx & 0.57\times {10}^{5}  \\ & =& 5.7\times {10}^{4}  \end{array}
$$
...
>
>     Try It
>     26. An average human body contains around 30,000,000,000,000 red blood cells. Each cell measures approximately 0.000008 m long. Write each number in scientific notation and find the total length if the cells were laid end-to-end. Write the answer in both scientific and standard notations.
>
> <details>
> <summary>Solution</summary>
>
...
## Verbal
1. Is ${2}^{3}$ the same as ${3}^{2}?$ Explain.
...
15. ${4}^{2}\times {4}^{3}\xf7{4}^{\mathrm{-4}}$
...
18. ${10}^{6}\xf7{\left({10}^{10}\right)}^{\mathrm{-2}}$

19. ${7}^{\mathrm{-6}}\times {7}^{\mathrm{-3}}$
...
26. $\frac{m{n}^{2}}{{m}^{\mathrm{-2}}}$

27. ${\left({b}^{3}{c}^{4}\right)}^{2}$
...
28. ${\left(\frac{{x}^{\mathrm{-3}}}{{y}^{2}}\right)}^{\mathrm{-5}}$

29. $a{b}^{2}\xf7{d}^{\mathrm{-3}}$
...
30. ${\left({w}^{0}{x}^{5}\right)}^{\mathrm{-1}}$
...
32. ${y}^{\mathrm{-4}}{\left({y}^{2}\right)}^{2}$

33. $\frac{{p}^{\mathrm{-4}}{q}^{2}}{{p}^{2}{q}^{\mathrm{-3}}}$
...
38. $\frac{{\left(16\sqrt{x}\right)}^{2}}{{y}^{\mathrm{-1}}}$

39. $\frac{{2}^{3}}{{\left(3a\right)}^{\mathrm{-2}}}$
...
40. ${\left(m{a}^{6}\right)}^{2}\frac{1}{{m}^{3}{a}^{2}}$

41. ${\left({b}^{\mathrm{-3}}c\right)}^{3}$
...
42. ${\left({x}^{2}{y}^{13}\xf7{y}^{0}\right)}^{2}$

43. ${\left(9{z}^{3}\right)}^{\mathrm{-2}}y$
...
44. To reach escape velocity, a rocket must travel at the rate of $2.2\times {10}^{6}$ ft/min. Rewrite the rate in standard notation.

45. A dime is the thinnest coin in U.S. currency. A dime’s thickness measures $1.35\times {10}^{\mathrm{-3}}$ m. Rewrite the number in standard notation.
...
48. The Gross Domestic Product (GDP) for the United States in the first quarter of 2014 was $\text{$}1.71496\times {10}^{13}.$ Rewrite the GDP in standard notation.

49. One picometer is approximately $3.397\times {10}^{\mathrm{-11}}$ in. Rewrite this length using standard notation.
...
51. ${\left(\frac{{12}^{3}{m}^{33}}{{4}^{\mathrm{-3}}}\right)}^{2}$
...
52. ${17}^{3}\xf7{15}^{2}{x}^{3}$

## Extensions
For the following exercises, simplify the given expression. Write answers with positive exponents.
53. ${\left(\frac{{3}^{2}}{{a}^{3}}\right)}^{\mathrm{-2}}{\left(\frac{{a}^{4}}{{2}^{2}}\right)}^{2}$
...
54. ${\left({6}^{2}\mathrm{-24}\right)}^{2}\xf7{\left(\frac{x}{y}\right)}^{\mathrm{-5}}$

55. $\frac{{m}^{2}{n}^{3}}{{a}^{2}{c}^{\mathrm{-3}}}\cdot \frac{{a}^{\mathrm{-7}}{n}^{\mathrm{-2}}}{{m}^{2}{c}^{4}}$
...
56. ${\left(\frac{{x}^{6}{y}^{3}}{{x}^{3}{y}^{\mathrm{-3}}}\cdot \frac{{y}^{\mathrm{-7}}}{{x}^{\mathrm{-3}}}\right)}^{10}$

57. ${\left(\frac{{\left(a{b}^{2}c\right)}^{\mathrm{-3}}}{{b}^{\mathrm{-3}}}\right)}^{2}$
...
58. Avogadro’s constant is used to calculate the number of particles in a mole. A mole is a basic unit in chemistry to measure the amount of a substance. The constant is $6.0221413\times {10}^{23}.$ Write Avogadro’s constant in standard notation.

59. Planck’s constant is an important unit of measure in quantum physics. It describes the relationship between energy and frequency. The constant is written as $6.62606957\times {10}^{\mathrm{-34}}.$ Write Planck’s constant in standard notation.
