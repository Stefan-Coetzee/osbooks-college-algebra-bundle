...
1. ⓐ     ![.](../../media/CNX_Coreq_Figure_06_04_001.jpg)               ⓑ    ![.](../../media/CNX_Coreq_Figure_06_04_002.jpg)                    ⓒ      Find the domain of the function $f\left(x\right)=\frac{5}{x-2}$                           ⓓ   Find the domain of the function $f\left(x\right)={\mathrm{log}}_{2}(x-5)$ .
...
2. Find the domain and range of a relation.   ![.](../../media/CNX_Coreq_Figure_06_04_003.jpg)
...
| :--- | :--- | :--- |
| $\mathrm{-2}$ | ${2}^{\mathrm{-2}}=\frac{1}{{2}^{2}}=\frac{1}{4}$ | $\left(\frac{1}{4},2\right)$ |
| $\mathrm{-1}$ | ${2}^{\mathrm{-1}}=\frac{1}{{2}^{1}}=\frac{1}{2}$ | $\left(\frac{1}{2},\mathrm{-1}\right)$ |
| 0 | ${2}^{0}=1$ | $\left(1,0\right)$ |
| 1 | ${2}^{1}=2$ | $\left(2,1\right)$ |
| 2 | ${2}^{2}=4$ | $\left(4,2\right)$ |
| 3 | ${2}^{3}=8$ | $\left(8,3\right)$ |

![This figure shows the logarithmic curve going through the points (1 over 2, negative 1), (1, 0), and (2, 1).](../../media/CNX_IntAlg_Figure_10_03_004_img.jpg)
</details>
...
7. Graph $y={\mathrm{log}}_{1/3}x\$   | $y$ | ${\left(\frac{1}{3}\right)}^{y}=x$ | $(x,y)$ | | :--- | :--- | :--- | |  |  |  | |  |  |  | |  |  |  | |  |  |  | |  |  |  | |  |  |  | |  |  |  |     ![A blank line graph](../../media/blankplot5.5.png)
...
9. Is there a point they all share? Why does this make sense?
...
The logarithmic function is defined only when the input is positive, so this function is defined when $x+3>0.$ Solving this inequality,
 ...
 $$
\begin{array}{ll}x+3>0  & \text{The\ input\ must\ be\ positive}.  \\ x>-3\begin{array}{cccc}& & & \end{array}  & \text{Subtract\ 3}.  \end{array}
$$
...
The logarithmic function is defined only when the input is positive, so this function is defined when $5\u20132x>0.$ Solving this inequality,
 ...
 $$
\begin{array}{ll}5-2x>0  & \text{The\ input\ must\ be\ positive}.  \\ -2x>-5  & \text{Subtract\}5.  \\ x<\frac{5}{2}\begin{array}{cccc}& & & \end{array}  & \text{Divide\ by\}-2\phantom{\rule{0.5em}{0ex}}\text{and\ switch\ the\ inequality}.  \end{array}
$$
...
![Notice that the graphs of $f\left(x\right)={2}^{x}$ and $g\left(x\right)={\mathrm{log}}_{2}\left(x\right)$ are reflections about the line $y=x.$](../../media/CNX_Precalc_Figure_04_04_002.jpg)
...
>
>
> ![Image](../../media/CNX_Precalc_Figure_04_04_003G.jpg)
>
...
![Image](../../media/CNX_Precalc_Figure_04_04_005.jpg)
...
> <summary>Solution</summary>
>
> ![Graph of f(x)=log_(1/5)(x) with labeled points at (1/5, 1) and (1, 0). The y-axis is the asymptote.](../../media/CNX_Precalc_Figure_04_04_006.jpg)
>
>
>
> The domain is $\left(0,\infty \right),$ the range is $\left(-\infty ,\infty \right),$ and the vertical asymptote is $x=0.$
...
![Image](../../media/CNX_Precalc_Figure_04_04_008.jpg)
</details>
...
> <summary>Solution</summary>
>
> ![Graph of two functions. The parent function is y=log_3(x), with an asymptote at x=0 and labeled points at (1, 0), and (3, 1).The translation function f(x)=log_3(x+4) has an asymptote at x=-4 and labeled points at (-3, 0) and (-1, 1).](../../media/CNX_Precalc_Figure_04_04_009.jpg)
>
>
>
...
![Image](../../media/CNX_Precalc_Figure_04_04_010F.jpg)
...
![Image](../../media/CNX_Precalc_Figure_04_04_011.jpg)
...
> <summary>Solution</summary>
>
> ![Graph of two functions. The parent function is y=log_2(x), with an asymptote at x=0 and labeled points at (1, 0), and (2, 1).The translation function f(x)=log_2(x)+2 has an asymptote at x=0 and labeled points at (0.25, 0) and (0.5, 1).](../../media/CNX_Precalc_Figure_04_04_012.jpg)
>
>
>
> The domain is $\left(0,\infty \right),$ the range is $\left(-\infty ,\infty \right),$ and the vertical asymptote is $x=0.$
...
![Image](../../media/CNX_Precalc_Figure_04_04_014.jpg)
...
> <summary>Solution</summary>
>
> ![Graph of two functions. The parent function is y=log_4(x), with an asymptote at x=0 and labeled points at (1, 0), and (4, 1).The translation function f(x)=(1/2)log_4(x) has an asymptote at x=0 and labeled points at (1, 0) and (16, 1).](../../media/CNX_Precalc_Figure_04_04_015.jpg)
>
>
>
> The domain is $\left(0,\infty \right),$ the range is $\left(-\infty ,\infty \right),$ and the vertical asymptote is $x=0.$
...
![Image](../../media/CNX_Precalc_Figure_04_04_016.jpg)
...
> <summary>Solution</summary>
>
> ![Graph of f(x)=3log(x-2)+1 with an asymptote at x=2.](../../media/CNX_Precalc_Figure_04_04_017.jpg)
>
>
>
> The domain is $\left(2,\infty \right),$ the range is $\left(-\infty ,\infty \right),$ and the vertical asymptote is $x=2.$
...
![Image](../../media/CNX_Precalc_Figure_04_04_019.jpg)
...
> <summary>Solution</summary>
>
> ![Graph of f(x)=-log(-x) with an asymptote at x=0.](../../media/CNX_Precalc_Figure_04_04_020.jpg)
>
>
>
> The domain is $\left(-\infty ,0\right),$ the range is $\left(-\infty ,\infty \right),$ and the vertical asymptote is $x=0.$
...
It appears the graph passes through the points $\left(\mathrm{\u20131},1\right)$ and $\left(2,\mathrm{\u20131}\right).$ Substituting $\left(\mathrm{\u20131},1\right),$ 
 $$
\begin{array}{ll}1=-a\mathrm{log}(\mathrm{-1}+2)+k\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}  & \text{Substitute\}(\mathrm{-1},1).  \\ 1=-a\mathrm{log}(1)+k  & \text{Arithmetic}.  \\ 1=k  & \text{log(1)}=0.  \end{array}
$$
Next, substituting in $\left(2,\mathrm{\u20131}\right)$ ,
 $$
\begin{array}{lll}-1=-a\mathrm{log}(2+2)+1  &   & \text{Plug\ in\}(2,\mathrm{-1}).  \\ -2=-a\mathrm{log}(4)  &   & \text{Arithmetic}.  \\ \phantom{\rule{0.5em}{0ex}}\text\ a=\frac{2}{\mathrm{log}(4)}  &   & \text{Solve\ for\}a.  \end{array}
$$
...
![Image](../../media/CNX_PreCalc_Figure_04_04_201.jpg)
...
31. $f(x)={\mathrm{log}}_{\frac{1}{3}}\left(x\right)$
...
![Graph of two functions, g(x) = log_(1/2)(x) in orange and f(x)=log(x) in blue.](../../media/CNX_PreCalc_Figure_04_04_204.jpg)
</details>
...
![Graph of two functions, g(x) = ln(1/2)(x) in orange and f(x)=e^(x) in blue.](../../media/CNX_PreCalc_Figure_04_04_206.jpg)
</details>
...
![Graph of f(x)=log_2(x+2).](../../media/CNX_PreCalc_Figure_04_04_208.jpg)
</details>

42. $f(x)=2\mathrm{log}(x)$
...
![Graph of f(x)=ln(-x).](../../media/CNX_PreCalc_Figure_04_04_210.jpg)
</details>
...
![Graph of g(x)=log(6-3x)+1.](../../media/CNX_PreCalc_Figure_04_04_212.jpg)
</details>
...
49. Use $f(x)={\mathrm{log}}_{4}(x)$ as the parent function.    ![The graph y=log_4(x) has been vertically stretched by 3, and shifted to the left by 2.](../../media/CNX_PreCalc_Figure_04_04_216.jpg)
...
![Image](../../media/CNX_Precalc_Figure_04_04_219.jpg)
</details>
