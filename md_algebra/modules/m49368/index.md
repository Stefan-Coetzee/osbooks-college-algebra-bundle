...
Objective 1: Draw and interpret scatter diagrams (linear, exponential, logarithmic). (CA 4.3.1)Vocabulary and Concept CheckDraw and interpret scatter diagrams (linear, exponential, logarithmic).Fill in the blanks and match the description with the graphs a, b, or cA ________ function has equation fx=mx+b and has a basic shape ________.
...
Practice Makes PerfectDraw and interpret scatter diagrams ( linear, exponential, logarithmic).
...
Practice Makes PerfectFit a regression equation to a set of data and use the linear (or exponential) model to make predictions.
...
Recall that exponential functions have the form 
 ...
 When performing regression analysis, we use the form most commonly used on graphing utilities, 
 ...
 Take a moment to reflect on the characteristics we’ve already learned about the exponential function 
...
0<b<1,
 ...
 the function models exponential decay. As 
...
GraphicalFor the following exercises, match the given function of best fit with the appropriate scatterplot in  through . Answer using the letter beneath the matching graph.
...
Rewrite the exponential model 
 ...
 as an equivalent model with base 
...
A logarithmic model is given by the equation 
 ...
 To the nearest hundredth, for what value of 
...
A logistic model is given by the equation 
 ...
 To the nearest hundredth, for what value of t does 
...
For the following exercises, use this scenario: The population 
 ...
 months is modeled by the function 
...
Graph the population model to show the population over a span of 
...
How many months will it take before there are 
...
For the following exercises, use this scenario: The population 
 ...
 of an endangered species habitat for wolves is modeled by the function 
...
How many wolves will the habitat have after 
...
How many years will it take before there are 
...
Use the intersect feature to find the value of 
...
Use the LOGarithm option of the REGression feature to find a logarithmic function of the form 
...
Use the LOGISTIC regression option to find a logistic growth model of the form 
...
Recall that the general form of a logistic equation for a population is given by 
 ...
 such that the initial population at time 
...
A retirement account is opened with an initial deposit of $8,500 and earns 
 ...
 interest compounded monthly. What will the account be worth in 
...
Hsu-Mei wants to save $5,000 for a down payment on a car. To the nearest dollar, how much will she need to invest in an account now with 
...
The graph below shows transformations of the graph of 
...
The formula for measuring sound intensity in decibels 
 ...
 is the lowest level of sound that the average person can hear. How many decibels are emitted from a large orchestra with a sound intensity of 
...
Exponential and Logarithmic ModelsFor the following exercises, use this scenario: A doctor prescribes 
 
  300
 
 milligrams of a therapeutic drug that decays by about 
...
Write an exponential model representing the amount of the drug remaining in the patient’s system after 
 ...
 hours. Then use the formula to find the amount of the drug that would remain in the patient’s system after 
...
For the following exercises, use this scenario: The equation 
 ...
 models the number of people in a school who have heard a rumor after 
...
The population of a culture of bacteria is modeled by the logistic equation 
 ...
 is in days. To the nearest tenth, how many days will it take the culture to reach 
...
The population of a pod of bottlenose dolphins is modeled by the function 
 ...
 is given in years. To the nearest whole number, what will the pod population be after 
...
Drew wants to save $2,500 to go to the next World Cup. To the nearest dollar, how much will he need to invest in an account now with 
 
6.25%
 
 APR, compounding daily, in order to reach his goal in 
...
An investment account was opened with an initial deposit of $9,600 and earns 
...
The graph shows transformations of the graph of 
...
A radiation safety officer is working with 
 ...
 days, the sample has decayed to 
...
Write the formula found in the previous exercise as an equivalent equation with base 
 
  e.
 
 Express the exponent to five significant digits.

A bottle of soda with a temperature of 
 
  71°
 
 Fahrenheit was taken off a shelf and placed in a refrigerator with an internal temperature of 
 
  35° F.
 
 After ten minutes, the internal temperature of the soda was 
...
The population of a wildlife habitat is modeled by the equation 
...
The population of a lake of fish is modeled by the logistic equation 
 ...
 is time in years. To the nearest hundredth, how many years will it take the lake to reach 
