...
| :--- | :--- |
| Identify the values of each variable in the formulas. | $\phantom{\rule{3em}{0ex}}P=\text{$}\mathrm{10,000}$ |
| Remember to express the percent as a decimal. | $\phantom{\rule{3em}{0ex}}r=0.05$ |
|  | $\phantom{\rule{3em}{0ex}}t=18\phantom{\rule{0.2em}{0ex}}\text{years}$ |

ⓑ

| For quarterly compounding, $n=4$. There are 4 quarters in a year. | $\phantom{\rule{3em}{0ex}}A=P{\left(1+\frac{r}{n}\right)}^{nt}$ |
| :--- | :--- |
| Substitute the values in the formula. | $\phantom{\rule{3em}{0ex}}A=\mathrm{10,000}{\left(1+\frac{0.05}{4}\right)}^{4\xb718}$ |
| Compute the amount. Be careful to consider the order of operations as you enter the expression into your calculator. | $\phantom{\rule{3em}{0ex}}A=\text{$}\mathrm{24,459.20}$ |

ⓒ

| For monthly compounding, $n=12$ . There are 12 months in a year. | $\phantom{\rule{3em}{0ex}}A=P{\left(1+\frac{r}{n}\right)}^{nt}$ |
| :--- | :--- |
| Substitute the values in the formula. | $\phantom{\rule{3em}{0ex}}A=\mathrm{10,000}{\left(1+\frac{0.05}{12}\right)}^{12\xb718}$ |
| Compute the amount. | $\phantom{\rule{3em}{0ex}}A=\text{$}\mathrm{24,550.08}$ |

ⓓ

| For compounding continuously, | $\phantom{\rule{3em}{0ex}}A=P{e}^{rt}$ |
| :--- | :--- |
| Substitute the values in the formula. | $\phantom{\rule{3em}{0ex}}A=\mathrm{10,000}{e}^{0.05\xb718}$ |
| Compute the amount. | $\phantom{\rule{3em}{0ex}}A=\text{$}\mathrm{24,596.03}$ |
</details>
...
| Identify the values of each variable in the formulas. | $\phantom{\rule{0.5em}{0ex}}A=?$ |
| :--- | :--- |
...
| Substitute the values in the formula: $A={A}_{0}{e}^{rt}$ . | $A=100{e}^{0.25\xb724}$ |
| Compute the amount. | $A=\mathrm{40,342.88}$ |
| Round to the nearest whole virus. | $A=\mathrm{40,343}$ |
...
| Substitute in the intensity level, I. | $D=10\ \text{log}\left(\frac{{10}^{-2}}{{10}^{-12}}\right)$ |
| :--- | :--- |
| Simplify. | $D=10\ \mathrm{log}\left({10}^{10}\right)$ |
...
| Convert the magnitudes to intensities. | $R=\text{log}\phantom{\rule{0.2em}{0ex}}I$ |
| :--- | :--- |
| 1906 earthquake | $7.8=\text{log}\phantom{\rule{0.2em}{0ex}}I$ |
| Convert to exponential form. | $I={10}^{7.8}$ |
| 2014 earthquake | $5.1=\text{log}\phantom{\rule{0.2em}{0ex}}I$ |
| Convert to exponential form. | $I={10}^{5.1}$ |
| Form a ratio of the intensities. | $\frac{\text{Intensity}\phantom{\rule{0.2em}{0ex}}\text{for}\phantom{\rule{0.2em}{0ex}}1906}{\text{Intensity}\phantom{\rule{0.2em}{0ex}}\text{for}\phantom{\rule{0.2em}{0ex}}2014}$ |
...
When an amount grows at a fixed percent per unit time, the growth is exponential. To find ${A}_{0}$ we use the fact that ${A}_{0}$ is the amount at time zero, so ${A}_{0}=10.$ To find $k,$ use the fact that after one hour $\left(t=1\right)$ the population doubles from $10$ to $20.$ The formula is derived as follows
 ...
 $$
\begin{array}{ll}20=10{e}^{k\cdot 1}  &   \\ 2={e}^{k}  & \text{Divide\ by\ 10}  \\ \mathrm{ln}2=k  & \text{Take\ the\ natural\ logarithm}  \end{array}
$$
...
This formula is derived as follows.
 $\begin{array}{ll}A={A}_{0}{e}^{kt}  & \text{The continuous growth formula}.  \\ 0.5{A}_{0}={A}_{0}{e}^{k\cdot 5730}  & \text{Substitute the half-life for}t\phantom{\rule{0.5em}{0ex}}\text{and}0.5{A}_{0}\phantom{\rule{0.5em}{0ex}}\text{for}f(t).  \\ 0.5={e}^{5730k}  & \text{Divide by}{A}_{0}.  \\ \mathrm{ln}(0.5)=5730k  & \text{Take the natural log of both sides}.  \\ k=\frac{\mathrm{ln}(0.5)}{5730}  & \text{Divide by the coefficient of}k.  \\ A={A}_{0}{e}^{\left(\frac{\mathrm{ln}(0.5)}{5730}\right)t}  & \text{Substitute for}r\phantom{\rule{0.5em}{0ex}}\text{in the continuous growth formula}.  \end{array}$
...
We substitute $20\%=0.20$ for $r$ in the equation and solve for $t:$ 
 $$
\begin{array}{ll}t=\frac{\mathrm{ln}(r)}{-0.000121}  & \text{Use\ the\ general\ form\ of\ the\ equation}.  \\ =\frac{\mathrm{ln}(0.20)}{-0.000121}\begin{array}{cccc}& & & \end{array}  & \text{Substitute\ for\}r.  \\ \approx 13301  & \text{Round\ to\ the\ nearest\ year}.  \end{array}
$$
...
The formula is derived as follows:
 ...
 $$
\begin{array}{ll}t=\frac{\mathrm{ln}2}{k}  & \text{The doubling time formula}.  \\ 2=\frac{\mathrm{ln}2}{k}  & \text{Use a doubling time of two years}.  \\ k=\frac{\mathrm{ln}2}{2}  & \text{Multiply by}\phantom{\rule{0.4em}{0ex}}k\phantom{\rule{0.4em}{0ex}}\text{and divide by 2}.  \\ A\phantom{\rule{0.5em}{0ex}}={A}_{0}{e}^{\frac{\mathrm{ln}2}{2}t}\begin{array}{cccc}& & & \end{array}  & \text{Substitute}\phantom{\rule{0.4em}{0ex}}k\phantom{\rule{0.4em}{0ex}}\text{into the continuous growth formula}.  \end{array}
$$
...
$$ We know the initial temperature was 165, so $T(0)=165.$ 
 ...
 $$
\begin{array}{ll}165=A{e}^{k0}+35  & \text{Substitute\}(0,165).  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}A=130  & \text{Solve\ for\}A.  \end{array}
$$
We were given another data point, $T(10)=150,$ which we can use to solve for $k.$ 
 $$
\begin{array}{ll}150=130{e}^{k10}+35  & \text{Substitute (10, 150)}.  \\ 115=130{e}^{k10}  & \text{Subtract 35}.  \\ \frac{115}{130}={e}^{10k}  & \text{Divide by 130}.  \\ \mathrm{ln}\left(\frac{115}{130}\right)=10k  & \text{Take the natural log of both sides}.  \\ k=\frac{\mathrm{ln}\left(\frac{115}{130}\right)}{10}\approx -0.0123  & \text{Divide by the coefficient of}k.  \end{array}
$$
...
Now we can solve for the time it will take for the temperature to cool to 70 degrees.
 $$
\begin{array}{ll}70=130{e}^{-0.0123t}+35  & \text{Substitute in 70 for}T(t).  \\ 35=130{e}^{-0.0123t}  & \text{Subtract 35}.  \\ \frac{35}{130}={e}^{-0.0123t}  & \text{Divide by 130}.  \\ \mathrm{ln}(\frac{35}{130})=-0.0123t  & \text{Take the natural log of both sides}  \\ t=\frac{\mathrm{ln}(\frac{35}{130})}{-0.0123}\approx 106.68  & \text{Divide by the coefficient of}t.  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_04_07_008.jpg)
...
Clearly, the points do not lie on a straight line, so we reject a linear model. If we draw a line between any two of the points, most or all of the points between those two points lie above the line, so the graph is concave down, suggesting a logarithmic model. We can try $y=a\mathrm{ln}(bx).$ Plugging in the first point, $\left(\text{1,0}\right)\text{,}$ gives $0=a\mathrm{ln}b.$ We reject the case that $a=0$ (if it were, all outputs would be 0), so we know $\mathrm{ln}(b)=0.$ Thus $b=1$ and $y=a\mathrm{ln}\left(\text{x}\right).$ Next we can use the point $\left(\text{9,4}\text{.394}\right)$ to solve for $a:$ 
 ...
 $$
\begin{array}{l}y=a\mathrm{ln}(x)  \\ 4.394=a\mathrm{ln}(9)  \\ a=\frac{4.394}{\mathrm{ln}(9)}  \end{array}
$$
...
![Image](../../media/CNX_Precalc_Figure_04_07_010.jpg)
</details>
...
22. **Changing to base *e***   Change the function $y=2.5{(3.1)}^{x}$ so that this same function is written in the form $y={A}_{0}{e}^{kx}.$
...
The formula is derived as follows
 $$
\begin{array}{ll}y=2.5{(3.1)}^{x}  &   \\ \phantom{\rule{0.5em}{0ex}}=2.5{e}^{\mathrm{ln}\left({3.1}^{x}\right)}  & \text{Insert\ exponential\ and\ its\ inverse}\text{.}  \\ \phantom{\rule{0.5em}{0ex}}=2.5{e}^{x\mathrm{ln}3.1}  & \text{Laws\ of\ logs}\text{.}  \\ \phantom{\rule{0.5em}{0ex}}=2.5{e}^{\left(\mathrm{ln}3.1\right)}{}^{x}  & \text{Commutative\ law\ of\ multiplication}  \end{array}
$$
</details>
...
![Graph of the question’s table.](../../media/CNX_PreCalc_Figure_04_07_201.jpg)
</details>
...
![Graph of the question’s table.](../../media/CNX_PreCalc_Figure_04_07_203.jpg)
</details>
...
![Graph of P(t)=1000/(1+9e^(-0.6t))](../../media/CNX_PreCalc_Figure_04_07_205.jpg)
</details>
...
$\begin{array}{l}M=\frac{2}{3}\mathrm{log}\left(\frac{S}{{S}_{0}}\right)  \\ \mathrm{log}\left(\frac{S}{{S}_{0}}\right)=\frac{3}{2}M  \\ \frac{S}{{S}_{0}}={10}^{\frac{3M}{2}}  \\ S={S}_{0}{10}^{\frac{3M}{2}}  \end{array}$
</details>
...
Let $y={b}^{x}$ for some non-negative real number $b$ such that $b\ne 1.$ Then,
 ...
 $\begin{array}{l}\mathrm{ln}(y)=\mathrm{ln}({b}^{x})  \\ \mathrm{ln}(y)=x\mathrm{ln}(b)  \\ {e}^{\mathrm{ln}(y)}={e}^{x\mathrm{ln}(b)}  \\ \ \ \ \ \ \ y={e}^{x\mathrm{ln}(b)}  \end{array}$
</details>
...
41. To the nearest minute, how long will it take the soup to cool to $\text{80\xb0\ F?}$
