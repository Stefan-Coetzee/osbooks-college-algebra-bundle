...
=======================
    ...
    Power Property for products and quotients
     $\begin{array}{ccc}{\left(xy\right)}^{m}={x}^{m}{y}^{m}& & (\frac{x}{y}\end{array}{)}^{m}=\frac{{x}^{m}}{{y}^{m}}$ 
    ...
    Negative exponent
     $\begin{array}{ccc}{x}^{-n}=\frac{1}{{x}^{n}}& & \frac{1}{{x}^{-n}}={x}^{n}\end{array}$ 
...
${\left(3{x}^{2}y\right)}^{4}$

  
    Use the product to a power to break the exponent into a product of three exponents
     ${3}^{4}{\left({x}^{2}\right)}^{4}{y}^{4}$ 
  
  
    Simplify ${\left({x}^{2}\right)}^{4}$ by applying the power property
     ${3}^{4}{x}^{8}{y}^{4}$ 
...
${\left(\frac{3x{y}^{2}}{{x}^{2}{y}^{-3}}\right)}^{4}$
 ...
 $f\left(x\right)=-5{x}^{-2}$ 
    ...
    *Degree of polynomial?*
    ...
    No, there is a variable in the denominator
     ...
     ${b}^{3}+\frac{1}{3}{b}^{2}-\frac{1}{2}b+12$ 
    1
    yes
...
![Graph of three functions, h(x)=x^2 in green, g(x)=x^4 in orange, and f(x)=x^6 in blue.](../../media/even_power_functions.jpg)

Graphs of $f\left(x\right)={x}^{2},\ f\left(x\right)={x}^{4},\ f\left(x\right)={x}^{6}$

![Graph of three functions, f(x)=x^3 in green, g(x)=x^5 in orange, and h(x)=x^7 in blue.](../../media/odd_power_functions.jpg)

Graphs of $f\left(x\right)={x}^{3},\ f\left(x\right)={x}^{5},\ f\left(x\right)={x}^{7}$
...
===========================
         ...
         $$
\begin{array}{cccc}\hfill f(x)& =& 1\hfill & \phantom{\rule{2em}{0ex}}\text{Constant\ function}\hfill \\ \hfill f(x)& =& x\hfill & \phantom{\rule{2em}{0ex}}\text{Identity\ function}\hfill \\ \hfill f(x)& =& {x}^{2}\hfill & \phantom{\rule{2em}{0ex}}\text{Quadratic\ function}\hfill \\ \hfill f(x)& =& {x}^{3}\hfill & \phantom{\rule{2em}{0ex}}\text{Cubic\ function}\hfill \\ \hfill f(x)& =& \frac{1}{x}\hfill & \phantom{\rule{2em}{0ex}}\text{Reciprocal\ function}\hfill \\ \hfill f(x)& =& \frac{1}{{x}^{2}}\hfill & \phantom{\rule{2em}{0ex}}\text{Reciprocal\ squared\ function}\hfill \\ \hfill f(x)& =& \sqrt{x}\hfill & \phantom{\rule{2em}{0ex}}\text{Square\ root\ function}\hfill \\ \hfill f(x)& =& \sqrt[3]{x}\hfill & \phantom{\rule{2em}{0ex}}\text{Cube\ root\ function}\hfill \end{array}
$$
...
$\begin{array}{ccc}\hfill f(x)& =& 2x\cdot 4{x}^{3}\hfill \\ \hfill g(x)& =& -{x}^{5}+5{x}^{3}\hfill \\ \hfill h(x)& =& \frac{2{x}^{5}-1}{3{x}^{2}+4}\hfill \end{array}$
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_004abcd.jpg)\n\nHow To
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_008.jpg)\n\n
...
\begin{array}{l}\text{as}\ x\to -\infty ,\ f(x)\to \infty \ \\ \text{as}\ x\to \infty ,\ f(x)\to -\infty \end{array}
$$
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_009.png)\n\n
...
We can see from  that, when we substitute very small values for $x,$ the output is very large, and when we substitute very large values for $x,$ the output is very small (meaning that it is a very large negative value).
...
Composing these functions gives a formula for the area in terms of weeks.
 ...
 $$
\begin{array}{ccc}\hfill A(w)& =& A(r(w))\hfill \\ & =& A(24+8w)\hfill \\ & =& \pi {(24+8w)}^{2}\hfill \end{array}
$$
...
Which of the following are polynomial functions?
 ...
 $$
\begin{array}{ccc}\hfill f(x)& =& 2{x}^{3}\cdot 3x+4\hfill \\ \hfill g(x)& =& -x({x}^{2}-4)\hfill \\ \hfill h(x)& =& 5\sqrt{x+2}\hfill \end{array}
$$
...
Identify the degree, leading term, and leading coefficient of the following polynomial functions.
 ...
 $$
\begin{array}{ccc}\hfill f(x)& =& 3+2{x}^{2}-4{x}^{3}\hfill \\ \hfill g(t)& =& 5{t}^{5}-2{t}^{3}+7t\hfill \\ h(p)\hfill & =& 6p-{p}^{3}-2\hfill \end{array}
$$
...
![Graph of f(x)=5x^4+2x^3-x-4.](../../media/CNX_Precalc_Figure_03_03_011.jpg)

  
  
    $f(x)=-2{x}^{6}-{x}^{5}+3{x}^{4}+{x}^{3}$
...
![Graph of f(x)=-2x^6-x^5+3x^4+x^3.](../../media/CNX_Precalc_Figure_03_03_012.jpg)

  
  
    $f(x)=3{x}^{5}-4{x}^{4}+2{x}^{2}+1$
...
![Graph of f(x)=3x^5-4x^4+2x^2+1.](../../media/CNX_Precalc_Figure_03_03_013.jpg)

  
  
    $f(x)=-6{x}^{3}+7{x}^{2}+3x+1$
...
![Graph of f(x)=-6x^3+7x^2+3x+1.](../../media/CNX_Precalc_Figure_03_03_014.jpg)
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_015.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_016n.jpg)\n\n
...
Obtain the general form by expanding the given expression for $f\left(x\right).$
 ...
 $$
\begin{array}{ccc}\hfill f(x)& =& \mathrm{-3}{x}^{2}(x-1)(x+4)\hfill \\ & =& \mathrm{-3}{x}^{2}\left({x}^{2}+3x-4\right)\hfill \\ & =& \mathrm{-3}{x}^{4}-9{x}^{3}+12{x}^{2}\hfill \end{array}
...
The *y-*intercept occurs when the input is zero so substitute 0 for $x.$
 ...
 $$
\begin{array}{ccc}\hfill f(0)& =& f\left(0\right)=(0-2)(0+1)(0-4)\hfill \\ & =& (-2)\left(1\right)(-4)\hfill \\ & =& 8\hfill \end{array}
$$
...
$$
 ...
 $$
\begin{array}{ccccccccccc}\hfill x-2& =& 0\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x+1& =& 0\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x-4& =& 0\hfill \\ \hfill x& =& 2\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x& =& \mathrm{-1}\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x& =& 4\hfill \end{array}
$$
The *x*-intercepts are $(2,0),(\u20131,0),$ and $(4,0).$
We can see these intercepts on the graph of the function shown in .

\n\n![Image](../../media/CNX_Precalc_Figure_03_03_018.jpg)\n\n
...
The *x*-intercepts occur when the output is zero. To determine when the output is zero, we will need to factor the polynomial.
 ...
 $$
\begin{array}{ccc}\hfill f(x)& =& {x}^{4}-4{x}^{2}-45\hfill \\ & =& \left({x}^{2}-9\right)\left({x}^{2}+5\right)\hfill \\ & =& (x-3)(x+3)\left({x}^{2}+5\right)\hfill \end{array}
$$ 
 $$
\phantom{\rule{2em}{0ex}}0=(x-3)(x+3)\left({x}^{2}+5\right)
$$ 
 $$
\begin{array}{ccccccccc}\hfill x-3& =& 0\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x+3& =& 0\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& {x}^{2}+5=0\\ \hfill x& =& 3\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& \hfill x& =& -3\hfill & \phantom{\rule{2em}{0ex}}\text{or}\phantom{\rule{2em}{0ex}}& (\text{no\ real\ solution)}\end{array}
$$
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_019.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_03_03_022-9b31.jpg)\n\n
...
Given the function $f(x)=-4x\left(x+3\right)\left(x-4\right),$
determine the local behavior.

The *y*-intercept is found by evaluating $f(0).$
 $$
\begin{array}{ccc}\hfill f(0)& =& -4(0)(0+3)(0-4\\ & =& 0\hfill \end{array}
...
What can we conclude if, in general, the graph of a polynomial function exhibits the following end behavior? As $x\to -\infty ,\phantom{\rule{0.5em}{0ex}}f(x)\to -\infty$
and as $x\to \infty ,\phantom{\rule{0.5em}{0ex}}f(x)\to -\infty .$
...
![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_201.jpg)

3

![Graph of an even-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_202.jpg)

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_203.jpg)

5

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_204.jpg)

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_205.jpg)

3

![Graph of an even-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_206.jpg)

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_207.jpg)

5

![Graph of an even-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_208.jpg)
...
![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_209.jpg)

Yes. Number of turning points is 2. Least possible degree is 3.

![Graph of an equation.](../../media/CNX_Precalc_Figure_03_03_210.jpg)

![Graph of an even-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_211.jpg)

Yes. Number of turning points is 1. Least possible degree is 2.

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_212.jpg)

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_213.jpg)

Yes. Number of turning points is 0. Least possible degree is 1.

![Graph of an equation.](../../media/CNX_Precalc_Figure_03_03_214.jpg)

![Graph of an odd-degree polynomial.](../../media/CNX_Precalc_Figure_03_03_215.jpg)
...
![Graph of f(x)=x^3(x-2).](../../media/CNX_Precalc_Figure_03_03_216.png)
...
![Graph of f(x)=x(14-2x)(10-2x).](../../media/CNX_Precalc_Figure_03_03_218.png)
...
![Image](../../media/CNX_Precalc_Figure_03_03_220.png)
...
![Graph of f(x)=x^3-27.](../../media/CNX_Precalc_Figure_03_03_222.png)
...
![Graph of f(x)=-x^3+x^2+2x.](../../media/CNX_Precalc_Figure_03_03_224.png)
...
End behavior: as $x\to -\infty$, $f(x)\to \infty$; as
$x\to \infty$, $f(x)\to \infty .$

$f(x)={x}^{2}-4$
The $y-$ intercept is $(0,9).$ The $x\text{-}$ intercepts are $(-3,0)$, $(3,0).$ Degree is 2.
End behavior: as $x\to -\infty$, $\phantom{\rule{0.5em}{0ex}}f(x)\to -\infty$, as $x\to \infty$, $f(x)\to -\infty .$
