...
| Step 1. List the factors of each denominator. Match factors vertically when possible | $\begin{array}{c}x+3=(x+3)\\ {x}^{2}-9=(x+3)(x-3)\end{array}$ |
| :--- | :--- |
| Step 2. Bring down the columns by including all factors, but do not include common factors twice. | $\frac{\begin{array}{c}x+3=(x+3)\\ {x}^{2}-9=(x+3)(x-3)\end{array}}{\text{LCD}=(x+3)(x-3)}$ |
...
| Step 1 | Write the equations in standard form. If any coefficients are fractions, clear them. $\left\{\begin{array}{l}3x+y=5\\ 2x-3y=7\end{array}\right.$ |
| :--- | :--- |
| Step 2 | Let’s eliminate y $\left\{\begin{array}{l}3x+y=5\\ 2x-3y=7\end{array}\right.\begin{array}{c}\underset{\text{Multiply by 3}}{\to}\\ \end{array}\left\{\begin{array}{l}9x+3y=15\\ 2x-3y=7\end{array}\right.$ |
| Step 3 | $\frac{\begin{array}{c}9x+3y=15\\ 2x-3y=7\end{array}}{11x=22}$ |
| Step 4 | $\begin{array}{c}11x=22\\ x=2\end{array}$ |
| Step 5 | Use the value of the variable found in Step 2 to find the second variable.Let’s substitute $x=2$ into $3x+y=5$  $\begin{array}{ccc}3\left(2\right)+y& =& 5\\ 6+y& =& 5\\ y& =& -1\end{array}$ |
| Step 6 | Write the solution as an ordered pair: (2, -1) |
| Step 7 | Check the solution into the original equations. $\begin{array}{cccccc}3x+y& =& 5& 2x-3y& =& 7\\ 3\left(2\right)-1& =& 5& \left(2\right)-3(-1)& =& 7\\ 6-1& =& 5& 4+3& =& 7\\ 5& =& 5& 7& =& 7\end{array}$ |
</details>
...
Another method to use to solve for $A$ or $B$ is by considering the equation that resulted from eliminating the fractions and substituting a value for $x$ that will make either the *A*- or *B*-term equal 0. If we let $x=1,$ the $A-$ term becomes 0 and we can simply solve for $B.$
 ...
 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \}3x=A(x-1)+B(x+2)  \\ \ 3(1)=A[(1)-1]+B[(1)+2]  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \}3=0+3B  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \}1=B  \end{array}
$$
Next, either substitute $B=1$ into the equation and solve for $A,$ or make the *B*-term 0 by substituting $x=\mathrm{-2}$ into the equation.
 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}3x=A(x-1)+B(x+2)  \\ \phantom{\rule{0.5em}{0ex}}\text\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}3(-2)=A[(-2)-1]+B[(-2)+2]  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}-6=-3A+0  \\ \phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \}\frac{-6}{-3}=A  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ 2}=A  \end{array}
$$
...
Next, we multiply both sides by the common denominator.
 ...
 $$
\begin{array}{l}x{(x\mathrm{-2})}^{2}\left[\frac{-{x}^{2}+2x+4}{x{(x\mathrm{-2})}^{2}}\right]=\left[\frac{A}{x}+\frac{B}{(x\mathrm{-2})}+\frac{C}{{(x\mathrm{-2})}^{2}}\right]x{(x\mathrm{-2})}^{2}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}-{x}^{2}+2x+4=A{(x\mathrm{-2})}^{2}+Bx(x\mathrm{-2})+Cx  \end{array}
$$
On the right side of the equation, we expand and collect like terms.

 $$
\begin{array}{l}-{x}^{2}+2x+4=A({x}^{2}-4x+4)+B({x}^{2}-2x)+Cx  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=A{x}^{2}-4Ax+4A+B{x}^{2}-2Bx+Cx  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}=(A+B){x}^{2}+(-4A-2B+C)x+4A  \end{array}
$$
...
$$
 ...
 $$
\begin{array}{rr}  A+B=\mathrm{-1}&   \text{(1)}\\   \mathrm{-4}A\mathrm{-2}B+C=2\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}&   \text{(2)}\\   4A=4\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}&   \text{(3)}\end{array}
$$
Solving for $A$ , we have

 $$
\begin{array}{l}4A=4  \\ \phantom{\rule{0.5em}{0ex}}\text\ A=1  \end{array}
$$
Substitute $A=1$ into equation (1).

 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text\ A+B=\mathrm{-1}  \\ (1)+B=\mathrm{-1}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}B=\mathrm{-2}  \end{array}
$$
Then, to solve for $C,$ substitute the values for $A$ and $B$ into equation (2).

 $$
\begin{array}{r}  \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \}\mathrm{-4}A\mathrm{-2}B+C=2\\   \mathrm{-4}(1)\mathrm{-2}(\mathrm{-2})+C=2\\   \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \}\mathrm{-4}+4+C=2\\   \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}C=2\end{array}
$$
Thus,
...
$$
 We follow the same steps as in previous problems. First, clear the fractions by multiplying both sides of the equation by the common denominator.
  ...
  $$
\begin{array}{l}(x+3)({x}^{2}+x+2)\left[\frac{8{x}^{2}+12x-20}{(x+3)({x}^{2}+x+2)}\right]=\left[\frac{A}{(x+3)}+\frac{Bx+C}{({x}^{2}+x+2)}\right](x+3)({x}^{2}+x+2)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}8{x}^{2}+12x-20=A({x}^{2}+x+2)+(Bx+C)(x+3)  \end{array}
$$
Notice we could easily solve for $\phantom{\rule{0.5em}{0ex}}A\phantom{\rule{0.5em}{0ex}}$ by choosing a value for $\phantom{\rule{0.5em}{0ex}}x\phantom{\rule{0.5em}{0ex}}$ that will make the $\phantom{\rule{0.5em}{0ex}}Bx+C\phantom{\rule{0.5em}{0ex}}$ term equal 0. Let $x=\mathrm{-3}\phantom{\rule{0.5em}{0ex}}$ and substitute it into the equation.
 $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}8{x}^{2}+12x-20=A({x}^{2}+x+2)+(Bx+C)(x+3)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \}8{(-3)}^{2}+12(-3)-20=A({(-3)}^{2}+(-3)+2)+(B(-3)+C)((-3)+3)  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}16=8A  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}A=2  \end{array}
$$
Now that we know the value of $\phantom{\rule{0.5em}{0ex}}A,\phantom{\rule{0.5em}{0ex}}$ substitute it back into the equation. Then expand the right side and collect like terms.
  ...
  $$
\begin{array}{l}  \\ 8{x}^{2}+12x\mathrm{-20}=2({x}^{2}+x+2)+(Bx+C)(x+3)  \\ 8{x}^{2}+12x\mathrm{-20}=2{x}^{2}+2x+4+B{x}^{2}+3B+Cx+3C  \\ 8{x}^{2}+12x\mathrm{-20}=(2+B){x}^{2}+(2+3B+C)x+(4+3C)  \end{array}
$$
Setting the coefficients of terms on the right side equal to the coefficients of terms on the left side gives the system of equations.
  ...
  $$
\begin{array}{ll}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}2+B=8  & \text{(1)}  \\ 2+3B+C=12  & \text{(2)}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \}4+3C=\mathrm{-20}  & \text{(3)}  \end{array}
$$
Solve for $\phantom{\rule{0.5em}{0ex}}B\phantom{\rule{0.5em}{0ex}}$ using equation (1) and solve for $\phantom{\rule{0.5em}{0ex}}C\phantom{\rule{0.5em}{0ex}}$ using equation (3).
  ...
  $$
\begin{array}{ll}\phantom{\rule{0.5em}{0ex}}\text{\ \}2+B=8  & \text{(1)}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}B=6  &   \\   &   \\ 4+3C=\mathrm{-20}  & \text{(3)}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \}3C=\mathrm{-24}  &   \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}C=\mathrm{-8}  &   \end{array}
$$
...
$$
     Expand the right side.
      ...
      $$
\begin{array}{l}\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \}{x}^{4}+{x}^{3}+{x}^{2}-x+1=A({x}^{4}+2{x}^{2}+1)+B{x}^{4}+B{x}^{2}+C{x}^{3}+Cx+D{x}^{2}+Ex  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}\phantom{\rule{0.5em}{0ex}}\phantom{\rule{0.5em}{0ex}}=A{x}^{4}+2A{x}^{2}+A+B{x}^{4}+B{x}^{2}+C{x}^{3}+Cx+D{x}^{2}+Ex  \end{array}
$$
...
Set up the system of equations matching corresponding coefficients on each side of the equal sign.
     ...
     $$
\begin{array}{l}\phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}A+B=1  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}C=1  \\ 2A+B+D=1  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \}C+E=\mathrm{-1}  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \}A=1  \end{array}
$$
We can use substitution from this point. Substitute  $A=1$ 
 into the first equation.

     $\begin{array}{l}1+B=1  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \}B=0  \end{array}$
Substitute  $A=1$ 
 and  $B=0$ 
 into the third equation.

     $$
\begin{array}{l}2(1)+0+D=1  \\ \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}D=\mathrm{-1}  \end{array}
$$
Substitute  $C=1$ 
 into the fourth equation.

     $$
\begin{array}{r}  1+E=\mathrm{-1}\\   \phantom{\rule{0.5em}{0ex}}\text{\ \ \ \ \}E=\mathrm{-2}\end{array}
$$
