...
ⓑ Solve for x.
      ...
      Complete the square of a binomial expression.
       ...
       Use the square root property to solve ${x}^{2}+6x+9=7$. Use the steps below to guide your work.

ⓐ ${x}^{2}+6x+9$ is a perfect square trinomial. Factor it into ${(\_+\_)}^{2}$ .
ⓑ Take a square root of both sides. Remember to have ± on the right side.
ⓒ Solve for x.
...
![Image](../../media/CNX_IntAlg_Figure_09_02_018_img.png)

Complete the square of a binomial expression
============================================

  Complete the square for
 ${x}^{2}+6x$ to make it a perfect square.

  
    Since there is a plus sign between the two terms, we will use the (*a* + *b*)2 pattern ${a}^{2}+2ab+{b}^{2}={(a+b)}^{2}$ .
...
We ultimately need to find the last term of this trinomial that will make it a perfect square trinomial. To do that we will need to find *b*. But first we start with determining *a*. Notice that the first term of *x*2 + 6*x* is a square, *x*2. This tells us that *a* = *x*.
 ${x}^{2}+2\xb7x\xb7b+{b}^{2}$ 
What number, *b*, when multiplied with 2*x*, gives 6*x*? It would have to be 3, which is (½)(6).  So *b* = 3.
 ${x}^{2}+2\xb73\xb7x+\_$ 
...
![Image](../../media/CNX_IntAlg_Figure_11_01_009_img.png)
...
![.](../../media/CNX_IntAlg_Figure_11_01_013c_img.jpg)
...
![.](../../media/CNX_IntAlg_Figure_11_01_015e_img.jpg)
...
\n\n![Image](../../media/CNX_Precalc_Figure_10_01_002.jpg)\n\n
...
\n\n![Image](../../media/CNX_Precalc_Figure_10_01_003.jpg)\n\n
...
By the definition of an ellipse, ${d}_{1}+{d}_{2}$ is constant for any point $\left(x,y\right)$ on the ellipse. We know that the sum of these distances is $2a$ for the vertex $(a,0).$ It follows that ${d}_{1}+{d}_{2}=2a$ for any point on the ellipse. We will begin the derivation by applying the distance formula. The rest of the derivation is algebraic.
 ...
 $$
\begin{array}{ll}{d}_{1}+{d}_{2}=\sqrt{{(x-(-c))}^{2}+{(y-0)}^{2}}+\sqrt{{(x-c)}^{2}+{(y-0)}^{2}}=2a\hfill & \text{Distance\ formula}\hfill \\ \sqrt{{(x+c)}^{2}+{y}^{2}}+\sqrt{{(x-c)}^{2}+{y}^{2}}=2a\hfill & \text{Simplify\ expressions}\text{.}\hfill \\ \sqrt{{(x+c)}^{2}+{y}^{2}}=2a-\sqrt{{(x-c)}^{2}+{y}^{2}}\hfill & \text{Move\ radical\ to\ opposite\ side}\text{.}\hfill \\ {(x+c)}^{2}+{y}^{2}={\left[2a-\sqrt{{(x-c)}^{2}+{y}^{2}}\right]}^{2}\hfill & \text{Square\ both\ sides}\text{.}\hfill \\ {x}^{2}+2cx+{c}^{2}+{y}^{2}=4{a}^{2}-4a\sqrt{{(x-c)}^{2}+{y}^{2}}+{(x-c)}^{2}+{y}^{2}\hfill & \text{Expand\ the\ squares}\text{.}\hfill \\ {x}^{2}+2cx+{c}^{2}+{y}^{2}=4{a}^{2}-4a\sqrt{{(x-c)}^{2}+{y}^{2}}+{x}^{2}-2cx+{c}^{2}+{y}^{2}\hfill & \text{Expand\ remaining\ squares}\text{.}\hfill \\ 2cx=4{a}^{2}-4a\sqrt{{(x-c)}^{2}+{y}^{2}}-2cx\hfill & \text{Combine\ like\ terms}\text{.}\hfill \\ 4cx-4{a}^{2}=-4a\sqrt{{(x-c)}^{2}+{y}^{2}}\hfill & \text{Isolate\ the\ radical}\text{.}\hfill \\ cx-{a}^{2}=-a\sqrt{{(x-c)}^{2}+{y}^{2}}\hfill & \text{Divide\ by\ 4}\text{.}\hfill \\ {\left[cx-{a}^{2}\right]}^{2}={a}^{2}{\left[\sqrt{{(x-c)}^{2}+{y}^{2}}\right]}^{2}\hfill & \text{Square\ both\ sides}\text{.}\hfill \\ {c}^{2}{x}^{2}-2{a}^{2}cx+{a}^{4}={a}^{2}\left({x}^{2}-2cx+{c}^{2}+{y}^{2}\right)\hfill & \text{Expand\ the\ squares}\text{.}\hfill \\ {c}^{2}{x}^{2}-2{a}^{2}cx+{a}^{4}={a}^{2}{x}^{2}-2{a}^{2}cx+{a}^{2}{c}^{2}+{a}^{2}{y}^{2}\hfill & \text{Distribute\}{a}^{2}.\hfill \\ {a}^{2}{x}^{2}-{c}^{2}{x}^{2}+{a}^{2}{y}^{2}={a}^{4}-{a}^{2}{c}^{2}\hfill & \text{Rewrite}\text{.}\hfill \\ {x}^{2}\left({a}^{2}-{c}^{2}\right)+{a}^{2}{y}^{2}={a}^{2}\left({a}^{2}-{c}^{2}\right)\hfill & \text{Factor\ common\ terms}\text{.}\hfill \\ {x}^{2}{b}^{2}+{a}^{2}{y}^{2}={a}^{2}{b}^{2}\hfill & \text{Set\}{b}^{2}={a}^{2}-{c}^{2}.\hfill \\ \frac{{x}^{2}{b}^{2}}{{a}^{2}{b}^{2}}+\frac{{a}^{2}{y}^{2}}{{a}^{2}{b}^{2}}=\frac{{a}^{2}{b}^{2}}{{a}^{2}{b}^{2}}\hfill & \text{Divide\ both\ sides\ by\}{a}^{2}{b}^{2}.\hfill \\ \frac{{x}^{2}}{{a}^{2}}+\frac{{y}^{2}}{{b}^{2}}=1\hfill & \text{Simplify}\text{.}\hfill \end{array}
$$
...
\n\n![(a) Horizontal ellipse with center $\left(0,0 ight)$ (b) Vertical ellipse with center $\left(0,0 ight)$](../../media/CNX_Precalc_Figure_10_01_005.jpg)\n\nHow To
...
What is the standard form equation of the ellipse that has vertices $\left(\pm 8,0\right)$ and foci $\left(\pm 5,0\right)?$
...
We know that the vertices and foci are related by the equation ${c}^{2}={a}^{2}-{b}^{2}.$ Solving for ${b}^{2},$ we have:
 ...
 $$
\begin{array}{ll}{c}^{2}={a}^{2}-{b}^{2}\hfill & \hfill \\ 25=64-{b}^{2}\begin{array}{cccc}& & & \end{array}\hfill & \text{Substitute\ for\}{c}^{2}\phantom{\rule{0.5em}{0ex}}\text{and\}{a}^{2}.\hfill \\ {b}^{2}=39\hfill & \text{Solve\ for\}{b}^{2}.\hfill \end{array}
$$
...
What is the standard form equation of the ellipse that has vertices $\left(\mathrm{0,}\pm 4\right)$ and foci $\left(\mathrm{0,}\pm \sqrt{15}\right)?$
...
\n\n![(a) Horizontal ellipse with center $\left(h,k ight)$ (b) Vertical ellipse with center $\left(h,k ight)$](../../media/CNX_Precalc_Figure_10_01_006-1.jpg)\n\n
How To
...
What is the standard form equation of the ellipse that has vertices $\left(\mathrm{-2},\mathrm{-8}\right)$ and $\left(\mathrm{-2},\text{2}\right)$
and foci $\left(\mathrm{-2},\mathrm{-7}\right)$ and $\left(\mathrm{-2},\text{1}\right)?$
...
First, we identify the center, $\left(h,k\right).$ The center is halfway between the vertices, $\left(-\mathrm{2,}-8\right)$ and $\left(-2,\text{2}\right).$ Applying the midpoint formula, we have:
 ...
 $$
\begin{array}{l}(h,k)=\left(\frac{\mathrm{-2}+(\mathrm{-2})}{2},\frac{\mathrm{-8}+2}{2}\right)\hfill \\ \text{\ \ \ \ \ \ \ \}=(\mathrm{-2},\mathrm{-3})\hfill \end{array}
$$
...
What is the standard form equation of the ellipse that has vertices $\left(\mathrm{-3},3\right)$ and $\left(5,3\right)$ and foci $\left(1-2\sqrt{3},3\right)$ and $\left(1+2\sqrt{3},3\right)?$
...
\n\n![Image](../../media/CNX_Precalc_Figure_10_01_007.jpg)\n\n
...
![Image](../../media/CNX_Precalc_Figure_10_01_008.jpg)
...
First, use algebra to rewrite the equation in standard form.
  ...
  $\begin{array}{l}\ 4{x}^{2}+25{y}^{2}=100\hfill \\ \text\ \frac{4{x}^{2}}{100}+\frac{25{y}^{2}}{100}=\frac{100}{100}\hfill \\ \text{\ \ \ \ \ \ \}\frac{{x}^{2}}{25}+\frac{{y}^{2}}{4}=1\hfill \end{array}$ Next, we determine the position of the major axis. Because $25>4,$ the major axis is on the *x*-axis. Therefore, the equation is in the form $\frac{{x}^{2}}{{a}^{2}}+\frac{{y}^{2}}{{b}^{2}}=1,$ where ${a}^{2}=25$ and ${b}^{2}=4.$ It follows that:
the center of the ellipse is $\left(0,0\right)$
...
\n\n![Image](../../media/CNX_Precalc_Figure_10_01_009.jpg)\n\n
...
![Image](../../media/CNX_Precalc_Figure_10_01_010.jpg)
...
Next, we plot and label the center, vertices, co-vertices, and foci, and draw a smooth curve to form the ellipse.
    ...
    \n\n![Image](../../media/CNX_Precalc_Figure_10_01_011.jpg)\n\n
   

  
   Try It
   Graph the ellipse given by the equation $\frac{{\left(x-4\right)}^{2}}{36}+\frac{{\left(y-2\right)}^{2}}{20}=1.$ Identify and label the center, vertices, co-vertices, and foci.
...
![Image](../../media/CNX_Precalc_Figure_10_01_012.jpg)
...
the center of the ellipse is $\left(h,k\right)=\left(5,\mathrm{-2}\right)$
     ...
     $$
\begin{array}{l}c=\pm \sqrt{{a}^{2}-{b}^{2}}\hfill \\ =\pm \sqrt{9-4}\hfill \\ =\pm \sqrt{5}\hfill \end{array}
$$
...
\n\n![Image](../../media/CNX_Precalc_Figure_10_01_018.jpg)\n\n
...
\n\n![Sound waves are reflected between foci in an elliptical room, called a whispering chamber.](../../media/CNX_Precalc_Figure_10_01_013.jpg)\n\n
...
What is the standard form of the equation of the ellipse representing the outline of the room? Hint: assume a horizontal ellipse, and let the center of the room be the point $\left(0,0\right).$ 
     ...
     \n\n![Image](../../media/CNX_Precalc_Figure_10_01_015.jpg)\n\n
...
=============
      ...
      Horizontal ellipse, center at origin
       $\frac{{x}^{2}}{{a}^{2}}+\frac{{y}^{2}}{{b}^{2}}=1,\phantom{\rule{0.5em}{0ex}}\text{}a>b$
      
     

     
      Vertical ellipse, center at origin
       $\frac{{x}^{2}}{{b}^{2}}+\frac{{y}^{2}}{{a}^{2}}=1,\phantom{\rule{0.5em}{0ex}}\text{}a>b$
      
     
     
      Horizontal ellipse, center $(h,k)$ 
       $\frac{{\left(x-h\right)}^{2}}{{a}^{2}}+\frac{{\left(y-k\right)}^{2}}{{b}^{2}}=1,\phantom{\rule{0.5em}{0ex}}\text{}a>b$
      
     
     
      Vertical ellipse, center $(h,k)$ 
       $\frac{{\left(x-h\right)}^{2}}{{b}^{2}}+\frac{{\left(y-k\right)}^{2}}{{a}^{2}}=1,\phantom{\rule{0.5em}{0ex}}\text{}a>b$
...
![Image](../../media/CNX_Precalc_Figure_10_01_202.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_204.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_206.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_208.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_210.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_212.jpg)
...
![Image](../../media/CNX_Precalc_Figure_10_01_214.jpg)
...
For the following exercises, use the given information about the graph of each ellipse to determine its equation.
    ...
    Center at the origin, symmetric with respect to the *x*- and *y*-axes, focus at $(0,\mathrm{-2}),$ and point on graph $(5,0).$
    ...
    Center $\left(4,2\right)$ ; vertex $\left(9,2\right)$ ; one focus: $\left(4+2\sqrt{6},2\right)$ .

     $\frac{{\left(x-4\right)}^{2}}{25}+\frac{{\left(y-2\right)}^{2}}{1}=1$

    Center $\left(3,5\right)$ ; vertex $\left(3,11\right)$ ; one focus: $\left(3,\phantom{\rule{0.5em}{0ex}}\text{5+4}\sqrt{\text{2}}\right)$

    Center $\left(\mathrm{-3},4\right)$ ; vertex $\left(1,4\right)$ ; one focus: $\left(\mathrm{-3}+2\sqrt{3},4\right)$
...
![A vertical ellipse centered at (0, 0) in the x y coordinate system with vertices at (0, 6) and (0, negative 6) and co-vertices at (4, 0) and (negative 4, 0).](../../media/CNX_Precalc_Figure_10_01_215.jpg)

     

![A horizontal ellipse centered at (0, 0)  in the x y coordinate system with vertices at (9, 0) and (negative 9, 0) and co-vertices at (0, 3) and (0, negative 3).](../../media/CNX_Precalc_Figure_10_01_216.jpg)

     $\frac{{x}^{2}}{81}+\frac{{y}^{2}}{9}=1$

     

![A vertical ellipse centered at (0, 0)  in the x y coordinate system with vertices at (0, 7) and (0, negative 7) and co-vertices at (5, 0) and (negative 5, 0).](../../media/CNX_Precalc_Figure_10_01_217.jpg)

     
     

![A vertical ellipse tangent to the y-axis at (0, 2) in the x y coordinate system and intersecting the x-axis midway between (negative 4, 0) and (negative 3, 0) and also (negative 1, 0) and (0, 0).](../../media/CNX_Precalc_Figure_10_01_218.jpg)

     $\frac{{\left(x+2\right)}^{2}}{4}+\frac{{\left(y-2\right)}^{2}}{9}=1$

     

![A horizontal ellipse in the x y coordinate system extending between x = negative 2 and x = 4, intersecting the y-axis at (2, 0) and (4, 0).](../../media/CNX_Precalc_Figure_10_01_219.jpg)
